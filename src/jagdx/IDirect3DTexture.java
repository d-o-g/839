...
public class IDirect3DTexture extends IDirect3DBaseTexture {
	...
	/**
	 * https://msdn.microsoft.com/en-us/library/windows/desktop/bb205912%28v=vs.85%29.aspx
	 */
	...
	public static native int Download(long l, int i, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_,
			long l_13_);
}
