...
public abstract class Class642 {
    Camera aClass261_8163;

    Class642(Camera class261) {
    ...
    public static void method13248() {
        ...
        if (Class262.aClass262_2650 == class262) {
            ...
            if (Class277.aBool3118) {
                ...
                Client.login(SpawnAnimatedObjectCutsceneAction.aString11131, BaseNpcDefinitionProvider.aString2994,
                        "", false, 1666399204);
            }
        } else {
            ...
            if (null != Class277.anInterface27Array3114) {
                for (int i_3_ = 1 + Class277.anInt3117 * 793335435; i_3_ < Class277.anInterface27Array3114.length; i_3_++) {
                    if (Class277.anInterface27Array3114[i_3_].method160() >= 100
                            && i_3_ - 1 == Class277.anInt3117 * 793335435 && 4 != -1501875989 * Client.connectionState
    ...
    public abstract Vector3f method13222(byte i);

    public abstract void method13223(float f, int i);

    public abstract boolean method13224();

    public abstract void method13227(Class268 class268, Matrix4x3 class405, int i, int i_0_, float f, int i_1_);

    public abstract Vector3f method13235();
