...
public class GlobalPlayer {
    ...
    int target;
    int direction;
    PlayerMapDot aPlayerMapDot_562 = PlayerMapDot.aPlayerMapDot_2093;
    boolean clanmate;
    int position;
    ...
    static void method1100(Toolkit toolkit, int i, int i_437_, int i_438_, int i_439_, int i_440_, int i_441_,
        ...
        SceneObject interface55 = (SceneObject) sceneGraph.getBoundary(i, i_437_, i_438_);
        if (interface55 != null) {
            ObjectDefinition object = Client.scene.getObjectLoader().get(interface55.getId());
            int i_444_ = interface55.getOrientation() & 0x3;
            int i_445_ = interface55.getType();
            if (object.mapscene * -995642805 != -1) {
                GlobalPlayer.method1545(toolkit, object, i_444_, i_439_, i_440_);
            } else {
                int i_446_ = i_441_;
                if (object.type * -1893691057 > 0) {
                    i_446_ = i_442_;
                }
        ...
        interface55 = (SceneObject) sceneGraph.getEntity(i, i_437_, i_438_, Client.anSceneEntityPredicate_10904);
        if (interface55 != null) {
            ObjectDefinition object = Client.scene.getObjectLoader().get(interface55.getId());
            int i_447_ = interface55.getOrientation() & 0x3;
            int i_448_ = interface55.getType();
        ...
        interface55 = (SceneObject) sceneGraph.getTileDecoration(i, i_437_, i_438_);
        if (interface55 != null) {
            ObjectDefinition object = Client.scene.getObjectLoader().get(interface55.getId());
            int i_450_ = interface55.getOrientation() & 0x3;
