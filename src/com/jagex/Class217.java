...
public class Class217 implements Interface34 {
    ...
    Buffer method4042(int i) {
        ...
        synchronized (aList2208) {
            while (!aList2208.isEmpty()) {
                ...
                anInt2239 -= method159(buffer_3_.caret * -165875887) / method238();
                int i_4_ = method279(i_2_);
                int i_5_ = buffer_3_.caret * -165875887 < i_4_ ? buffer_3_.caret * -165875887 : i_4_;
                buffer.writeBytes(buffer_3_.payload, 0, i_5_);
                i_2_ -= method159(i_5_);
                int i_6_ = buffer_3_.caret * -165875887 - i_5_;
                if (i_6_ != 0) {
                    System.arraycopy(buffer_3_.payload, i_5_, buffer_3_.payload, 0, i_6_);
                    buffer_3_.caret = i_6_ * 1258142129;
    ...
    void method4064(byte[] is, int i) {
        ...
        if (!method244()) {
            ...
            if (isVorbis(is, i, 1)) {
                ...
                throw new RuntimeException(new StringBuilder().append(i_19_).toString());
            }
            if (i_19_ == 1) {
                method4103(is, i + 7);
    ...
    synchronized void method4069() {
        int i = aClass480_Sub17_2261 != null ? aClass480_Sub17_2261.caret * -165875887 : 0;
        int i_148_ = 0;
        Iterator iterator = aList2236.iterator();
        while (iterator.hasNext()) {
            Buffer buffer = (Buffer) iterator.next();
            i_148_ += buffer.caret * -165875887;
        }
        if (aClass480_Sub17_2261 != null) {
            if (aClass480_Sub17_2261.payload.length - aClass480_Sub17_2261.caret * -165875887 < i_148_) {
                Buffer buffer = method4074(i_148_ + anInt2238);
                buffer.writeBytes(aClass480_Sub17_2261.payload, aClass480_Sub17_2261.caret * -165875887 - anInt2269,
                        anInt2238);
                aClass480_Sub17_2261.cache();
        ...
        while (iterator.hasNext()) {
            Buffer buffer = (Buffer) iterator.next();
            aClass480_Sub17_2261.writeBytes(buffer.payload, 0, buffer.caret * -165875887);
            anInt2238 += buffer.caret * -165875887;
            buffer.cache();
        }
        aClass480_Sub17_2261.caret = (i - anInt2269) * 1258142129;
        anInt2269 = 0;
        aList2236.clear();
        while (aBool2235 && aClass480_Sub17_2261.caret * -165875887 < aClass480_Sub17_2261.payload.length) {
            ...
            if (aClass480_Sub17_2261 == null || anInt2238 < 27) {
                if (aClass480_Sub17_2261 != null) {
                    anInt2269 = anInt2238;
                    aClass480_Sub17_2261.caret += anInt2238 * 1258142129;
                }
                aBool2235 = false;
                break;
            }
            int i_149_ = aClass480_Sub17_2261.caret * -165875887;
            int i_150_ = 0;
            int i_151_ = 0;
            ...
            aClass480_Sub17_2261.caret += -1344562416;
            int i_154_ = aClass480_Sub17_2261.readUByte();
            int i_155_ = aClass480_Sub17_2261.caret * -165875887;
            int i_156_ = i_155_ + i_154_;
            if (i_156_ > i_149_ + anInt2238) {
                aClass480_Sub17_2261.caret = (i_149_ + anInt2238) * 1258142129;
                anInt2269 = aClass480_Sub17_2261.caret * -165875887 - i_149_;
                aBool2235 = false;
            }
            int i_157_ = i_156_;
            int i_158_ = 0;
            ...
            if (aBool2235) {
                    ...
                    if (method244() && aBool2248 == true && anInt2251 < anInt2249 && i_162_ < anInt2250) {
                        ...
                        if (bool_167_ && (aBool2248 != true || anInt2251 >= anInt2249 || i_162_ >= anInt2250)) {
                            if (class225s != null) {
                                ...
                                synchronized (aList2208) {
                                    anInt2239 += method159(buffer.caret * -165875887) / method238();
                ...
                aClass480_Sub17_2261.caret = i_161_ * 1258142129;
