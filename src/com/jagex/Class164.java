...
class Class164 implements ReferenceCacheSweeper {
    ...
    static int[] method3369(OutgoingFrame frame) {
        ...
        frame.payload.writeBytes(buffer.payload, 0, -165875887 * buffer.caret);
        return seed;
    }

    @Override
    public void sweep(Object object) {
        clear((SomeSerializable) object);
    }

    void clear(SomeSerializable interface66) {
