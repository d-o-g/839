...
public class JavaSceneGraphLevel extends SceneGraphLevel {
    ...
    JavaSceneGraphLevel(JavaToolkit toolkit, int i_330_, int width, int length, int[][] heights, int[][] lighting, int units) {
    ...
    public void addBlendedTile(int i, int i_3_, int[] is, int[] is_4_, int[] is_5_, int[] is_6_, int[] is_7_, int[] is_8_,
        ...
        boolean noTextures = (flags & 0x20) == 0; // i think
        if (aClass85ArrayArray8759 == null && !noTextures) {
        ...
        } else if (aClass90ArrayArray8760 == null && noTextures) {
        ...
        if (is != null && is.length != 0) {
            ...
            if (noTextures) {
                ...
                for (int i_14_ = 0; i_14_ < class90.aShort1247; i_14_++) {
                    ...
                    class90.aShortArray1249[i_14_] = (short) (averageHeightAt(i_21_, i_22_) + (is_4_ != null ? is_4_[i_14_]
                            : 0));
                    if (i_18_ < 0) {
                        i_18_ = 0;
                    }
                    if (is_7_[i_14_] == 0) {
                        ...
                        class90.anIntArray1246[i_14_] = i_25_
                                | JavaSceneGraphLevel.blendColours(method14080(is_7_[i_14_] >> 8, i_18_),
                ...
                if (bool_28_) {
                    ...
                    if (i_37_ != -1 && (class85.aByte1219 & 0x2) == 0 && !toolkit.metricsList.get(i_37_).aBool1724) {
                        ...
                        class85.anInt1218 = JavaSceneGraphLevel.blendColours(
                        ...
                        class85.anInt1224 = JavaSceneGraphLevel.blendColours(
                        ...
                        class85.anInt1217 = JavaSceneGraphLevel.blendColours(
                        ...
                        class85.anInt1221 = JavaSceneGraphLevel.blendColours(
                    ...
                    for (int i_40_ = 0; i_40_ < class70.aShort1038; i_40_++) {
                        ...
                        class70.aShortArray1044[i_40_] = (short) (averageHeightAt(i_47_, i_48_) + (is_4_ != null ? is_4_[i_40_]
                                : 0));
                        if (i_44_ < 0) {
                            i_44_ = 0;
                        }
                        if (is_7_[i_40_] == 0) {
                            ...
                            class70.anIntArray1037[i_40_] = JavaSceneGraphLevel.blendColours(
    ...
    public void method2216(int i, int i_92_, int i_93_, boolean[][] bools, boolean bool, int i_94_) {
        ...
        Matrix4f class399 = toolkit.matrix;
        m0 = class399.array[0];
        m1 = class399.array[1];
        m2 = class399.array[2];
        m3 = class399.array[3];
        ...
        m8 = class399.array[8];
        m9 = class399.array[9];
        m10 = class399.array[10];
        m11 = class399.array[11];
        m12 = class399.array[12];
        m13 = class399.array[13];
        m14 = class399.array[14];
        m15 = class399.array[15];
    ...
    public void method2224(int i, int i_60_, int[] is, int[] is_61_, int[] is_62_, int[] is_63_, int[] is_64_,
        ...
        if (!bool_71_) {
            ...
            for (int i_77_ = 0; i_77_ < i_75_; i_77_++) {
                ...
                class78.aShortArray1138[i_77_] = (short) (averageHeightAt(i_82_, i_83_) + (is_61_ != null ? is_61_[i_77_]
                        : 0));
        ...
        if (class108 != null) {
            if ((class108.aByte1369 & 0x2) == 0) {
                ...
                if ((class108.aByte1369 & 0x1) != 0) {
                    ...
                    float f_127_ = m6 * i_126_;
                    float f_128_ = m7 * i_126_;
                    float f_129_ = m14 + (m2 * i_107_ + f_127_ + m10 * i_109_);
                    f = m15 + (m3 * i_107_ + f_128_ + m11 * i_109_);
                    if (f_129_ < -f) {
                        return;
                    }
                    float f_130_ = m14 + (m2 * i_108_ + f_127_ + m10 * i_109_);
                    f_111_ = m15 + (m3 * i_108_ + f_128_ + m11 * i_109_);
                    if (f_130_ < -f_111_) {
                        return;
                    }
                    float f_131_ = m14 + (m2 * i_108_ + f_127_ + m10 * i_110_);
                    f_112_ = m15 + (m3 * i_108_ + f_128_ + m11 * i_110_);
                    if (f_131_ < -f_112_) {
                        return;
                    }
                    float f_132_ = m14 + (m2 * i_107_ + f_127_ + m10 * i_110_);
                    f_113_ = m15 + (m3 * i_107_ + f_128_ + m11 * i_110_);
                    if (f_132_ < -f_113_) {
                        return;
                    }
                    float f_133_ = m4 * i_126_;
                    float f_134_ = m5 * i_126_;
                    float f_135_ = m12 + (m0 * i_107_ + f_133_ + m8 * i_109_);
                    f_114_ = class109.aFloat1379 + class109.aFloat1380 * f_135_ / f;
                    float f_136_ = m13 + (m1 * i_107_ + f_134_ + m9 * i_109_);
                    f_115_ = class109.aFloat1381 + class109.aFloat1374 * f_136_ / f;
                    f_116_ = class109.aFloat1386 + class109.aFloat1388 * f_129_ / f;
                    float f_137_ = m12 + (m0 * i_108_ + f_133_ + m8 * i_109_);
                    f_117_ = class109.aFloat1379 + class109.aFloat1380 * f_137_ / f_111_;
                    float f_138_ = m13 + (m1 * i_108_ + f_134_ + m9 * i_109_);
                    f_118_ = class109.aFloat1381 + class109.aFloat1374 * f_138_ / f_111_;
                    f_119_ = class109.aFloat1386 + class109.aFloat1388 * f_130_ / f_111_;
                    float f_139_ = m12 + (m0 * i_108_ + f_133_ + m8 * i_110_);
                    f_120_ = class109.aFloat1379 + class109.aFloat1380 * f_139_ / f_112_;
                    float f_140_ = m13 + (m1 * i_108_ + f_134_ + m9 * i_110_);
                    f_121_ = class109.aFloat1381 + class109.aFloat1374 * f_140_ / f_112_;
                    f_122_ = class109.aFloat1386 + class109.aFloat1388 * f_131_ / f_112_;
                    float f_141_ = m12 + (m0 * i_107_ + f_133_ + m8 * i_110_);
                    f_123_ = class109.aFloat1379 + class109.aFloat1380 * f_141_ / f_113_;
                    float f_142_ = m13 + (m1 * i_107_ + f_134_ + m9 * i_110_);
                    ...
                    float f_147_ = m14 + (m2 * i_107_ + m6 * i_143_ + m10 * i_109_);
                    f = m15 + (m3 * i_107_ + m7 * i_143_ + m11 * i_109_);
                    if (f_147_ < -f) {
                        return;
                    }
                    float f_148_ = m14 + (m2 * i_108_ + m6 * i_144_ + m10 * i_109_);
                    f_111_ = m15 + (m3 * i_108_ + m7 * i_144_ + m11 * i_109_);
                    if (f_148_ < -f_111_) {
                        return;
                    }
                    float f_149_ = m14 + (m2 * i_108_ + m6 * i_145_ + m10 * i_110_);
                    f_112_ = m15 + (m3 * i_108_ + m7 * i_145_ + m11 * i_110_);
                    if (f_149_ < -f_112_) {
                        return;
                    }
                    float f_150_ = m14 + (m2 * i_107_ + m6 * i_146_ + m10 * i_110_);
                    f_113_ = m15 + (m3 * i_107_ + m7 * i_146_ + m11 * i_110_);
                    if (f_150_ < -f_113_) {
                        return;
                    }
                    float f_151_ = m12 + (m0 * i_107_ + m4 * i_143_ + m8 * i_109_);
                    f_114_ = class109.aFloat1379 + class109.aFloat1380 * f_151_ / f;
                    float f_152_ = m13 + (m1 * i_107_ + m5 * i_143_ + m9 * i_109_);
                    f_115_ = class109.aFloat1381 + class109.aFloat1374 * f_152_ / f;
                    f_116_ = class109.aFloat1386 + class109.aFloat1388 * f_147_ / f;
                    float f_153_ = m12 + (m0 * i_108_ + m4 * i_144_ + m8 * i_109_);
                    f_117_ = class109.aFloat1379 + class109.aFloat1380 * f_153_ / f_111_;
                    float f_154_ = m13 + (m1 * i_108_ + m5 * i_144_ + m9 * i_109_);
                    f_118_ = class109.aFloat1381 + class109.aFloat1374 * f_154_ / f_111_;
                    f_119_ = class109.aFloat1386 + class109.aFloat1388 * f_148_ / f_111_;
                    float f_155_ = m12 + (m0 * i_108_ + m4 * i_145_ + m8 * i_110_);
                    f_120_ = class109.aFloat1379 + class109.aFloat1380 * f_155_ / f_112_;
                    float f_156_ = m13 + (m1 * i_108_ + m5 * i_145_ + m9 * i_110_);
                    f_121_ = class109.aFloat1381 + class109.aFloat1374 * f_156_ / f_112_;
                    f_122_ = class109.aFloat1386 + class109.aFloat1388 * f_149_ / f_112_;
                    float f_157_ = m12 + (m0 * i_107_ + m4 * i_146_ + m8 * i_110_);
                    f_123_ = class109.aFloat1379 + class109.aFloat1380 * f_157_ / f_113_;
                    float f_158_ = m13 + (m1 * i_107_ + m5 * i_146_ + m9 * i_110_);
            ...
            if (class78 != null) {
                ...
                for (int i_159_ = 0; i_159_ < class78.aShort1132; i_159_++) {
                    ...
                    float f = m14 + (m2 * i_160_ + m6 * i_161_ + m10 * i_162_);
                    float f_163_ = m15 + (m3 * i_160_ + m7 * i_161_ + m11 * i_162_);
                    if (f < -f_163_) {
                        return;
                    }
                    float f_164_ = m12 + (m0 * i_160_ + m4 * i_161_ + m8 * i_162_);
                    float f_165_ = m13 + (m1 * i_160_ + m5 * i_161_ + m9 * i_162_);
        ...
        if (class85 != null) {
            if ((class85.aByte1219 & 0x2) == 0) {
                ...
                if ((class85.aByte1219 & 0x1) != 0 && !bool) {
                    ...
                    float f_216_ = m6 * i_215_;
                    float f_217_ = m7 * i_215_;
                    float f_218_ = m14 + (m2 * i_192_ + f_216_ + m10 * i_194_);
                    f_199_ = m15 + (m3 * i_192_ + f_217_ + m11 * i_194_);
                    if (f_218_ < -f_199_) {
                        return;
                    }
                    float f_219_ = m14 + (m2 * i_193_ + f_216_ + m10 * i_194_);
                    f_200_ = m15 + (m3 * i_193_ + f_217_ + m11 * i_194_);
                    if (f_219_ < -f_200_) {
                        return;
                    }
                    float f_220_ = m14 + (m2 * i_193_ + f_216_ + m10 * i_195_);
                    f_201_ = m15 + (m3 * i_193_ + f_217_ + m11 * i_195_);
                    if (f_220_ < -f_201_) {
                        return;
                    }
                    float f_221_ = m14 + (m2 * i_192_ + f_216_ + m10 * i_195_);
                    f_202_ = m15 + (m3 * i_192_ + f_217_ + m11 * i_195_);
                    if (f_221_ < -f_202_) {
                        return;
                    }
                    ...
                    float f_237_ = m14 + (m2 * i_192_ + m6 * i_233_ + m10 * i_194_);
                    f_199_ = m15 + (m3 * i_192_ + m7 * i_233_ + m11 * i_194_);
                    if (f_237_ < -f_199_) {
                        return;
                    }
                    float f_238_ = m14 + (m2 * i_193_ + m6 * i_234_ + m10 * i_194_);
                    f_200_ = m15 + (m3 * i_193_ + m7 * i_234_ + m11 * i_194_);
                    if (f_238_ < -f_200_) {
                        return;
                    }
                    float f_239_ = m14 + (m2 * i_193_ + m6 * i_235_ + m10 * i_195_);
                    f_201_ = m15 + (m3 * i_193_ + m7 * i_235_ + m11 * i_195_);
                    if (f_239_ < -f_201_) {
                        return;
                    }
                    float f_240_ = m14 + (m2 * i_192_ + m6 * i_236_ + m10 * i_195_);
                    f_202_ = m15 + (m3 * i_192_ + m7 * i_236_ + m11 * i_195_);
                    if (f_240_ < -f_202_) {
                        return;
                    }
            ...
            if (class70 != null) {
                ...
                for (int i_262_ = 0; i_262_ < class70.aShort1038; i_262_++) {
                    ...
                    float f = m14 + (m2 * i_263_ + m6 * i_264_ + m10 * i_265_);
                    float f_266_ = m15 + (m3 * i_263_ + m7 * i_264_ + m11 * i_265_);
                    if (f < -f_266_) {
                        return;
                    }
                    ...
                    float f_271_ = m12 + (m0 * i_263_ + m4 * i_264_ + m8 * i_265_);
                    float f_272_ = m13 + (m1 * i_263_ + m5 * i_264_ + m9 * i_265_);
        ...
        if (i_301_ == 0 || (i_301_ & 0x2) == 0) {
            if (class90 != null) {
                for (int i_302_ = 0; i_302_ < class90.aShort1247; i_302_++) {
                    ...
                    float f = m14 + (m2 * i_303_ + m6 * i_304_ + m10 * i_305_);
                    float f_306_ = m15 + (m3 * i_303_ + m7 * i_304_ + m11 * i_305_);
                    if (f < -f_306_) {
                        return;
                    }
                    fs_300_[i_302_] = 0.0F;
                    ...
                    float f_310_ = m12 + (m0 * i_303_ + m4 * i_304_ + m8 * i_305_);
                    float f_311_ = m13 + (m1 * i_303_ + m5 * i_304_ + m9 * i_305_);
