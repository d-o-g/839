...
public class Class452 {
    ...
    BitBuffer buffer;
    SceneFormat aSceneFormat_5090;

    public Class452(SceneFormat sceneFormat, BitBuffer buffer) {
        aSceneFormat_5090 = sceneFormat;
        this.buffer = buffer;
    }
    ...
    static final void method7410(Toolkit toolkit, int i, int i_4_, int i_5_, int i_6_, int i_7_) {
        ...
        if (147042807 * Class495_Sub1.anInt10322 >= 100) {
            ...
            int i_10_ = i_8_ * Toolkit.anInt4892 * -1258027563 / Class495.anInt6824;
