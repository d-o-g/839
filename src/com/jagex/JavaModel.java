...
public class JavaModel extends Model {
    ...
    public void updateFunctionMask(int i) {
        if (toolkit.threadCount * -1677857107 > 1) {
            synchronized (this) {
                if ((anInt9453 & 0x10000) == 0x10000 && (i & 0x10000) == 0) {
                    renderLater(true);
                }
                anInt9453 = i;
            }
        ...
        if (aClass84Array9462 != null) {
            if (angle == 4096) {
                ...
                synchronized (this) {
                    ...
                    if (aVertexArray9478 != null) {
                        for (int index = 0; index < faceCount; index++) {
                            if (aVertexArray9478[index] != null) {
                                int i_704_ = aVertexArray9478[index].z * sin
                                        + aVertexArray9478[index].x * cos >> 14;
                                aVertexArray9478[index].z = aVertexArray9478[index].z * cos
                                        - aVertexArray9478[index].x * sin >> 14;
                                aVertexArray9478[index].x = i_704_;
                            }
                        }
                    }
        ...
        synchronized (this) {
            ...
            if (aVertexArray9478 != null) {
                for (int i = 0; i < faceCount; i++) {
                    if (aVertexArray9478[i] != null) {
                        aVertexArray9478[i].z = -aVertexArray9478[i].z;
                    }
                }
            }
    ...
    @Override
    public void method2901(int i, int i_156_, SceneGraphLevel class120, SceneGraphLevel class120_157_, int i_158_, int i_159_, int i_160_) {
        if (i == 3) {
            if ((anInt9453 & 0x7) != 7) {
                throw new IllegalStateException();
            }
        ...
        int i_161_ = i_158_ + minimumX;
        int i_162_ = i_158_ + maximumX;
        int i_163_ = i_160_ + aShort9504;
        int i_164_ = i_160_ + maximumZ;
        if (i == 4
                || i_161_ >= 0
            ...
            synchronized (this) {
                if (i == 1) {
                    ...
                    for (int i_188_ = 0; i_188_ < anInt9457; i_188_++) {
                        int i_189_ = (vertexY[i_188_] << 16) / minimumY;
                        if (i_189_ < i_156_) {
                    ...
                    for (int i_199_ = anInt9457; i_199_ < vertexCount; i_199_++) {
                        int i_200_ = (vertexY[i_199_] << 16) / minimumY;
                        if (i_200_ < i_156_) {
    ...
    @Override
    public void transform(Matrix4x3 class405, int i, boolean bool) {
        if (aShortArray9461 != null) {
            JavaThreadResource class64 = toolkit.getThreadResource(Thread.currentThread());
            Matrix4x3 class405_498_ = class64.aClass405_971;
    ...
    @Override
    public void method2917(Matrix4x3 class405, Class139 class139, int i) {
        method15006(class405, class139, i);
    }

    @Override
    public boolean method2918(int i, int i_713_, Matrix4x3 class405, boolean bool, int i_714_) {
        ...
        class399_715_.method6547(toolkit.matrix);
        ...
        int i_721_ = maximumX - minimumX >> 1;
        int i_722_ = maximumY - minimumY >> 1;
        int i_723_ = maximumZ - aShort9504 >> 1;
        int i_724_ = minimumX + i_721_;
        int i_725_ = minimumY + i_722_;
    ...
    @Override
    public void recolor(int i, int i_642_, int i_643_, int i_644_) {
    ...
    public void method2944(Model class143, int i, int i_684_, int i_685_, boolean bool) {
        ...
        computeBounds();
        method14990();
        class143_sub3_686_.computeBounds();
        ...
        for (int i_689_ = 0; i_689_ < anInt9457; i_689_++) {
            ...
            if (class84.anInt1213 != 0) {
                ...
                if (i_690_ >= class143_sub3_686_.minimumY && i_690_ <= class143_sub3_686_.maximumY) {
                    int i_691_ = vertexX[i_689_] - i;
                    if (i_691_ >= class143_sub3_686_.minimumX && i_691_ <= class143_sub3_686_.maximumX) {
                        int i_692_ = vertexZ[i_689_] - i_685_;
                        if (i_692_ >= class143_sub3_686_.aShort9504 && i_692_ <= class143_sub3_686_.maximumZ) {
    ...
    @Override
    public void method3063(Matrix4x3 class405) {
        method14988(toolkit.getThreadResource(Thread.currentThread()));
        Matrix4f class399 = aClass64_9442.aClass399_972;
        class399.method6548(class405);
            ...
            for (int i_97_ = 0; i_97_ < faceCount; i_97_++) {
                ...
                if (i_100_ == -1) {
                    if (i_98_ == 0) {
                        ...
                        Vertex vertex = aVertexArray9478[i_97_];
                        int i_110_ = i * vertex.x + i_92_ * vertex.y + i_93_ * vertex.z >> 16;
                    ...
                    if (i_98_ == 0) {
                        ...
                        Vertex vertex = aVertexArray9478[i_97_];
                        int i_117_ = i * vertex.x + i_92_ * vertex.y + i_93_ * vertex.z >> 16;
    ...
    void method15000() {
        synchronized (this) {
            ...
            if (aVertexArray9478 != null) {
                for (int i = 0; i < faceCount; i++) {
                    if (aVertexArray9478[i] != null) {
                        int i_147_ = aVertexArray9478[i].x;
                        aVertexArray9478[i].x = aVertexArray9478[i].z;
                        aVertexArray9478[i].z = -i_147_;
                    }
                }
            }
    ...
    void method15006(Matrix4x3 class405, Class139 class139, int test) {
        if (anInt9457 >= 1) {
            JavaThreadResource class64 = toolkit.getThreadResource(Thread.currentThread());
            Matrix4f class399 = class64.aClass399_972;
            class399.method6548(class405);
            ...
            class399.method6553(0.0F, minimumY, 0.0F, fs);
            float f = fs[0];
            float f_502_ = fs[1];
            float f_503_ = fs[2];
            class399.method6553(0.0F, maximumY, 0.0F, fs);
            float f_504_ = fs[0];
            float f_505_ = fs[1];
            float f_506_ = fs[2];
            ...
            float f_513_ = f_511_ + minimumY * f_512_;
            float f_514_ = f_511_ + maximumY * f_512_;
            ...
            class399_517_.method6547(toolkit.matrix);
            aClass109_9444.method1988((test & 0x2) != 0);
            ...
            if (class139 != null) {
                ...
                int i_550_ = minimumX + maximumX >> 1;
                int i_551_ = aShort9504 + maximumZ >> 1;
                int i_552_ = i_550_;
                short i_553_ = minimumY;
                int i_554_ = i_551_;
            ...
            renderLater(true);
            aClass109_9444.aBool1373 = (test & 0x1) == 0;
            aClass109_9444.aBool1396 = false;
            try {
                method15007(toolkit.anIntArray8797 != null, toolkit.aFloatArray8801 != null, (test & 0x4) != 0, bool_518_,
    ...
    void method15009() {
        synchronized (this) {
            ...
            if (aVertexArray9478 != null) {
                for (int i = 0; i < faceCount; i++) {
                    if (aVertexArray9478[i] != null) {
                        aVertexArray9478[i].x = -aVertexArray9478[i].x;
                        aVertexArray9478[i].z = -aVertexArray9478[i].z;
                    }
                }
            }
    ...
    final void method15010(boolean bool, boolean bool_584_, boolean bool_585_, int i, boolean bool_586_,
        ...
        if (anIntArray9507[i] != -2) {
            ...
            if (!bool_586_ || f != -5000.0F && f_591_ != -5000.0F && f_592_ != -5000.0F) {
                ...
                if (anIntArray9524[i] != -1 || (f - f_591_) * (f_595_ - f_594_) - (f_593_ - f_594_) * (f_592_ - f_591_) > 0.0F) {
                    aClass109_9444.aBool1376 = f < 0.0F || f_591_ < 0.0F || f_592_ < 0.0F || f > aClass64_9442.anInt980 * -16220783 || f_591_ > aClass64_9442.anInt980 * -16220783 || f_592_ > aClass64_9442.anInt980 * -16220783;
                    if (bool_587_) {
    ...
    void method15071() {
        ...
        for (int i = 0; i < faceCount; i++) {
            ...
            if (i_778_ == 0) {
                ...
                if (aVertexArray9478 == null) {
                    aVertexArray9478 = new Vertex[faceCount];
                }
                Vertex vertex = aVertexArray9478[i] = new Vertex();
                vertex.x = i_774_;
                vertex.y = i_775_;
                vertex.z = i_776_;
            }
    ...
    Model method15073(JavaModel update, JavaModel prev, int i, boolean bool, boolean bool_781_) {
        update.computedBounds = computedBounds;
        if (computedBounds) {
            update.maximumX = maximumX;
            update.maximumY = maximumY;
            update.maximumZ = maximumZ;
            update.minimumX = minimumX;
            update.minimumY = minimumY;
            update.aShort9504 = aShort9504;
            update.aShort9501 = aShort9501;
            update.aShort9502 = aShort9502;
        }
        if (aBool9480) {
            update.aShort9510 = aShort9510;
            update.aBool9480 = true;
        } else {
            update.aBool9480 = false;
        }
        update.anInt9441 = anInt9441;
        update.anInt9455 = anInt9455;
        update.vertexCount = vertexCount;
        update.anInt9457 = anInt9457;
        update.faceCount = faceCount;
        update.anInt9459 = anInt9459;
        update.anInt9440 = anInt9440;
        update.aBool9511 = (i & 0x100) != 0 || aBool9511;
        update.textured = textured;
        ...
        if (bool_783_ || bool_784_ || bool_785_) {
            if (bool_783_) {
                if (prev.vertexX == null || prev.vertexX.length < vertexCount) {
                    update.vertexX = prev.vertexX = new int[vertexCount];
                } else {
                    update.vertexX = prev.vertexX;
                }
                System.arraycopy(vertexX, 0, update.vertexX, 0, vertexCount);
            } else {
                update.vertexX = vertexX;
            }
            if (bool_784_) {
                if (prev.vertexY == null || prev.vertexY.length < vertexCount) {
                    update.vertexY = prev.vertexY = new int[vertexCount];
                } else {
                    update.vertexY = prev.vertexY;
                }
                System.arraycopy(vertexY, 0, update.vertexY, 0, vertexCount);
            } else {
                update.vertexY = vertexY;
            }
            if (bool_785_) {
                if (prev.vertexZ == null || prev.vertexZ.length < vertexCount) {
                    update.vertexZ = prev.vertexZ = new int[vertexCount];
                } else {
                    update.vertexZ = prev.vertexZ;
                }
                System.arraycopy(vertexZ, 0, update.vertexZ, 0, vertexCount);
            } else {
                update.vertexZ = vertexZ;
            }
        } else {
            update.vertexX = vertexX;
            update.vertexY = vertexY;
        ...
        if ((i & 0x84080) != 0) {
            if (prev.faceColours == null || prev.faceColours.length < faceCount) {
                int i_789_ = faceCount;
                update.faceColours = prev.faceColours = new short[i_789_];
            } else {
                update.faceColours = prev.faceColours;
            }
            System.arraycopy(faceColours, 0, update.faceColours, 0, faceCount);
        } else {
            update.faceColours = faceColours;
        }
        if ((i & 0x97018) != 0) {
            update.anInt9477 = 0;
            update.anIntArray9507 = null;
            update.anIntArray9472 = null;
            update.anIntArray9471 = null;
        } else if ((i & 0x80) != 0) {
            if (bool_781_) {
                renderLater(false);
            }
            if (anIntArray9471 != null) {
                if (prev.anIntArray9471 == null || prev.anIntArray9471.length < faceCount) {
                    int i_793_ = faceCount;
                    update.anIntArray9471 = prev.anIntArray9471 = new int[i_793_];
                    update.anIntArray9472 = prev.anIntArray9472 = new int[i_793_];
                    update.anIntArray9507 = prev.anIntArray9507 = new int[i_793_];
                } else {
                    update.anIntArray9471 = prev.anIntArray9471;
                    update.anIntArray9472 = prev.anIntArray9472;
                    update.anIntArray9507 = prev.anIntArray9507;
                }
                for (int i_794_ = 0; i_794_ < faceCount; i_794_++) {
                    update.anIntArray9471[i_794_] = anIntArray9471[i_794_];
                    update.anIntArray9472[i_794_] = anIntArray9472[i_794_];
                    update.anIntArray9507[i_794_] = anIntArray9507[i_794_];
                }
            }
            update.anInt9477 = anInt9477;
        } else {
            if (bool_781_) {
                renderLater(false);
            }
            update.anIntArray9471 = anIntArray9471;
            update.anIntArray9472 = anIntArray9472;
            update.anIntArray9507 = anIntArray9507;
            update.anInt9477 = anInt9477;
        }
        if ((i & 0x100) != 0) {
            if (prev.faceAlphas == null || prev.faceAlphas.length < faceCount) {
                int i_795_ = faceCount;
                update.faceAlphas = prev.faceAlphas = new byte[i_795_];
            } else {
                update.faceAlphas = prev.faceAlphas;
            }
            if (faceAlphas != null) {
                System.arraycopy(faceAlphas, 0, update.faceAlphas, 0, faceCount);
            } else {
                for (int i_797_ = 0; i_797_ < faceCount; i_797_++) {
                    update.faceAlphas[i_797_] = (byte) 0;
                }
            }
        } else {
            update.faceAlphas = faceAlphas;
        }
        if ((i & 0x8) != 0 || (i & 0x10) != 0) {
            if (prev.aClass84Array9462 == null || prev.aClass84Array9462.length < anInt9457) {
                int i_798_ = anInt9457;
                update.aClass84Array9462 = prev.aClass84Array9462 = new Class84[i_798_];
            } else {
                update.aClass84Array9462 = prev.aClass84Array9462;
            }
            if (aClass84Array9462 != null) {
                for (int i_799_ = 0; i_799_ < anInt9457; i_799_++) {
                    update.aClass84Array9462[i_799_] = new Class84(aClass84Array9462[i_799_]);
                }
            } else {
                update.aClass84Array9462 = null;
            }
            if (aVertexArray9478 != null) {
                if (prev.aVertexArray9478 == null
                        || prev.aVertexArray9478.length < faceCount) {
                    int i_800_ = faceCount;
                    update.aVertexArray9478 = prev.aVertexArray9478 = new Vertex[i_800_];
                } else {
                    update.aVertexArray9478 = prev.aVertexArray9478;
                }
                for (int i_801_ = 0; i_801_ < faceCount; i_801_++) {
                    update.aVertexArray9478[i_801_] = aVertexArray9478[i_801_] != null ? new Vertex(
                            aVertexArray9478[i_801_]) : null;
                }
            } else {
                update.aVertexArray9478 = null;
            }
        } else {
            if (bool_781_) {
                method14990();
            }
            update.aClass84Array9462 = aClass84Array9462;
            update.aVertexArray9478 = aVertexArray9478;
        }
        if ((i & 0x8000) != 0) {
            if (aShortArray9482 == null) {
                update.aShortArray9482 = null;
            } else {
                if (prev.aShortArray9482 == null || prev.aShortArray9482.length < faceCount) {
                    int i_802_ = faceCount;
                    update.aShortArray9482 = prev.aShortArray9482 = new short[i_802_];
                } else {
                    update.aShortArray9482 = prev.aShortArray9482;
                }
                System.arraycopy(aShortArray9482, 0, update.aShortArray9482, 0, faceCount);
            }
        } else {
            update.aShortArray9482 = aShortArray9482;
        }
        if ((i & 0x10000) != 0) {
            if (aByteArray9479 == null) {
                update.aByteArray9479 = null;
            } else {
                if (prev.aByteArray9479 == null || prev.aByteArray9479.length < faceCount) {
                    int i_804_ = bool ? faceCount + 100 : faceCount;
                    update.aByteArray9479 = prev.aByteArray9479 = new byte[i_804_];
                } else {
                    update.aByteArray9479 = prev.aByteArray9479;
                }
                System.arraycopy(aByteArray9479, 0, update.aByteArray9479, 0, faceCount);
            }
        } else {
            update.aByteArray9479 = aByteArray9479;
        }
        if ((i & 0xc580) != 0) {
            if (prev.aClass79Array9498 == null || prev.aClass79Array9498.length < anInt9459) {
                int i_806_ = anInt9459;
                update.aClass79Array9498 = prev.aClass79Array9498 = new Class79[i_806_];
                for (int i_807_ = 0; i_807_ < anInt9459; i_807_++) {
                    update.aClass79Array9498[i_807_] = aClass79Array9498[i_807_].copy();
                }
            } else {
                update.aClass79Array9498 = prev.aClass79Array9498;
                for (int i_808_ = 0; i_808_ < anInt9459; i_808_++) {
                    update.aClass79Array9498[i_808_].copyFrom(aClass79Array9498[i_808_]);
                }
            }
        } else {
            update.aClass79Array9498 = aClass79Array9498;
        }
        if (aFloatArrayArray9469 != null && (i & 0x10) != 0) {
            if (prev.aFloatArrayArray9469 == null
                    || prev.aFloatArrayArray9469.length < faceCount) {
                int i_809_ = bool ? faceCount + 100 : faceCount;
                update.aFloatArrayArray9469 = prev.aFloatArrayArray9469 = new float[i_809_][3];
            } else {
                update.aFloatArrayArray9469 = prev.aFloatArrayArray9469;
            }
            for (int i_810_ = 0; i_810_ < faceCount; i_810_++) {
                if (aFloatArrayArray9469[i_810_] != null) {
                    update.aFloatArrayArray9469[i_810_][0] = aFloatArrayArray9469[i_810_][0];
                    update.aFloatArrayArray9469[i_810_][1] = aFloatArrayArray9469[i_810_][1];
                    update.aFloatArrayArray9469[i_810_][2] = aFloatArrayArray9469[i_810_][2];
                }
            }
            if (prev.aFloatArrayArray9523 == null
                    || prev.aFloatArrayArray9523.length < faceCount) {
                int i_811_ = bool ? faceCount + 100 : faceCount;
                update.aFloatArrayArray9523 = prev.aFloatArrayArray9523 = new float[i_811_][3];
            } else {
                update.aFloatArrayArray9523 = prev.aFloatArrayArray9523;
            }
            for (int i_812_ = 0; i_812_ < faceCount; i_812_++) {
                if (aFloatArrayArray9523[i_812_] != null) {
                    update.aFloatArrayArray9523[i_812_][0] = aFloatArrayArray9523[i_812_][0];
                    update.aFloatArrayArray9523[i_812_][1] = aFloatArrayArray9523[i_812_][1];
                    update.aFloatArrayArray9523[i_812_][2] = aFloatArrayArray9523[i_812_][2];
                }
            }
        } else {
            update.aFloatArrayArray9469 = aFloatArrayArray9469;
            update.aFloatArrayArray9523 = aFloatArrayArray9523;
        }

        update.vertexLabels = vertexLabels;
        update.faceLabels = faceLabels;
        update.anIntArrayArray9512 = anIntArrayArray9512;
        update.aShortArray9461 = aShortArray9461;
        update.aShortArray9509 = aShortArray9509;
        update.aByteArray9497 = aByteArray9497;
        update.aShortArray9466 = aShortArray9466;
        update.aShortArray9467 = aShortArray9467;
        update.aShortArray9522 = aShortArray9522;
        update.aClass145Array9450 = aClass145Array9450;
        update.aClass115Array9495 = aClass115Array9495;
        update.aClass69Array9468 = aClass69Array9468;
        update.aShortArray9485 = aShortArray9485;
        update.anInt9453 = i;
        return update;
    }
        ...
        synchronized (this) {
            ...
            if (aVertexArray9478 != null) {
                for (int face = 0; face < faceCount; face++) {
                    if (aVertexArray9478[face] != null) {
                        int i_818_ = aVertexArray9478[face].z;
                        aVertexArray9478[face].z = aVertexArray9478[face].x;
                        aVertexArray9478[face].x = -i_818_;
                    }
                }
            }
