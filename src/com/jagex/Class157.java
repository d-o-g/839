...
class Class157 implements Interface52 {
    ...
    public static void method3302() {
        ...
        if (Client.aBool10611 && -947242039 * Class597.anInt7842 <= 0) {
            ...
            if (Client.mapState * 1212513917 == 3) {
                if (Client.camera.method4837() == Class270.aClass270_2995) {
                    ...
                    i_25_ = PlayerMapDot.method3870(class281_sub2.aQuaternion_9749) >> 3;
                    int i_27_ = 1024;
                    i_26_ = (3 * i_27_ - (Varp.method2284(class281_sub2.aQuaternion_9749) >> 3))
                            % (2 * i_27_);
                } else {
                    i_25_ = 0;
                    i_26_ = 0;
        ...
        if (!Client.sentPreferences) {
            ...
            int i_28_ = class480_sub15.payload.caret * -165875887;
            Buffer buffer = Class199.preferences.encode();
            class480_sub15.payload.writeBytes(buffer.payload, 0, buffer.caret * -165875887);
            class480_sub15.payload.writeSizeByte(class480_sub15.payload.caret * -165875887 - i_28_);
            Client.gameConnection.sendFrame(class480_sub15);
    ...
    public void method345(Object object, float[] fs, Object[] objects, int i) {
        ...
        float f_3_ = 0.0F;
        int i_4_ = 8192;
        float f_5_ = vector3f_2_.distance();
        float f_6_ = 0.0F;
        if (f_5_ >= f_0_) {
            f_3_ = 0.0F;
        } else {
            ...
            if (vector3f_1_.x > vector3f.x - f_7_ / 2.0F && vector3f_1_.x < vector3f.x + f_7_ / 2.0F
                    && vector3f_1_.z > vector3f.z - f_8_ / 2.0F && vector3f_1_.z < vector3f.z + f_8_ / 2.0F) {
                float f_9_ = Math.abs(vector3f_1_.x - (f_7_ / 2.0F + vector3f.x));
                float f_10_ = Math.abs(vector3f_1_.x - (vector3f.x - f_7_ / 2.0F));
                float f_11_ = Math.abs(vector3f_1_.z - (f_8_ / 2.0F + vector3f.x));
                float f_12_ = Math.abs(vector3f_1_.z - (vector3f.x - f_8_ / 2.0F));
                float f_13_ = f_0_ - f;
            ...
            if (vector3f_2_.x != 0.0F || vector3f_2_.z != 0.0F) {
                if (1212513917 * Client.mapState == 3) {
                    float f_18_ = Client.camera.getYaw();
                    if (vector3f_2_.x != 0.0F || vector3f_2_.z != 0.0F) {
                        int i_19_ = (int) (2607.5945876176133 * (-1.0F * f_18_))
                                - (int) (Math.atan2(vector3f_2_.x, vector3f_2_.z) * 2607.5945876176133) - 4096 & 0x3fff;
                        if (i_19_ > 8192) {
                            i_19_ = 16384 - i_19_;
                        }
                        int i_20_;
                    ...
                    int i_21_ = -(Class550.cameraYaw * 1686504405)
                            - (int) (Math.atan2(vector3f_2_.x, vector3f_2_.z) * 2607.5945876176133) - 4096 & 0x3fff;
                    if (i_21_ > 8192) {
                        i_21_ = 16384 - i_21_;
                    }
