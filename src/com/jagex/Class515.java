...
public class Class515 implements Interface71, Definition {
    ...
    public static final int method8841(int i, int i_30_, int x, int z, int i_33_) {
        ...
        if (i_33_ < 3) {
            ...
            if (i_35_ < 1 || i_36_ < 1 || i_35_ > Client.scene.getMapWidth() - 1
                    || i_36_ > Client.scene.getMapLength() - 1) {
                return 0;
            }
        ...
        return Client.scene.getGraph().levels1[i_33_].averageHeightAt(i, i_30_);
    }
    ...
    public Matrix4x3[] method8826() {
        ...
        aClass405Array7045 = new Matrix4x3[anIntArrayArray7043.length];
        for (int i_14_ = 0; i_14_ < anIntArrayArray7043.length; i_14_++) {
            ...
            if (i_15_ != 0 || 0 != i_16_ || i_17_ != 0 || 0 != i_18_ || i_19_ != 0 || 0 != i_20_) {
                Matrix4x3 class405 = aClass405Array7045[i_14_] = new Matrix4x3();
                if (i_20_ != 0) {
    ...
    public int[] method8827() {
        HashTable<Node> table = new HashTable(16);
        ...
        while (iterator.hasNext()) {
            ...
            is[i_23_++] = (int) (node.linkedKey * -4821875126325281949L);
        }
