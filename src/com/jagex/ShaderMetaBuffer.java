...
public class ShaderMetaBuffer {
    ...
    public static void method4368(Archive interfaces, Archive models, Archive sprites, Archive fonts) {
        UnboundedDefinitionLoaderIterator.interfaces = interfaces;
    ...
    static void method4369(int i, int i_7_, Component component, byte i_8_) {
        int i_9_ = component.width * 688089097 + i;
        int i_10_ = 15 + i_7_;
        ...
        if (Client.displayFps) {
            ...
            if (l_14_ != -1L) {
                string = l_14_ + "ms";
                if (l_14_ > 500L) {
                    string = Item.getColorTags(16711680) + string + Item.getColorTags(16776960);
                }
            }
            ...
            if (-1L != latency) {
                ping = latency + "ms";
                if (latency > 500L) {
                    ping = Item.getColorTags(16711680) + ping + Item.getColorTags(16776960);
                }
            }
