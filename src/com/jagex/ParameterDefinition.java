...
public class ParameterDefinition implements Definition, Interface71 {
    ...
    static final void method924(long l) {
        ...
        int i = Client.anInt10692 * -123944055 + (int) vector3f.x;
        int i_3_ = -861250759 * Client.anInt10694 + (int) vector3f.z;
    ...
    void decode(Buffer buffer, int opcode) {
        if (opcode == 1) {
            ...
            type = KeyType.valueOf(character);
        } else if (2 == opcode) {
            ...
            type = CompressionType.findIdentifiable(KeyType.values(), buffer.readUSmart());
        }
    }
