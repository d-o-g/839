...
public class NativeModel extends Model {
    ...
    @Override
    public void method2901(int i, int i_114_, SceneGraphLevel class120, SceneGraphLevel class120_115_, int i_116_, int i_117_, int i_118_) {
        if (!computedBounds) {
            computeBounds();
        }
    ...
    public void transform(Matrix4x3 class405, int i, boolean bool) {
        if (aShortArray9178 != null) {
            Matrix4x3 class405_801_ = class405;
            if (bool) {
    ...
    @Override
    public boolean method2918(int i, int i_581_, Matrix4x3 class405, boolean bool, int i_582_) {
    ...
    @Override
    public void recolor(int i, int i_757_, int i_758_, int i_759_) {
    ...
    public void method2944(Model class143, int i, int i_63_, int i_64_, boolean bool) {
        NativeModel model = (NativeModel) class143;
        if (anInt9184 != 0 && model.anInt9184 != 0) {
            int i_66_ = model.vertexCount;
            int[] is = model.vertexX;
            int[] is_67_ = model.vertexY;
            int[] is_68_ = model.vertexZ;
            short[] is_69_ = model.aShortArray9177;
            short[] is_70_ = model.aShortArray9212;
            short[] is_71_ = model.aShortArray9179;
            byte[] is_72_ = model.aByteArray9180;
            short[] is_73_;
            short[] is_74_;
            short[] is_75_;
            byte[] is_76_;
            ...
            short[] is_79_;
            byte[] is_80_;
            if (model.aClass328_9183 != null) {
                is_77_ = model.aClass328_9183.aShortArray3561;
                is_78_ = model.aClass328_9183.aShortArray3559;
                is_79_ = model.aClass328_9183.aShortArray3560;
                is_80_ = model.aClass328_9183.aByteArray3558;
            } else {
                is_77_ = null;
                is_78_ = null;
                is_79_ = null;
            ...
            int[] is_81_ = model.anIntArray9186;
            short[] is_82_ = model.aShortArray9218;
            if (!model.computedBounds) {
                model.computeBounds();
            }
            int i_83_ = model.minimumY;
            int i_84_ = model.maximumY;
            int i_85_ = model.minimumX;
            int i_86_ = model.maximumX;
            int i_87_ = model.minimumZ;
            int i_88_ = model.maximumZ;
                                ...
                                for (int i_97_ = 0; i_97_ < i_66_; i_97_++) {
                                    if (i_91_ == is[i_97_] && i_92_ == is_68_[i_97_] && i_90_ == is_67_[i_97_]) {
                                        ...
                                        if (i_98_ != -1) {
                                            ...
                                            if (is_77_ == null) {
                                                Class328 class328 = model.aClass328_9183 = new Class328();
    ...
    boolean method14530(int i, int i_583_, int i_584_, int i_585_, Matrix4x3 class405, boolean bool, int i_586_) {
        Matrix4f class399 = toolkit.aClass399_9324;
        class399.method6548(class405);
    ...
    void method14534(Matrix4x3 class405) {
        if (anInt9195 != 0 && method14536() && method14535()) {
            ...
            if (toolkit.aBool9349) {
                ...
                class259.aVector3f_2872.set((class150.colour * 2139661437 >> 16 & 0xff) / 255.0F,
                ...
                class259.aVector3f_2872.set(0.0F, 0.0F, 0.0F);
            }
            if (toolkit.anInt9390 > 0) {
                class259.aClass375_2871.set(0.0F, 0.0F, 1.0F, -toolkit.aFloat9392);
                class259.aVector3f_2875.set((toolkit.anInt9293 >> 16 & 0xff) / 255.0F,
                ...
                class259.aVector3f_2875.set(0.0F, 0.0F, 0.0F);
            }
            if ((anInt9164 & 0x37) == 0) {
                ...
                Matrix4x3 class405_688_ = toolkit.aClass405_9287;
                ...
                if (toolkit.fixedFunction) {
                    ...
                    class259.aVector3f_2859.set(toolkit.aFloatArray9298[0], toolkit.aFloatArray9298[1],
                            toolkit.aFloatArray9298[2]);
                    class259.aVector3f_2859.method6466(class405_688_);
                    class259.aVector3f_2874.set(toolkit.aFloat9344 * toolkit.aFloat9340, toolkit.aFloat9344
                            * toolkit.aFloat9321, toolkit.aFloat9344 * toolkit.aFloat9320);
                    class259.aVector3f_2873.set(-toolkit.aFloat9345 * toolkit.aFloat9340, -toolkit.aFloat9345
                            * toolkit.aFloat9321, -toolkit.aFloat9345 * toolkit.aFloat9320);
                    class259.aVector3f_2870.set(toolkit.aFloat9331 * toolkit.aFloat9340, toolkit.aFloat9331
                            * toolkit.aFloat9321, toolkit.aFloat9331 * toolkit.aFloat9320);
                    if (toolkit.anInt9347 > 0) {
                        i = toolkit.anInt9347;
                        Vector3f vector3f = toolkit.aVector3f_9290;
                        for (int i_689_ = 0; i_689_ < i; i_689_++) {
                            ...
                            vector3f.copyFrom(class480_sub23.position);
                            vector3f.method6465(class405_688_);
                            class259.aFloatArray2862[i_689_ * 4 + 0] = vector3f.x;
                            class259.aFloatArray2862[i_689_ * 4 + 1] = vector3f.y;
                            class259.aFloatArray2862[i_689_ * 4 + 2] = vector3f.z;
                ...
                for (int i_691_ = 0; i_691_ < anIntArray9215.length; i_691_++) {
                    ...
                    switch (i_695_) {
                        ...
                        case 5:
                            ...
                            break;
                        case 7:
                            class259.aVector3f_2876.set(toolkit.aClass399_9323.array[12],
                                    toolkit.aClass399_9323.array[13], toolkit.aClass399_9323.array[14]);
                            class259.aVector3f_2876.method6465(class405_688_);
        ...
        if (bool_698_) {
            ...
            if (unsafe != null) {
                ...
                for (int i_743_ = 0; i_743_ < uniqueVertices; i_743_++) {
                    Vector3f vector3f = new Vector3f(is[i_743_], is_740_[i_743_], is_741_[i_743_]);
                    if (vector3f.distance() != 0.0F) {
                        if (is_742_[i_743_] > 1) {
                            vector3f.divide(is_742_[i_743_]);
                        }
                        vector3f.normalise();
                    }
                    unsafe.putFloat(l, vector3f.x);
                    l += 4L;
                    unsafe.putFloat(l, vector3f.y);
                    l += 4L;
                    unsafe.putFloat(l, vector3f.z);
                    l += 4L;
                }
                interface32.unmap();
            } else {
                ...
                bytebuffer.clear();
                for (int i = 0; i < uniqueVertices; i++) {
                    Vector3f vector3f = new Vector3f(is[i], is_740_[i], is_741_[i]);
                    if (vector3f.distance() != 0.0F) {
                        if (is_742_[i] > 1) {
                            vector3f.divide(is_742_[i]);
                        }
                        vector3f.normalise();
                    }
    ...
    void method14571(Matrix4f class399) {
        if (aClass324Array9222 != null) {
            ...
            Matrix4x3 class405 = toolkit.aClass405_9287;
            Class290 class290 = toolkit.aClass290_9426;
            boolean bool = toolkit.anInt9390 > 0;
            if (bool) {
                class290.aVector3f_3232.set((toolkit.anInt9293 >> 16 & 0xff) / 255.0F,
                        (toolkit.anInt9293 >> 8 & 0xff) / 255.0F, (toolkit.anInt9293 >> 0 & 0xff) / 255.0F);
            } else {
                class290.aVector3f_3232.set(0.0F, 0.0F, 0.0F);
            }
