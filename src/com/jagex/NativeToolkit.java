...
public abstract class NativeToolkit extends Toolkit {
    ...
    boolean aBool9276;
    Matrix4x3 aClass405_9277;
    Matrix4f aClass399_9278;
    Matrix4x3 aClass405_9280;
    int anInt9282 = 0;
    Matrix4f aClass399_9283;
    Matrix4x3 aClass405_9284;
    int anInt9285;
    Matrix4x3 aClass405_9287;
    float[] aFloatArray9288;
    Matrix4f aClass399_9289;
    Vector3f aVector3f_9290;
    ...
    Matrix4x3 aClass405_9429;
    NativeToolkit(TextureMetricsList metricsList, TextureLoader textureLoader, BillboardLoader billboardLoader,
                  ParticleProducerDefinitionLoader particleLoader, Interface44 interface44, Archive shaders, int i, int i_223_) {
        super(metricsList, textureLoader, billboardLoader, particleLoader, interface44);
        aClass644_9273 = new Deque();
        aClass405_9277 = new Matrix4x3();
        aClass399_9278 = new Matrix4f();
        aClass405_9316 = new Matrix4x3();
        aClass405_9280 = new Matrix4x3();
        aClass399_9281 = new Matrix4f();
        aClass399_9323 = new Matrix4f();
        aClass399_9283 = new Matrix4f();
        aClass405_9284 = new Matrix4x3();
        aClass399_9315 = new Matrix4f();
        aClass405_9287 = new Matrix4x3();
        aClass399_9324 = new Matrix4f();
        aClass399_9289 = new Matrix4f();
        aVector3f_9290 = new Vector3f();
        ...
        try {
            ...
            if (anTextureLoader_1546 != null) {
                aClass321_9360 = new Native2DTextureCache(this, anTextureLoader_1546);
            } else {
                aClass321_9360 = null;
            }
    ...
    public final void method14596() {
        ...
        aClass323_9423 = method14696(new Class320(Class316.aClass316_3,
                Class316.aClass316_9));
        aClass323_9291 = method14696(new Class320(Class316.aClass316_3,
                Class316.aClass316_2));
        aClass323_9375 = method14696(new Class320(Class316.aClass316_3),
                new Class320(Class316.aClass316_2), new Class320(Class316.aClass316_9),
                new Class320(Class316.aClass316_1));
        aClass323_9421 = method14696(new Class320(Class316.aClass316_3),
                new Class320(Class316.aClass316_2), new Class320(Class316.aClass316_9));
        for (int i = 0; i < 8; i++) {
    ...
    @Override
    public final Matrix4x3 getMatrix4x3() {
    ...
    @Override
    public final SceneGraphLevel createGround(int i, int i_197_, int[][] is, int[][] is_198_, int i_199_, int i_200_, int i_201_) {
        return new NativeSceneGraphLevel(this, i_200_, i_201_, i, i_197_, is, is_198_, i_199_);
    }

    @Override
    public final void method2470(ParticleEntities particleEntities) {
        aClass319_9404.method5723(this, particleEntities);
    }
    ...
    @Override
    public int update(int i, int i_64_, int i_65_, int i_66_, int i_67_, int i_68_) {
        int i_69_ = 0;
    ...
    final void method14601() {
        ...
        aClass323_9420 = method14696(new Class320(Class316.aClass316_3,
    ...
    final void method14602() {
        ...
        aClass323_9419 = method14696(new Class320(Class316.aClass316_3));
    }
    ...
    void method2374() {
        if (!aBool9253) {
            method14731();
            aClass321_9360.clear();
            for (Node class480 = aClass644_9273.head(); class480 != null; class480 = aClass644_9273.next()) {
    ...
    @Override
    boolean method2377(int i, int i_194_, int i_195_, int i_196_, Matrix4x3 class405, Class379 class379) {
        Matrix4f class399 = aClass399_9324;
        class399.method6548(class405);
        class399.method6547(aClass399_9302);
