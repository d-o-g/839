...
public class GraphicDefinition implements Definition {
    ...
    static void method10406(Component class226, Component class226_46_) {
        OutgoingFrame frame = OutgoingFrame.prepare(OutgoingFrameMeta.aClass366_3933, Client.gameConnection.encryptor);
        frame.payload.writeShort(class226.index * -592186295);
        frame.payload.writeLEShort(1391525437 * class226_46_.itemId);
        frame.payload.writeInt(1857819631 * class226_46_.uid);
        frame.payload.writeIMEInt(class226.uid * 1857819631);
        frame.payload.writeLEShort(-592186295 * class226_46_.index);
        frame.payload.writeLEShort(class226.itemId * 1391525437);
    ...
    public final Model method10391(Toolkit toolkit, int i, int i_16_, SceneGraphLevel class120, SceneGraphLevel class120_17_, int i_18_,
                                   int i_19_, int i_20_, Animator animator, byte i_21_) {
        return method10392(toolkit, i, true, class120, class120_17_, i_18_, i_19_, i_20_, i_16_, 0, 0, 0, animator,
                i_21_);
    }

    public final Model method10394(Toolkit toolkit, int i, Animator animator, byte i_38_) {
        return method10392(toolkit, i, false, null, null, 0, 0, 0, 0, 0, 0, 0, animator, i_38_);
    }

    public final Model method10402(Toolkit toolkit, int i, int i_40_, int i_41_, int i_42_, int i_43_,
                                   Animator animator, byte i_44_, int i_45_) {
        if (aByte7985 != 3) {
            return method10392(toolkit, i, false, null, null, 0, 0, 0, i_40_, 0, 0, 0, animator, i_44_);
        }

        return method10392(toolkit, i, true, null, null, 0, 0, 0, i_40_, i_41_, i_42_, i_43_, animator, i_44_);
    }
    ...
    final Model method10392(Toolkit toolkit, int functionMask, boolean bool, SceneGraphLevel class120, SceneGraphLevel class120_23_,
                            int i_24_, int i_25_, int i_26_, int yaw, int pitch, int roll, int dy, Animator animator, byte i_31_) {
        ...
        if (animator != null) {
            animator.method13458(class143_37_, 0);
        }
