...
public class LoadingRequirement {
    ...
    public static LoadingRequirement varpbits = new LoadingRequirement(LoadingRequirementType.ARCHIVE);
    public static LoadingRequirement interfaces = new LoadingRequirement(LoadingRequirementType.ARCHIVE);
    ...
    public static LoadingRequirement[] values() {
        return new LoadingRequirement[]{defaults, jaclib, jaggl, jagdx, sw3d, hw3d, shaders, textureDefs, config,
                objects, enumerations, npcs, items, animations, graphics, varpbits, quickChat, restrictedQuickChat,
                particles, billboards, huffman, interfaces, scripts, fonts, worldMap};
    }
