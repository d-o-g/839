...
public class Class186 {
        ...
        if (bool_99_) {
            try {
                ...
                if (Class199.preferences.currentToolkit.getValue() == 3) {
                    ...
                    GraphicsCard type = Class60.activeToolkit.getGraphicsCard();
    ...
    public void method3590(int i, int i_0_) {
        if (!aBool2015) {
            ...
            aClass168_2012.setSweeper(new Class164(this));
    ...
    public Class456 method3609(Class171 class171, Object object, int i, int i_17_, int i_18_, int i_19_,
                               Class167 class167, float f, float f_20_, Vector3f vector3f, int i_21_, int i_22_, boolean bool) {
        if (!aBool2015) {
            return null;
        } else if (object == null) {
            return null;
        ...
        if (Class167.aClass167_1926 != class167 && !method3608(aVector3f_2025, vector3f, f_20_)) {
            return null;
        }
        ...
        SomeSerializable interface66 = method3607(i, bool);
    ...
    public void method3615() {
        if (aBool2015) {
            ...
            if (Client.localPlayer != null && Client.localPlayer.getCoordinateSpace() != null) {
                if (aVector3f_2025 == null) {
                    aVector3f_2025 = new Vector3f();
                }
                aVector3f_2025.x = Client.localPlayer.getCoordinateSpace().translation.x;
                aVector3f_2025.y = 0.0F;
                aVector3f_2025.z = Client.localPlayer.getCoordinateSpace().translation.z;
            }

            Iterator<SomeSerializable> iterator = aHashMap2018.values().iterator();
            while (iterator.hasNext()) {
                SomeSerializable interface66 = iterator.next();
            ...
            if (null != aClass456_2009 && aClass456_2009.method7436() == Class455.aClass455_5113 && !aBool2030
                    ...
                    && BaseAnimationDefinitionProvider.method3320(Client.connectionState * -1501875989)) {
            ...
            if (class456 != null && class456.method7444().getId() == i) {
                ...
                if (class456_45_ == null) {
                    if (bool) {
                        float f = i_40_;
                        float f_46_ = i_41_;
                        Vector3f vector3f = new Vector3f(i_38_, 0.0F, i_39_);
                ...
                if (class456_45_ != null) {
                    ...
                    if (Client.gameConnection.encryptor != null
                            && BaseAnimationDefinitionProvider.method3320(-1501875989 * Client.connectionState)) {
                        OutgoingFrame frame = OutgoingFrame.prepare(OutgoingFrameMeta.aClass366_3981,
                                Client.gameConnection.encryptor);
    ...
    public void method3661(Animation class175, int i, byte i_51_) {
    ...
    public void method3710(Class171 class171, int i, int i_63_, int i_64_, int i_65_, Class167 class167, float f,
                           float f_66_, Vector3f vector3f, int i_67_, int i_68_, int i_69_) {
        if (aBool2015) {
            Class456 class456 = method3609(class171, this, i, i_63_, i_64_, i_65_, class167, f, f_66_, vector3f, i_67_,
                    i_68_, false);
            if (null != class456) {
                if (i_69_ == 0) {
                    class456.method7430();
    ...
    public void method3714(Animation class175, int i, SceneNode class600_sub1) {
        if (null != class175 && class175.anIntArrayArray1975 != null && i < class175.anIntArrayArray1975.length
            ...
            if (i_75_ == 0) {
                ...
                int i_80_ = (int) vector3f.x - 256 >> 9;
                int i_81_ = (int) vector3f.z - 256 >> 9;
                Vector3f vector3f_82_ = new Vector3f(i_80_ << 9, 0.0F, i_81_ << 9);
                ...
                method3710(Class171.aClass171_1953, i_73_, i_74_, i_78_, Class156.aClass156_1879.method3293(),
                        ...
                        i_75_ << 9, vector3f_82_, i_83_, i_77_, 0);
            }
        }
    }
    ...
    SomeSerializable method3604(int i, boolean bool) {
        if (!aBool2015) {
            return null;
        }
        SomeSerializable interface66 = (SomeSerializable) (bool ? aClass168_2022.get(i) : aClass168_2012.get(i));
        if (interface66 == null) {
            if (bool) {
                interface66 = (SomeSerializable) aHashMap2027.get(Integer.valueOf(i));
            } else {
                interface66 = (SomeSerializable) aHashMap2018.get(Integer.valueOf(i));
            }
        }
        return interface66;
    }
    ...
    Class456 method3606(SomeSerializable interface66) {
        if (!aBool2015) {
            return null;
        }
        int i_13_ = 0;
    ...
    SomeSerializable method3607(int i, boolean music) {
        if (!aBool2015) {
            return null;
        }

        SomeSerializable interface66 = method3604(i, music);
        if (null == interface66) {
    ...
    boolean method3608(Vector3f vector3f, Vector3f vector3f_15_, float f) {
        Vector3f vector3f_16_ = Vector3f.difference(vector3f_15_, vector3f);
        return vector3f_16_.distance() < f;
    }
