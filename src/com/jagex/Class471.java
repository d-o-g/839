...
public class Class471 {
    ...
    public static void method8058(String name) {
        if (Client.componentSelected && (Class577.selectedComponentAttributes * -1564025309 & 0x18) != 0) {
            boolean found = false;
            ...
            for (int index = 0; index < count; index++) {
                ...
                if (null != player.accountName
                        ...
                        && 0 != (Class577.selectedComponentAttributes * -1564025309 & 0x10) || 0 != (-1564025309
                        * Class577.selectedComponentAttributes & 0x8))) {
                    ...
                    frame.payload.writeLEInt(SceneGraph.anInt6751 * 1969702363);
