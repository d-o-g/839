...
public class CutsceneObject {
    public static TextureLoader anTextureLoader_1944;
    ...
    static void renderPlayersOnMinimap(int i, int i_14_, Component component, ClippingMask class129, int i_15_, int i_16_, int i_17_) {
        ...
        for (int index = 0; index < count; index++) {
            ...
            if (null != player && player.hasAppearance() && !player.aBool11783 && Client.localPlayer != player
                ...
                int i_20_ = (int) vector3f.x / 128 - i / 128;
                int i_21_ = (int) vector3f.z / 128 - i_14_ / 128;
                ...
                if (player.appearance != null && player.appearance.npc * 1639350421 != -1
                    ...
                    Class369.addMapSprite(component, class129, i_15_, i_16_, i_20_, i_21_, Client.mapDots[1]);
                } else if (player.aPlayerMapDot_11782 == PlayerMapDot.aPlayerMapDot_2091) {
                    Class369.addMapSprite(component, class129, i_15_, i_16_, i_20_, i_21_, Client.mapDots[8]);
                } else if (player.aPlayerMapDot_11782 == PlayerMapDot.aPlayerMapDot_2092) {
                    Class369.addMapSprite(component, class129, i_15_, i_16_, i_20_, i_21_, Client.mapDots[6]);
                } else if (bool_25_) {
                    Class369.addMapSprite(component, class129, i_15_, i_16_, i_20_, i_21_, Client.mapDots[4]);
                } else if (player.clanmate) {
                    Class369.addMapSprite(component, class129, i_15_, i_16_, i_20_, i_21_, Client.mapDots[7]);
                } else if (isFriend) {
                    Class369.addMapSprite(component, class129, i_15_, i_16_, i_20_, i_21_, Client.mapDots[3]);
                } else if (bool_23_) {
                    Class369.addMapSprite(component, class129, i_15_, i_16_, i_20_, i_21_, Client.mapDots[5]);
                } else {
                    Class369.addMapSprite(component, class129, i_15_, i_16_, i_20_, i_21_, Client.mapDots[2]);
                }
            }
        }
    }
        ...
        if (id * -2046454043 >= 0) {
            ...
            if (animations != null) {
                for (int animation : animations) {
                    loaded &= Animation.loader.get(animation).ready();
                }
            }
