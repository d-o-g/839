...
public class HitsplatDefinition implements Definition {
    ...
    public final HitsplatDefinition method9036(VariableLoader interface14, VariableProvider interface12) {
        ...
        if (-1 != 1935331655 * varbit) {
            VarpBit bits = interface14.getVarpBit(varbit * 1935331655);
            if (bits != null) {
                index = interface12.getVarpBitValue(bits);
            }
        } else if (-1 != -1139445169 * varp) {
            Varp class131 = interface14.getVarp(VarpType.PLAYER, -1139445169 * varp);
            if (class131 != null) {
                index = interface12.getVarpValue(class131);
            }
        }
