        ...
        synchronized (Class642_Sub3.aclient10561) {
            if (Client.fullScreenFrame != null) {
                ...
                if (container == null) {
                    ...
                    Engine.gameCanvas.setSize(Engine.screenWidth * 1319181337, Engine.screenHeight * -551672947);
                    ...
                    if (container == Engine.frame) {
                        Insets insets = Engine.frame.getInsets();
                        Engine.gameCanvas.setLocation(Engine.anInt6498 * 1489471141 + insets.left, insets.top
                                + -1495234169 * Engine.anInt6499);
                    } else {
                        Engine.gameCanvas.setLocation(1489471141 * Engine.anInt6498, -1495234169 * Engine.anInt6499);
                    }
