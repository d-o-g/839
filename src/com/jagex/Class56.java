...
public class Class56 {
    ...
    static MenuItem aClass480_Sub31_Sub17_615;
    static int anInt616 = 184295856;
    static ReferenceCache aClass168_617;
    static boolean aBool620 = false;
    static int anInt621;
    static Matrix4x3 aClass405_625;
    static Queue<ExpandableMenuItem> expandableMenuItems;
    static int anInt632;
    static int expandedMenuX;
    static Component aClass226_636;
    static int anInt637;
    static int anInt638;
    static int anInt639;
    static int anInt640;
    ...
    static ExpandableMenuItem expandedMenuItem = null;
    static MenuItem topMenuItem;
    static int anInt648;
    static float[] aFloatArray651;

    static {
        MenuItem.options = new Deque();
        ExpandableMenuItem.categories = new HashTable(16);
        expandableMenuItems = new Queue();
        aClass644_614 = new Deque();
        aClass644_613 = new Deque();
        ExpandableMenuItem.cache = new ReferenceCache(30);
        aClass226_636 = null;
        anInt637 = 1357380675;
        anInt638 = -534298803;
        anInt639 = 779078951;
    ...
    static boolean method1351(Toolkit toolkit, int i) {
        toolkit.method2456();
        TimeUtil.time();
        ...
        int i_5_ = Client.scene.getMapWidth();
        int i_6_ = Client.scene.getMapLength();
        ...
        if (Class63.aBool944) {
            ...
            NativeAttachBuffer nativeAttachBuffer = toolkit.method2774(i_17_, i_17_);
            class146_sub2.method14255(nativeAttachBuffer);
        ...
        for (int i_24_ = i_11_; i_24_ < i_11_ + i_5_; i_24_ += i_10_) {
            for (int i_25_ = i_12_; i_25_ < i_6_ + i_12_; i_25_ += i_10_) {
                ...
                for (int i_33_ = i_7_; i_33_ <= 3; i_33_++) {
                    ...
                    sceneGraph.levels[i_33_].renderPlan(i_19_, i_20_, 1024, i_28_, i_29_, i_30_, i_31_, bools);
