...
public final class OpenGlXToolkit extends NativeToolkit {
    ...
    String description;
    int version;
    OpenGlXToolkit(OpenGL opengl, Canvas canvas, long l, TextureMetricsList metricsList, TextureLoader textureLoader,
        ...
        super(metricsList, textureLoader, billboardLoader, particleLoader, interface44, shaders, i, 1);
    ...
    public static Toolkit create(Canvas canvas, TextureMetricsList class147, TextureLoader textureLoader,
        ...
        try {
            ...
            OpenGlXToolkit toolkit = new OpenGlXToolkit(gl, canvas, l, class147, textureLoader, billboardLoader,
    ...
    public final synchronized void method2375(int i) {
        ...
        while (!aClass644_10960.isEmpty()) {
            IntegerNode class480_sub24 = (IntegerNode) aClass644_10960.popHead();
        ...
        while (!deletedTextures.isEmpty()) {
            IntegerNode class480_sub24 = (IntegerNode) deletedTextures.popHead();
            anIntArray10975[i_20_++] = (int) (class480_sub24.linkedKey * -4821875126325281949L);
        ...
        while (!aClass644_10964.isEmpty()) {
            IntegerNode class480_sub24 = (IntegerNode) aClass644_10964.popHead();
        ...
        while (!deletedRenderBuffers.isEmpty()) {
            IntegerNode class480_sub24 = (IntegerNode) deletedRenderBuffers.popHead();
            anIntArray10975[i_20_++] = (int) (class480_sub24.linkedKey * -4821875126325281949L);
    ...
    @Override
    public NativeAttachment method2401(int i, int i_6_, Class121 class121, Class151 class151, int i_7_) {
        return new OpenGlXAttachableRenderBuffer(this, class121, class151, i, i_6_, i_7_);
    }

    @Override
    public NativeAttachBuffer method2403(int i, int i_34_, int i_35_) {
    ...
    @Override
    public NativeAttachBuffer method2774(int i, int i_8_) {
    ...
    public boolean method2806() {
        return !aBool10967 || aLongArray10980[anInt11002] == 0L;
    }
    ...
    public GraphicsCard getGraphicsCard() {
        ...
        return new GraphicsCard(vendor, isFixedFunction() ? "OpenGL FF" : "OpenGL", version, description, 0L);
    }
    ...
    final synchronized void method17351(int i, int i_50_) {
        IntegerNode class480_sub24 = new IntegerNode(i_50_);
    ...
    final synchronized void method17354(int i) {
        IntegerNode class480_sub24 = new IntegerNode(i);
