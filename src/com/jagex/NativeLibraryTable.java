...
public class NativeLibraryTable implements NativeLibraryProvider {
    ...
    public boolean clear() {
        ...
        try {
            Class<AccessibleObject> accessibleObject = (Class<AccessibleObject>) Class.forName("java.lang.reflect.AccessibleObject");
    ...
    void load(String string, Class clazz) throws NativeLibraryLoadException {
        ...
        if (null != file) {
            try {
                ...
                Class<AccessibleObject> accessible = (Class<AccessibleObject>) Class.forName("java.lang.reflect.AccessibleObject");

                Method setAccessible = accessible.getDeclaredMethod("setAccessible", Boolean.TYPE);
                Method load0 = runtime.getDeclaredMethod("load0", Class.forName("java.lang.Class"), Class.forName("java.lang.String"));
