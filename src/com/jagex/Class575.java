...
public class Class575 {
    ...
    public static ResourceCache aClass507_7710;
    ...
    public Class575(Toolkit toolkit, Archive images, int i, int i_12_) {
        aVector3f_7696 = new Vector3f(-50.0F, -60.0F, -50.0F);
    ...
    public static void method9765(Interface44 interface44) {
        ...
        Class570.particleSystems = new LinkedList();
        Particle.cache = new Particle[1024];
        ParticleSystem.cache = new ParticleSystem[1 + ParticleSystem.maxParticleSystems[ParticleSystem.particleSetting
                * -897945427]];
        ParticleSystem.particleCount = 0;
        ParticleSystem.cachedCount = 0;
        PlayerMapDot.anInterface44_2095 = interface44;
    }

    static final void method9766(InterfaceNode class480_sub41, int i, int i_31_, int i_32_, int i_33_, int i_34_,
        ...
        if (Component.loadInterface(i, null)) {
            if (class480_sub41 != null && !class480_sub41.method16250()) {
                ...
                Client.method17015(class221, class221.getComponents(), -1, i_31_, i_32_, i_33_, i_34_, i_35_, i_36_,
                        i_37_, i_38_);
            }
        }
    }

    public void method9694(Scene scene) {
        Class569 class569 = method9706(scene);
    ...
    public void method9696(Scene scene, Class591 class591, int i) {
    ...
    public void method9711(float f, float f_15_, float f_16_, int i, int i_17_, int i_18_, int i_19_, int i_20_) {
        toolkit.method2476((0.7F + Class199.preferences.brightness.getValue() * 0.1F + Client.scene
                .method7752()) * f);
    ...
    public void method9727(Scene scene) {
        Class569 class569 = method9706(scene);
        if (null != aClass591_7709) {
            aClass569_7695.copyFrom(class569);
            aClass569_7695.method9598(this, aClass591_7709);
    ...
    public void method9734(int i, int i_28_) {
        ...
        if (class569 != null) {
            aVector3f_7696.copyFrom(class569.aVector3f_7618);
        }
        method9710();
    }
    ...
    Class487 method9702(int skybox, int i_4_, int i_5_, int i_6_) {
        long l = (i_4_ & 65535L) << 48 | (i_5_ & 0xffffL) << 32 | (i_6_ & 0xffffL) << 16 | skybox & 0xffffL;
        Class487 class487 = (Class487) aClass168_7698.get(l);
        if (class487 == null) {
            class487 = Class487.createSkybox(skybox, i_4_, i_5_, i_6_, SkyboxDefinition.loader, SunDefinition.loader);
    ...
    Class569 method9706(Scene scene) {
        int regionX = -1;
        int regionZ = -1;

        if (AsynchronousStreamRequest.loggedOutState(Client.connectionState * -1501875989)
                || Class456.lobbyState(Client.connectionState * -1501875989)) {
            regionX = 2006359481 * Client.cameraX >> 12;
            regionZ = 1829446257 * Client.cameraZ >> 12;
        } else {
            ...
            if (regionX < 0 || regionX >= scene.getMapWidth() >> 3 || regionZ < 0
                    || regionZ >= scene.getMapLength() >> 3) {
                regionX = scene.getMapWidth() >> 4;
                regionZ = scene.getMapLength() >> 4;
            }
        }
    ...
    void method9710() {
        ...
        toolkit.method2477(-1514981919 * aClass569_7684.anInt7617, aClass569_7684.aFloat7616,
                aClass569_7684.aFloat7632, (int) aVector3f_7696.x << 2, (int) aVector3f_7696.y << 2,
                (int) aVector3f_7696.z << 2);
