...
public class Class263 implements Interface27 {
    ...
    public void method156(boolean bool, int i) {
        if (!aBool2952 && !aBool2948) {
            ...
            try {
                ...
                if (strings.length < 3) {
                    ...
                    MediaTracker tracker = new MediaTracker(Engine.gameCanvas);
                    int i_2_ = 0;
        ...
        if (aBool2952) {
            ...
            if (graphics != null) {
                try {
                    aString2949 = new StringBuilder().append(IgnoredPlayer.aClass266_670.method5022())
                            .append("%").toString();
                    aString2950 = IgnoredPlayer.aClass266_670.method5016();
                    if (ClanMember.anImage3166 == null) {
                        ClanMember.anImage3166 = Engine.gameCanvas.createImage(Engine.screenWidth * 1319181337,
                                Engine.screenHeight * -551672947);
                    }
                    Graphics graphics_8_ = ClanMember.anImage3166.getGraphics();
