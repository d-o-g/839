...
public class PlayerAppearance {
    ...
    static final void method9805(Component class226, Interface class221, ScriptExecutionContext class613, int i) {
        ...
        if (class226.index * -592186295 == -1 && !class221.closed) {
            PulseEvent.resetComponentScrollPosition(1857819631 * class226.uid);
        }
    }
    ...
    static DefaultHashMap method9807(Buffer buffer, DefaultProvidingVarpLoader varpLoader) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                DefaultMapEntry entry = varpLoader.decodeTypedEntry(buffer, type);
                if (entry != null) {
    ...
    public Model method9773(Toolkit toolkit, int initialMask, Class678_Sub6 class678_sub6,
                            ...
                            VariableLoader interface14, VariableProvider interface12, Animator animator, Animator animator_10_,
                            Animator[] animators, int[] is, int i_11_, boolean bool, EquipmentDefaults class561) {
        if (-1 != npc * 1639350421) {
            return npcLoader.get(1639350421 * npc).method5103(toolkit, initialMask, class678_sub6, interface14,
                    interface12, animator, animator_10_, animators, is, i_11_, null);
        }
        ...
        int i_23_ = animators != null ? animators.length : 0;
        for (int i_24_ = 0; i_24_ < i_23_; i_24_++) {
            if (animators[i_24_] != null) {
                functionMask |= animators[i_24_].method13457();
                bool_22_ = true;
            }
        }
        if (null != animator) {
            functionMask |= animator.method13457();
            bool_22_ = true;
        }
        if (null != animator_10_) {
            functionMask |= animator_10_.method13457();
            bool_22_ = true;
        }
        ...
        int i_49_ = 1;
        while (i_48_ < i_23_) {
            if (null != animators[i_48_]) {
                animators[i_48_].method13459(class143_46_, 0, i_49_, 1386035661);
            }
            i_48_++;
            i_49_ <<= 1;
        }
        ...
        if (animator != null && null != animator_10_) {
            QuestDefinitionProvider.method4610(class143_46_, animator, animator_10_);
        } else if (null != animator) {
            animator.method13458(class143_46_, 0);
        } else if (null != animator_10_) {
            animator_10_.method13458(class143_46_, 0);
        }
        return class143_46_;
    }
    ...
    public Model createHeadModel(Toolkit toolkit, int i, IdentikitDefinitionLoader kitLoader,
                                 ...
                                 VariableProvider interface12, Animator animator) {
        if (-1 != 1639350421 * npc) {
            return npcLoader.get(npc * 1639350421).method5105(toolkit, i, interface14, interface12, animator, null);
        }

        int i_51_ = null != animator ? i | animator.method13457() : i;
        Model cached;
        synchronized (models) {
    ...
    public Model createHeadModel(Toolkit toolkit, int i, IdentikitDefinitionLoader kitLoader,
                                 AnimationDefinitionLoader class678_sub10, Animator animator, int i_61_, int i_62_, int i_63_, int i_64_) {
        int i_65_ = null != animator ? i | animator.method13457() : i;
