...
public class DirectXDirectDisplay extends NativeDirectDisplay {
    ...
    @Override
    public void method14255(NativeAttachBuffer nativeAttachBuffer) {
        Interface48 interface48 = (Interface48) nativeAttachBuffer;

        if (nativeAttachBuffer != null) {
            if (anInt11661 != 0) {
    ...
    @Override
    public void method14256(int i, NativeAttachment nativeAttachment) {
        int i_6_ = 1 << i;
        Interface46 interface46 = (Interface46) nativeAttachment;
        ...
        if (nativeAttachment != null) {
            ...
            if (aBool11662) {
                setRenderTarget(i, interface46.getIdentifier());
            }
        } else {
    ...
    boolean setRenderTarget(int i, long l) {
