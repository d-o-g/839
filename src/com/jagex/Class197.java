...
public class Class197 implements VarpInstrution {
    ...
    static void method3862() {
        ...
        for (int i_0_ = 0; i_0_ < PlayerFacade.instance.skills.length; i_0_++) {
            Skill class565 = new Skill(Class197.aClass566_9252.method9565(i_0_), false);
            class565.method9532(0);
            class565.method9529(0);
            PlayerFacade.instance.skills[i_0_] = class565;
        }
    ...
    static final void method3864(Component class226, Interface class221, ScriptExecutionContext class613) {
        class226.modelType = 1219093618;
        ...
        if (-1 == class226.index * -592186295 && !class221.closed) {
            PulseEvent.method7175(class226.uid * 1857819631);
        }
    }

    static void method3866(Component class226, int i, int i_1_, byte i_2_) {
    ...
    public void execute(MappingVarpProvider mappingVarpProvider) {
        mappingVarpProvider.method3833(97899145 * anInt2089);
        mappingVarpProvider.method3806(anInt2089 * 97899145);
    }
