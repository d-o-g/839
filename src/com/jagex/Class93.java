...
public class Class93 {
    ...
    Class93(OpenGlToolkit toolkit, Class91 class91, OpenGlSceneGraphLevel ground, int i, int i_9_, int i_10_, int i_11_,
            int i_12_) {
        anInt1269 = -1;
        ...
        if (i_14_ > 0) {
            ...
            anInterface15_1274 = toolkit.createElementArrayBuffer(buffer.payload, buffer.caret * -165875887, false);
