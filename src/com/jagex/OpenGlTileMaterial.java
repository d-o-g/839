...
public class OpenGlTileMaterial extends Node {
    ...
    OpenGlTileMaterial(OpenGlSceneGraphLevel ground, int texture, int scale, Class150 class150) {
        this.ground = ground;
    ...
    void render(int[] tiles, int length) {
        ...
        if (count > 0) {
            indices.write(buffer.payload, buffer.caret * -165875887);
