...
public class Matrix4x3 {
    ...
    public static Matrix4x3 primeMatrix = new Matrix4x3();
    ...
    public Matrix4x3(Matrix4x3 class405_113_) {
        copyFrom(class405_113_);
    }

    public void method6725(Matrix4x3 class405_0_) {
        if (class405_0_ == this) {
            method6735();
        } else {
    ...
    public void copyFrom(Matrix4x3 other) {
    ...
    public void method6728(CoordinateSpace coordinateSpace) {
        method6737(coordinateSpace.rotation);
        method6747(coordinateSpace.translation);
    }

    public void store(CoordinateSpace coordinateSpace) {
        float f = coordinateSpace.rotation.w * coordinateSpace.rotation.w;
        float f_2_ = coordinateSpace.rotation.w * coordinateSpace.rotation.x;
        float f_3_ = coordinateSpace.rotation.w * coordinateSpace.rotation.y;
        float f_4_ = coordinateSpace.rotation.w * coordinateSpace.rotation.z;
        float f_5_ = coordinateSpace.rotation.x * coordinateSpace.rotation.x;
        float f_6_ = coordinateSpace.rotation.x * coordinateSpace.rotation.y;
        float f_7_ = coordinateSpace.rotation.x * coordinateSpace.rotation.z;
        float f_8_ = coordinateSpace.rotation.y * coordinateSpace.rotation.y;
        float f_9_ = coordinateSpace.rotation.y * coordinateSpace.rotation.z;
        float f_10_ = coordinateSpace.rotation.z * coordinateSpace.rotation.z;
        ...
        aFloat4565 = coordinateSpace.translation.x;
        aFloat4566 = coordinateSpace.translation.y;
        aFloat4567 = coordinateSpace.translation.z;
    }
    ...
    public void method6737(Quaternion quaternion) {
        method6738(quaternion.x, quaternion.y, quaternion.z, quaternion.w);
    }
    ...
    public void method6745(Matrix4x3 other) {
        float f = aFloat4556;
    ...
    public void method6746(Matrix4x3 class405_84_, Matrix4x3 class405_85_) {
    ...
    public void method6747(Vector3f vector3f) {
        method6744(vector3f.x, vector3f.y, vector3f.z);
    }
