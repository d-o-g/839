...
public class SkillVarpProvider {

    String aString2100;
    long aLong2102;
    Skill[] aClass565Array2103;
    ...
    SkillVarpProvider(Buffer buffer, boolean bool, boolean bool_3_, BigBoyVarpProvider bigBoyVarpProvider) {
        if (bool) {
        ...
        aBool2105 = 0 != (i & 0x1);
        aBool2111 = (i & 0x2) != 0;
        aClass565Array2103 = new Skill[bigBoyVarpProvider.method121().method9564()];
        ...
        for (int i_5_ = 0; i_5_ < aClass565Array2103.length; i_5_++) {
            Skill class565 = aClass565Array2103[i_5_] = new Skill(bigBoyVarpProvider.method121().method9565(i_5_), true);
            if (i_5_ < i_4_) {
        ...
        aClass666_2104 = new DefaultHashMap(bigBoyVarpProvider.method128());
        for (int i_7_ = 0; i_7_ < i_6_; i_7_++) {
            DefaultMapEntry entry = bigBoyVarpProvider.method128().decode(buffer);
    ...
    public void method3892(BigBoyVarpProvider bigBoyVarpProvider) {
        if (null == aClass666_2112) {
            aClass666_2112 = new DefaultHashMap(bigBoyVarpProvider.method128());
        } else {
