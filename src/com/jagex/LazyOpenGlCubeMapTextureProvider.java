...
public class LazyOpenGlCubeMapTextureProvider extends OpenGlCubeMapTextureProvider {
    ...
    OpenGlCubeMapTexture getTexture() {
        if (texture == null) {
            TextureLoader textureLoader = toolkit.anTextureLoader_1546;
            ...
            if (metrics == null) {
                ...
                return null;
            } else if (!textureLoader.loaded(TextureType.TEXTURE, id)) {
                return null;
            }

            int[] source = textureLoader.loadTranslucent(TextureType.TEXTURE, id, 1.0F);
