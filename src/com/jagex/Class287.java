...
public class Class287 implements Interface28 {
    ...
    public static World method5302() {
        if (359181819 * Class671.worldCount < Class671.worlds.length) {
            return Class671.worlds[(Class671.worldCount += 374560051) * 359181819 - 1];
        }
        return null;
    }
    ...
    public void method176(boolean bool) {
        ...
        if (null != class292) {
            ...
            i_1_ += drawString(Class450.b12Full, class292.aString3250, i_0_, i_1_, 5) * 12;
            i_1_ += 8;
            if (aClass330_3195.aBool3576) {
            ...
            i_1_ = ++i_1_ + drawString(Class450.b12Full, class292.aString3249, i_0_, i_1_, 5) * 12;
            i_1_ += 5;
            i_1_ += drawString(Class450.b12Full, class292.aString3248, i_0_, i_1_, 5) * 12;
        }
    }

    int drawString(Font font, String string, int i, int i_2_, int i_3_) {
