...
public class Class614 {
    ...
    public static CameraEvent method10358(int i, Class228 class228, Buffer buffer, int i_9_) {
        if (class228 == Class228.aClass228_2570) {
            return new CameraShake(i, buffer);
        }
    ...
    static void method10356() {
        ...
        if (-1 != 105362857 * Class65.consoleScriptIndex
            ...
            for (int i_2_ = 105362857 * Class65.consoleScriptIndex; i_2_ < BaseCursorDefinitionProvider.consoleScript.length; i_2_++) {
                if (BaseCursorDefinitionProvider.consoleScript[i_2_].startsWith("pause")) {
                    ...
                    Client.printToConsole(new StringBuilder().append("Pausing for ").append(i_3_)
        ...
        for (int i_4_ = 0; i_4_ < 1019900971 * Client.anInt10690; i_4_++) {
            ...
            if (80 == i_5_) {
                ...
                if (PlayerMapDot.aClipboard2096 != null) {
                    String string = "";
                    ...
                    PlayerMapDot.aClipboard2096.setContents(new StringSelection(string), null);
                }
                ...
                Class65.consoleText = new StringBuilder()
                        .append(Class65.consoleText, 0, -581519027 * Class65.consoleTextIndex - 1)
                ...
                Class65.consoleText = new StringBuilder()
                        .append(Class65.consoleText, 0, -581519027 * Class65.consoleTextIndex)
                ...
                Class65.consoleTextIndex = Class65.consoleText.length() * -1223481467;
            } else if (Client.isAlphaNumeric(c) || "\\/.:, _-+[]~@".indexOf(c) != -1) {
                Class65.consoleText = new StringBuilder()
                        .append(Class65.consoleText, 0, Class65.consoleTextIndex * -581519027)
