...
public class Class98 {
    ...
    void method1788(OpenGlToolkit toolkit, ParticleEntities particleEntities) {
            ...
            try {
                ...
                while (next != cacheable) {
                    ...
                    for (; next != cacheable; next = next.nextCacheable) {
                        ...
                        if (i > 0 && (i_10_ != point.texture || bool != point.render)) {
                            bool_11_ = true;
                            break;
                        }
    ...
    void method1790(OpenGlToolkit class134_sub2, int i) {
        ...
        if (data.caret * -165875887 != 0) {
            anInterface11_1294.write(24, data.payload, data.caret
                    * -165875887);
            class134_sub2.setPointers(aClass94_1295, null, aClass94_1296, aClass94_1299);
            class134_sub2.method14353(7, 0, data.caret * -165875887 / 24);
        }
    }
