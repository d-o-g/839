    ...
    public static void method8821(Toolkit toolkit, long l, int i, int i_0_, int i_1_) {
        ...
        if (Class533.aBool7280) {
            ...
            if (!toolkit.method2406()) {
                ...
                toolkit.method2412(Client.engineCycle, Class554.anInt7503 * 1401702975, -1021853939 * IgnoredPlayer.anInt4246);
                Class533.aLinkedList7284.add(new Class535(Client.engineCycle, Class533.aLinkedList7260,
