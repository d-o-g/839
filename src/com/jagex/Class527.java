...
public class Class527 implements Identifiable {
    public static Class527 aClass527_7218 = new Class527(0, "", new KeyType[]{KeyType.I_LOWER,
            KeyType.S_LOWER});
    public static Class527 aClass527_7219;
    public static Class527 aClass527_7220 = new Class527(1, "", new KeyType[]{KeyType.I_LOWER,
            KeyType.I_LOWER});
    static Class527 aClass527_7221;

    static {
        aClass527_7219 = new Class527(2, "", new KeyType[]{KeyType.S_LOWER, KeyType.S_LOWER});
        aClass527_7221 = new Class527(3, "", new KeyType[]{KeyType.I_LOWER, KeyType.I_LOWER,
                KeyType.S_LOWER});
    }
    ...
    Class527(int i, String string, KeyType[] types) {
        id = i * -411689407;
        this.types = types;
    ...
    static String intToString(int value, int radix, boolean bool) {
        if (radix < 2 || radix > 36) {
            throw new IllegalArgumentException(new StringBuilder().append(radix).toString());
