...
public class Class349 {
    ...
    static void method5956(Buffer buffer) {
        for (int i_3_ = 0; i_3_ < 704263327 * Class572.anInt7657; i_3_++) {
            ...
            if (null != Class289_Sub1.worlds[i_4_]) {
                Class289_Sub1.worlds[i_4_].population = i_5_ * -1065053833;
            }
        }
    }

    static void method5957(Component class226, ClippingMask class129, int i, int i_6_, int i_7_, int i_8_,
                           Sprite class116, double d, Class203 class203, Class220 class220) {
        if (null != class116) {
            int i_10_;
            if (Client.mapState * 1212513917 == 3) {
                i_10_ = (int) (Client.camera.getYaw() * 2607.5945876176133) + Client.pendingWalkX
                        * 1093165775 & 0x3fff;
            } else if (Client.mapState * 1212513917 == 6) {
                i_10_ = (int) Client.aFloat10787 & 0x3fff;
            } else {
                i_10_ = Client.pendingWalkX * 1093165775 + (int) Client.aFloat10787 & 0x3fff;
            }
            ...
            if (i_12_ <= i_11_ * i_11_) {
                ...
                if (6 != Client.mapState * 1212513917) {
                    i_13_ = 256 * i_13_ / (Client.pendingWalkY * -1894746741 + 256);
                    i_14_ = i_14_ * 256 / (256 + -1894746741 * Client.pendingWalkY);
                }
