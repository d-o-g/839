...
public class Class148 {
    ...
    public static final void method3177(int viewX, int viewZ, int viewY, int i_8_, int i_9_) {
        ...
        if (BefriendedPlayer.anInt576 * -1261726809 >= 100) {
            ...
            int i_16_ = i_12_ - Client.cameraZ * 1829446257;
            int i_17_ = (int) Math.sqrt(i_14_ * i_14_ + i_16_ * i_16_);

            Class155.cameraPitch = ((int) (Math.atan2(i_15_, i_17_) * 2607.5945876176133) & 0x3fff) * -1300105055;
            Class550.cameraYaw = ((int) (Math.atan2(i_14_, i_16_) * -2607.5945876176133) & 0x3fff) * -1726145155;
            IncomingFrameMeta.anInt4473 = 0;

            if (912649057 * Class155.cameraPitch < 1024) {
                Class155.cameraPitch = 132285440;
            }

            if (912649057 * Class155.cameraPitch > 3072) {
                Class155.cameraPitch = 396856320;
            }
        }

        Client.mapState = -2080369111;
