...
public class IgnoredPlayer {
    ...
    public static final void method1364(int i, String string, Color color, Color color_0_, Color color_1_, int i_2_) {
        try {
            Graphics graphics = Engine.gameCanvas.getGraphics();
            ...
            try {
                if (null == ClanMember.anImage3166) {
                    ClanMember.anImage3166 = Engine.gameCanvas.createImage(Engine.screenWidth * 1319181337, -551672947
                            * Engine.screenHeight);
                }
                Graphics graphics_3_ = ClanMember.anImage3166.getGraphics();
                ...
                graphics.drawImage(ClanMember.anImage3166, 0, 0, null);
            ...
            Engine.gameCanvas.repaint();
        }
    }

    static final void method1363(Component class226, Interface class221, ScriptExecutionContext class613, byte i) {
        ...
        class226.anObjectArray2557 = World.method16248(string, class613);
