...
final class DecodingFontProvider implements FontProvider<Font> {
    static void method915() {
        if (Class60.activeToolkit.method2387()) {
            Class60.activeToolkit.method2394(Engine.gameCanvas, -1552648719);
            Class166_Sub8.method15090();

            Dimension dimension = Engine.gameCanvas.getSize();
            Class60.activeToolkit.method2392(Engine.gameCanvas, dimension.width, dimension.height);
            Class60.activeToolkit.method2620(Engine.gameCanvas);
        } else {
