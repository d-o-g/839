...
public class OpenGlToolkit extends Toolkit {
    ...
    Matrix4x3 aClass405_8962;
    Matrix4x3 aClass405_9033;
    Matrix4x3 aClass405_9045;
    ...
    Deque<IntegerNode> deletedTextures;
    Deque<IntegerNode> deletededRenderBuffers;
    Deque<Node> deletedShaders;
    ...
    OpenGlToolkit(Canvas canvas, TextureMetricsList class147, TextureLoader textureLoader, BillboardLoader interface41,
                  ParticleProducerDefinitionLoader interface42, Interface44 interface44, int i) {
        super(class147, textureLoader, interface41, interface42, interface44);
        aClass399_9000 = new Matrix4f();
        aClass399_9001 = new Matrix4f();
        aClass405_9045 = new Matrix4x3();
        anInt9005 = 8;
        shadowScale = 3;
        aBool9128 = false;
        ...
        try {
            ...
            aBool9128 = true;
            aClass119_8993 = new OpenGl2DTextureCache(this, anTextureLoader_1546);
            method14357();
    ...
    public static Toolkit create(Canvas canvas, TextureMetricsList class147, TextureLoader textureLoader,
                                 ...
                                 int multisamples) {
        return new OpenGlToolkit(canvas, class147, textureLoader, interface41, interface42, interface44, multisamples);
    }
    ...
    public final synchronized void method2375(int i) {
        ...
        while (!deletedBuffers.isEmpty()) {
            IntegerNode class480_sub24 = (IntegerNode) deletedBuffers.popHead();
        ...
        while (!deletedTextures.isEmpty()) {
            IntegerNode class480_sub24 = deletedTextures.popHead();
            anIntArray9022[i_266_++] = (int) (class480_sub24.linkedKey * -4821875126325281949L);
        ...
        while (!deletedFrameBuffers.isEmpty()) {
            IntegerNode class480_sub24 = (IntegerNode) deletedFrameBuffers.popHead();
        ...
        while (!deletededRenderBuffers.isEmpty()) {
            IntegerNode linkable = deletededRenderBuffers.popHead();
    ...
    @Override
    public NativeAttachment method2401(int i, int i_128_, Class121 class121, Class151 class151, int i_129_) {
        return new OpenGlAttachableRenderBuffer(this, class121, class151, i, i_128_, i_129_);
    }

    @Override
    public NativeAttachBuffer method2403(int i, int i_287_, int i_288_) {
    ...
    @Override
    public SceneGraphLevel createGround(int width, int length, int[][] heights, int[][] lighting, int units, int i_187_,
                                        int i_188_) {
        return new OpenGlSceneGraphLevel(this, i_187_, i_188_, width, length, heights, lighting, units);
    }

    @Override
    public void method2470(ParticleEntities particleEntities) {
        aClass98_9059.method1788(this, particleEntities);
    }

    @Override
    public final void method2471(Matrix4x3 class405) {
    ...
    @Override
    public final Matrix4f cloneMatrix4f() {
        return new Matrix4f(aClass399_9036);
    }

    @Override
    public int update(int i, int i_71_, int i_72_, int i_73_, int i_74_, int i_75_) {
        int i_76_ = 0;
    ...
    public Matrix4x3 method2754() {
        return new Matrix4x3(aClass405_9033);
    }
    ...
    @Override
    public NativeAttachBuffer method2774(int i, int i_127_) {
    ...
    public void method2824(Class480_Sub5 class480_sub5) {
        ...
        if (anInterface11_9143 == null) {
            ...
            anInterface11_9143 = createArrayBuffer(20, rsfloatbuffer.payload, rsfloatbuffer.caret * -165875887, false);
    ...
    public GraphicsCard getGraphicsCard() {
        ...
        return new GraphicsCard(vendor, "OpenGL", version, description, 0L);
    }
    ...
    final synchronized void deleteRenderBuffer(int identifier, int size) {
        IntegerNode linkable = new IntegerNode(size);
    ...
    final synchronized void deleteFrameBuffer(int identifer) {
        IntegerNode class480_sub24 = new IntegerNode(identifer);
    ...
    final synchronized void deleteBuffer(int name, int length) {
        IntegerNode linkable = new IntegerNode(length);
        linkable.linkedKey = name * -7096345066895942069L;
    ...
    final synchronized void deleteShader(long shader) {
        Node node = new Node();
        node.linkedKey = shader * -7096345066895942069L;
        deletedShaders.pushBack(node);
    }

    final synchronized void deleteProgram(int program) {
        Node node = new Node();
        node.linkedKey = program * -7096345066895942069L;
        deletedPrograms.pushBack(node);
    }
    ...
    @Override
    void method2374() {
        for (Node class480 = aClass644_9009.head(); class480 != null; class480 = aClass644_9009.next()) {
    ...
    @Override
    boolean method2377(int i, int i_0_, int i_1_, int i_2_, Matrix4x3 class405, Class379 class379) {
        Matrix4f class399 = aClass399_9050;
        class399.method6548(class405);
        class399.method6547(aClass399_9087);
