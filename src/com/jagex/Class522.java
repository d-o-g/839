...
public class Class522 {
    ...
    public static void method8955(int type, String string, boolean bool) {
        if (type == 0) {
            Class60.activeToolkit = Toolkit.create(0, Engine.gameCanvas,
                    CachedParticleDefinitionLoader.aClass147_3727, CutsceneObject.anTextureLoader_1944,
            ...
            if (null != string) {
                toolkit = Toolkit.create(0, Engine.gameCanvas, CachedParticleDefinitionLoader.aClass147_3727,
                        CutsceneObject.anTextureLoader_1944, ArchiveBillboardsLoader.instance, ParticleProducerDefinition.loader,
            ...
            try {
                try {
                    Deque.method13349();
                    System.gc();
                    Class60.activeToolkit = Toolkit.create(type, Engine.gameCanvas,
                            CachedParticleDefinitionLoader.aClass147_3727, CutsceneObject.anTextureLoader_1944,
                            ArchiveBillboardsLoader.instance, ParticleProducerDefinition.loader, Class274.aClass364_3093,
                            Class54.shaders, Class199.preferences.multisample.getValue() * 2);
                    ...
                    if (Class60.activeToolkit.method2378()) {
                        ...
                        try {
                            bool_22_ = SystemInformation.systemInfo.processorInfoInt * -2033165835 > 256;
                        } catch (Throwable throwable) {
    ...
    static void method8954(Toolkit class134, int i, int i_6_, int i_7_, int i_8_, int i_9_) {
        ...
        if (Class495_Sub1.anInt10322 * 147042807 < 100) {
            ...
            Toolkit.anInt4892 = -1255863427 * (int) (i_7_ * 2 / Class495.aFloat6818);
