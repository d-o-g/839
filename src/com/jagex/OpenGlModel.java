...
public class OpenGlModel extends Model {
    ...
    @Override
    public void method2901(int i, int i_174_, SceneGraphLevel class120, SceneGraphLevel class120_175_, int i_176_, int i_177_, int i_178_) {
        if (!computedBounds) {
            computeBounds();
        }
    ...
    @Override
    public boolean method2918(int i, int i_627_, Matrix4x3 class405, boolean bool, int i_628_) {
    ...
    @Override
    public void recolor(int i, int i_789_, int i_790_, int i_791_) {
    ...
    public boolean method2938() {
        ...
        for (short element : aShortArray8900) {
            if (element != -1) {
                ...
                if (metrics.aBool1698 && !toolkit.aClass119_8993.loaded(TextureType.TEXTURE_AND_MATERIAL, metrics, -1)) {
                    return false;
                }
            }
        }
    ...
    public void method2944(Model class143, int i, int i_225_, int i_226_, boolean bool) {
        OpenGlModel model = (OpenGlModel) class143;
        if (anInt8893 != 0 && model.anInt8893 != 0) {
            int i_228_ = model.vertexCount;
            int[] is = model.vertexX;
            int[] is_229_ = model.vertexY;
            int[] is_230_ = model.vertexZ;
            short[] is_231_ = model.aShortArray8885;
            short[] is_232_ = model.aShortArray8887;
            short[] is_233_ = model.aShortArray8868;
            byte[] is_234_ = model.aByteArray8889;
            short[] is_235_;
            short[] is_236_;
            short[] is_237_;
            byte[] is_238_;
            ...
            short[] is_241_;
            byte[] is_242_;
            if (model.aClass127_8865 != null) {
                is_239_ = model.aClass127_8865.aShortArray1487;
                is_240_ = model.aClass127_8865.aShortArray1486;
                is_241_ = model.aClass127_8865.aShortArray1488;
                is_242_ = model.aClass127_8865.aByteArray1489;
            } else {
                is_239_ = null;
                is_240_ = null;
                is_241_ = null;
            ...
            int[] is_243_ = model.sharedFaces;
            short[] is_244_ = model.aShortArray8924;
            if (!model.computedBounds) {
                model.computeBounds();
            }
            int i_245_ = model.minimumY;
            int i_246_ = model.maximumY;
            int i_247_ = model.minimumX;
            int i_248_ = model.maximumX;
            int i_249_ = model.minimumZ;
            int i_250_ = model.maximumZ;
                                ...
                                for (int i_259_ = 0; i_259_ < i_228_; i_259_++) {
                                    if (i_253_ == is[i_259_] && i_254_ == is_230_[i_259_] && i_252_ == is_229_[i_259_]) {
                                        ...
                                        if (i_260_ != -1) {
                                            ...
                                            if (is_239_ == null) {
                                                Class127 class127 = model.aClass127_8865 = new Class127();
                                            ...
                                            if (model.aClass94_8905 == null
                                                    && model.aClass94_8904 != null) {
                                                model.aClass94_8904.buffer = null;
                                            }
                                            if (model.aClass94_8905 != null) {
                                                model.aClass94_8905.buffer = null;
                                            }
                                        }
                                    }
                                }
    ...
    public void transform(Matrix4x3 class405, int i, boolean bool) {
        if (aShortArray8884 != null) {
            Matrix4x3 class405_624_ = class405;
            if (bool) {
    ...
    void method14208(boolean bool) {
        ...
        if (rsfloatbuffer.caret * -165875887 != 0) {
            if (bool) {
                if (anInterface15_8908 == null) {
                    anInterface15_8908 = toolkit.createElementArrayBuffer(rsfloatbuffer.payload, rsfloatbuffer.caret
                            * -165875887, true);
                } else {
                    anInterface15_8908.write(rsfloatbuffer.payload, rsfloatbuffer.caret * -165875887);
                }
                aClass92_8907.buffer = anInterface15_8908;
            } else {
                aClass92_8907.buffer = toolkit.createElementArrayBuffer(rsfloatbuffer.payload, rsfloatbuffer.caret
                        * -165875887, false);
            }
            if (!bool) {
                aBool8910 = true;
    ...
    void method14209(boolean bool) {
        ...
        if (i != 0) {
                ...
                if (toolkit.bigEndian) {
                    for (int i_561_ = 0; i_561_ < vertexCount; i_561_++) {
                        ...
                        for (int i_567_ = i_565_; i_567_ < i_566_ && aShortArray8924[i_567_] != 0; i_567_++) {
                            ...
                            rsfloatbuffer.caret = i_568_ * i * 1258142129;
                    ...
                    for (int i_569_ = 0; i_569_ < vertexCount; i_569_++) {
                        ...
                        for (int i_575_ = i_573_; i_575_ < i_574_ && aShortArray8924[i_575_] != 0; i_575_++) {
                            ...
                            rsfloatbuffer.caret = i_576_ * i * 1258142129;
            ...
            if (bool_553_) {
                if (aClass94_8905 == null) {
                    ...
                    for (int i_585_ = 0; i_585_ < anInt8893; i_585_++) {
                        ...
                        rsfloatbuffer.caret = (i_558_ + i_590_ * i) * 1258142129;
                    ...
                    for (int i_597_ = 0; i_597_ < anInt8893; i_597_++) {
                        ...
                        rsfloatbuffer.caret = (i_558_ + (aShortArray8920[i_597_] & 0xffff) * i) * 1258142129;
                        rsfloatbuffer.writeInt(i_598_);
                        rsfloatbuffer.caret = (i_558_ + (aShortArray8898[i_597_] & 0xffff) * i) * 1258142129;
                        rsfloatbuffer.writeInt(i_598_);
                        rsfloatbuffer.caret = (i_558_ + (aShortArray8899[i_597_] & 0xffff) * i) * 1258142129;
                        rsfloatbuffer.writeInt(i_598_);
                    }
                }
            }
            if (bool_554_) {
                ...
                rsfloatbuffer.caret = i_559_ * 1258142129;
                if (toolkit.bigEndian) {
                    for (int i_603_ = 0; i_603_ < uniqueVertices; i_603_++) {
                        ...
                        rsfloatbuffer.caret += (i - 12) * 1258142129;
                    }
                } else {
            ...
            if (bool_556_) {
                rsfloatbuffer.caret = i_560_ * 1258142129;
                if (toolkit.bigEndian) {
                    for (int i_609_ = 0; i_609_ < uniqueVertices; i_609_++) {
                        ...
                        rsfloatbuffer.caret += (i - 8) * 1258142129;
                    }
                } else {
            ...
            rsfloatbuffer.caret = i * uniqueVertices * 1258142129;
            ArrayBuffer interface11;
            if (bool) {
                if (anInterface11_8909 == null) {
                    anInterface11_8909 = toolkit.createArrayBuffer(i, rsfloatbuffer.payload, rsfloatbuffer.caret
                            * -165875887, true);
                } else {
                    anInterface11_8909.write(i, rsfloatbuffer.payload, rsfloatbuffer.caret * -165875887);
                }
                interface11 = anInterface11_8909;
                aByte8901 = (byte) 0;
            } else {
                interface11 = toolkit.createArrayBuffer(i, rsfloatbuffer.payload, rsfloatbuffer.caret * -165875887,
                        false);
                aBool8910 = true;
            }
            if (bool_555_) {
