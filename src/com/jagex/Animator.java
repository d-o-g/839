...
public class Animator {
    ...
    MultiFrameCollection aMultiFrameCollection_8203;
    MultiFrameCollection aMultiFrameCollection_8217;
    Animation animation;
    int anInt8202;
    int anInt8206;
    int anInt8207;
    ...
    Animator(boolean bool) {
        multipleFrames = bool;
        aMultiFrameCollection_8203 = new MultiFrameCollection();
        if (multipleFrames) {
            aMultiFrameCollection_8217 = new MultiFrameCollection();
        } else {
            aMultiFrameCollection_8217 = null;
        }
    }
    ...
    public final int method13457() {
        if (method13468()) {
            int i_8_ = 0;
            if (method13468()) {
                i_8_ |= aMultiFrameCollection_8203.anInt8063 * -444292541;

                if (multipleFrames && animation.anIntArray1970 != null) {
                    i_8_ |= -444292541 * aMultiFrameCollection_8217.anInt8063;
                }
            }
    ...
    public final void method13458(Model model, int i) {
        if (null != animation) {
            if (animation.frames != null && method13468()) {
                model.method2950(aMultiFrameCollection_8203.aClass480_Sub31_Sub8_8064,
                        aMultiFrameCollection_8203.anInt8062 * 140382599,
                        aMultiFrameCollection_8203.aClass480_Sub31_Sub8_8065,
                        aMultiFrameCollection_8203.anInt8061 * 1088051891,
                        anInt8206 * 1563999969,
                        animation.frameDurations[-1747811733 * anInt8202],
                        i,
                        animation.aBool1971
                );
                if (multipleFrames && null != animation.anIntArray1970 && aMultiFrameCollection_8217.aBool8066) {
                    model.method2950(aMultiFrameCollection_8217.aClass480_Sub31_Sub8_8064,
                            aMultiFrameCollection_8217.anInt8062 * 140382599,
                            aMultiFrameCollection_8217.aClass480_Sub31_Sub8_8065,
                            aMultiFrameCollection_8217.anInt8061 * 1088051891,
                            anInt8206 * 1563999969,
                            animation.frameDurations[anInt8202 * -1747811733],
                            i,
                            animation.aBool1971
                    );
                }
    ...
    public final void method13459(Model model, int i, int i_10_, int i_11_) {
        if (null != animation.frames && method13468()) {
            model.method2906(aMultiFrameCollection_8203.aClass480_Sub31_Sub8_8064, 140382599 * aMultiFrameCollection_8203.anInt8062,
                    aMultiFrameCollection_8203.aClass480_Sub31_Sub8_8065, aMultiFrameCollection_8203.anInt8061 * 1088051891,
                    1563999969 * anInt8206, animation.frameDurations[-1747811733 * anInt8202], i, i_10_,
                    animation.aBool1971, null);

            if (multipleFrames && animation.anIntArray1970 != null && aMultiFrameCollection_8217.aBool8066) {
                model.method2906(aMultiFrameCollection_8217.aClass480_Sub31_Sub8_8064,
                        aMultiFrameCollection_8217.anInt8062 * 140382599,
                        aMultiFrameCollection_8217.aClass480_Sub31_Sub8_8065,
                        aMultiFrameCollection_8217.anInt8061 * 1088051891,
                        anInt8206 * 1563999969,
                        animation.frameDurations[anInt8202 * -1747811733], i, i_10_,
                        animation.aBool1971, null);
            }
        }
    }
    ...
    public final void method13460(Model model) {
        if (null != animation.frames && method13468()) {
            model.method2979(aMultiFrameCollection_8203.aClass480_Sub31_Sub8_8064, aMultiFrameCollection_8203.anInt8062 * 140382599);
            if (multipleFrames && null != animation.anIntArray1970 && aMultiFrameCollection_8217.aBool8066) {
                model.method2979(aMultiFrameCollection_8217.aClass480_Sub31_Sub8_8064, 140382599 * aMultiFrameCollection_8217.anInt8062);
            }
        }
    }
    ...
    public final boolean method13465(int i) {
        ...
        boolean bool = animation.tweened | Animation.aBool1977;
    ...
    public final void method13514(Animator animator_25_) {
        animation = animator_25_.animation;
        aBool8211 = animator_25_.aBool8211;
        multipleFrames = animator_25_.multipleFrames;
        anInt8207 = 1 * animator_25_.anInt8207;
        anInt8216 = animator_25_.anInt8216 * 1;
        anInt8202 = animator_25_.anInt8202 * 1;
        anInt8215 = animator_25_.anInt8215 * 1;
        anInt8206 = animator_25_.anInt8206 * 1;
        method13469();
    }
    ...
    final boolean method13468() {
        if (animation != null) {
            boolean bool = aMultiFrameCollection_8203.method13113(AnimationDefinitionLoader.instance, animation, anInt8202 * -1747811733, anInt8215
                    * -1213758163, animation.frames);
            if (bool && multipleFrames && null != animation.anIntArray1970) {
                aMultiFrameCollection_8217.method13113(AnimationDefinitionLoader.instance, animation, anInt8202 * -1747811733,
    ...
    final void method13469() {
        aMultiFrameCollection_8203.method13111();
        if (multipleFrames) {
            aMultiFrameCollection_8217.method13111();
        }
    }
