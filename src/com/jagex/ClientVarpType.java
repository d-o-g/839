...
final class ClientVarpType extends VarpType {
    ...
    ClientVarpType(Js5ConfigGroup config, int id) {
        super(config, id);
    }
    ...
    static int method15442() {
        ...
        if (Class262.aClass262_2650 == Class262.aClass262_2922) {
            ...
            Class671.interfaces = Archive.create(ArchiveType.INTERFACES, false, 1, true);
            ...
            SceneGraphLevel.graphics = Archive.create(ArchiveType.SPOT_ANIMATIONS, false, 1, true);
            Class501.varpbits = Archive.create(ArchiveType.VARBITS, false, 1, true);
        ...
        if (Class262.aClass262_2650 == Class262.aClass262_2935) {
            ...
            Client.playerDefaults = new PlayerDefaults(Class22.defaults);
            UnboundedDefinitionLoader.originalBodyColours = Client.playerDefaults.originalColours;
            HuffmanCodec.replacementBodyColours = Client.playerDefaults.replacementColours;

            if (-1 != Client.playerDefaults.anInt7585 * 2105964905 && 2146047459 * Client.playerDefaults.anInt7599 != -1) {
                Client.anInt10682 = 1186575901 * Client.playerDefaults.anInt7585;
                Client.anInt10813 = Client.playerDefaults.anInt7599 * -217067231;
            }
        ...
        if (Class262.aClass262_2932 == Class262.aClass262_2650) {
            if (-1 != Client.playerDefaults.profilingModel * -587121439
                    && !Class436.models.loaded(-587121439 * Client.playerDefaults.profilingModel, 0)) {
                return 99;
            }

            CachedParticleDefinitionLoader.aClass147_3727 = new TextureMetricsList(ValueType.textureDefinitions);
            CutsceneObject.anTextureLoader_1944 = new ArchiveTextureLoader(Class51.textures, Class467.materials);
            ...
            WeakReferenceTable.itemTableDefinitionLoader = new Class678_Sub12(Client.game, Client.currentLanguage,
                    Class350.config);
            ...
            Client.scene.setObjectLoader(Class539.aClass678_Sub17_7330);
            ChatContainer.aClass461_2622.method7824(new ObjectDefinitionLoader(Client.game, Client.currentLanguage, true,
                    Class51.objects, Class436.models));
            ...
            Animation.loader = new AnimationDefinitionLoader(Client.game, Client.currentLanguage,
            ...
            Varp.varpLoader = new VarpLoader(Client.game,
                    VarpType.PLAYER, Client.currentLanguage, Class350.config);
            Npc.varpLoader = new VarDefinitionLoader(Client.game, VarpType.NPC,
                    Client.currentLanguage, Class350.config);
            Class501.aClass77_Sub1_Sub1_6903 = new VarDefinitionLoader(Client.game, VarpType.CLAN,
                    Client.currentLanguage, Class350.config);
            Class184.aClass77_Sub1_Sub1_2006 = new VarDefinitionLoader(Client.game, VarpType.CLAN_SETTING,
                    Client.currentLanguage, Class350.config);
            SunDefinition.aClass77_Sub1_Sub1_2846 = new VarDefinitionLoader(Client.game, VarpType.aClass441_5047,
                    Client.currentLanguage, Class350.config);
            ProxyingVariableLoader.parameters = Class154.method3281(new DefaultProvidingVarpLoader[]{
                    Varcs.varcLoader, Varp.varpLoader,
                    Npc.varpLoader, Class501.aClass77_Sub1_Sub1_6903,
                    Class184.aClass77_Sub1_Sub1_2006, SunDefinition.aClass77_Sub1_Sub1_2846});
            VarpBit.loader = new VarpBitLoader(Client.game, Client.currentLanguage,
                    Class350.config, ProxyingVariableLoader.parameters);
            Class378.anInterface14_4201 = new ProxyingVariableLoader();
            ShaderMetaBuffer.method4368(Class671.interfaces, Class436.models, DequeIterator.images, Class80.fonts);
            ...
            PlayerFacade.instance = new PlayerFacade(
                    Varp.varpLoader, VarpBit.loader,
                    Class197.aClass566_9252.method9564());
            PreferenceManager.method744();
            AnimationDefinitionLoader.init(Animation.loader);
            ...
            Class155.method3285(Class436.models, CachedParticleDefinitionLoader.aClass147_3727,
                    CutsceneObject.anTextureLoader_1944);
            HuffmanCodec huffman = new HuffmanCodec(ClientVarpType.huffman.get("huffman", ""));
            StaticTileDecoration.method18064(huffman);
            Engine.aClass467_6508 = Class467.method6970();
            SystemInformation.systemInfo = new SystemInformation(true);
        }
        ...
        if (Class262.aClass262_2934 == Class262.aClass262_2650) {
            Class495.method8547(DequeIterator.worldMapInfo, SetMemberRankChannelUpdate.worldMap,
                    OverlayDefinition.loader, UnderlayDefinition.loader, Client.scene.getObjectLoader(),
                    Queue.aClass678_Sub8_8139, MapSceneDefinition.loader, PlayerFacade.instance,
                    PlayerFacade.instance);
        }
        if (Class262.aClass262_2650 == Class262.aClass262_2936) {
            Class199.aVarcs_2099 = new Varcs(Varcs.varcLoader);
            Class339.method5852();
        ...
        if (Class262.aClass262_2931 == Class262.aClass262_2650 && Client.playerDefaults.loginWindowInterfaceIndex * 1673114103 != -1) {
            if (!Component.loadInterface(1673114103 * Client.playerDefaults.loginWindowInterfaceIndex, null)) {
                return 0;
            }
            boolean bool = true;
            for (int i_15_ = 0; i_15_ < Class598.loadedInterfaces[1673114103 * Client.playerDefaults.loginWindowInterfaceIndex].components.length; i_15_++) {
                Component class226 = Class598.loadedInterfaces[1673114103 * Client.playerDefaults.loginWindowInterfaceIndex].components[i_15_];
                if (5 == 1558474223 * class226.type && -1 != class226.textureId * -370763243
                        && !DequeIterator.images.loaded(-370763243 * class226.textureId, 0)) {
                    bool = false;
                }
            }
            if (!bool) {
        ...
        if (Class262.aClass262_2938 == Class262.aClass262_2650) {
            ...
            if (Client.aBool10598) {
                Class199.preferences.setValue(Class199.preferences.desiredToolkit, 0);
                    ...
                    && SystemInformation.systemInfo.processorInfoInt * -2033165835 < 512
                    && SystemInformation.systemInfo.processorInfoInt * -2033165835 != 0) {
                Class199.preferences.setValue(Class199.preferences.desiredToolkit, 0);
            }
    ...
    Object method7337(Varp parameter) {
        if (KeyType.I_LOWER == parameter.keyType || KeyType.ONE == parameter.keyType) {
            return -1;
        }
