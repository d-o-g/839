...
public class Class459 {
            ...
            if (aBool5212) {
                ...
                if (i_37_ <= 0) {
                    ...
                    int i_38_ = i_37_ + 1616882453 * anInt5194 > -165875887
                            * aClass453Array5184[-93220855 * anInt5176].buffer.caret ? aClass453Array5184[-93220855
                            * anInt5176].buffer.caret
                    ...
                    if (1616882453 * anInt5194 < aClass453Array5184[-93220855 * anInt5176].anInt5093 * -277979871
                        ...
                        i_38_ = 1616882453 * anInt5194 + i_37_ > aClass453Array5184[anInt5176 * -93220855].buffer.caret
                                * -165875887 ? -165875887
                                * aClass453Array5184[-93220855 * anInt5176].buffer.caret - 1616882453
                                * anInt5194 : i_37_;
                    }
                    ...
                    if (anInt5194 * 1616882453 >= -165875887
                            * aClass453Array5184[-93220855 * anInt5176].buffer.caret
    ...
    boolean method7556(byte[] is, Interface53 interface53, int i, float f, boolean bool, boolean bool_0_, int i_1_,
        ...
        synchronized (this) {
            ...
            if (null != is_4_) {
                ...
                int i_6_ = -766032760 * anInt5206 + -165875887 * buffer.caret;
                ...
                anInt5186 = -2135087597 * buffer.caret;
                ...
                if (anObject5197 instanceof Class456) {
                    SomeSerializable interface66 = ((Class456) anObject5197).method7444();
                    ...
                    if (null != aByteArray5193) {
                        ...
                        if (-1872333597 * anInt5204 >= anInt5206 * 2051729553) {
                            ...
                            if (is != null) {
                                ...
                                buffer.caret = is.length * 1258142129;
                                anInterface34_5189.method22(buffer);
                                method7575(false);
                                anInt5204 += 910848203;
                            }
    ...
    boolean method7573(byte i) {
        synchronized (this) {
            if (null != anObject5197 && anObject5197 instanceof Class456) {
                ...
                SomeSerializable interface66 = class456.method7444();
                if (null != interface66) {
                    ...
                    if (null == aClass453Array5184[anInt5199 * -1137038873]) {
                        ...
                        if (buffer != null) {
                            ...
                            int i_25_ = anInterface34_5189
                                    .method159(aClass453Array5184[anInt5199 * -1137038873].buffer.caret
                                            * -165875887 / i_24_);
                    ...
                    if (false == aBool5163 && null == aClass453Array5184[anInt5199 * -1137038873]) {
                        if (class342 != Class342.aClass342_3645 && i_28_ > 0) {
                            ...
                            int i_30_ = aClass453Array5184[anInt5199 * -1137038873] != null ? -165875887
                                    * aClass453Array5184[anInt5199 * -1137038873].buffer.caret : 0;
    ...
    Buffer method7616(int i, byte i_50_) {
        if (null != anObject5197 && anObject5197 instanceof Class456) {
            ...
            Buffer buffer_51_ = new Buffer(-165875887 * buffer.caret, true);
    ...
    void method7618(Buffer buffer, byte i) {
        if (anObject5197 != null && anObject5197 instanceof Class456) {
            Class456 class456 = (Class456) anObject5197;
            SomeSerializable interface66 = class456.method7444();
            byte[] is = new byte[-165875887 * buffer.caret];
            System.arraycopy(buffer.payload, 0, is, 0, buffer.caret * -165875887);
            Buffer buffer_52_ = new Buffer(is);
            buffer_52_.caret = buffer.caret * 1;
