...
public class ItemDefinition implements Definition {
    ...
    public static MappingVarpProvider aMappingVarpProvider_8339;
    ...
    ItemDefinition(int id, DefinitionLoader cache, BaseItemDefinitionProvider provider) {
        ...
        componentActions = provider.defaultComponentActions.clone();
    }
    ...
    public final Model method13583(Toolkit toolkit, int i, int amount, PlayerAppearance appearance, Animator animator,
        ...
        if (null != stacks && amount > 1) {
            ...
            if (-1 != id) {
                return cache.get(id).method13583(toolkit, i, 1, appearance, animator, i_29_, i_30_, i_31_, i_32_);
            }
        }
        ...
        if (null != animator || 0 != i_32_) {
            ...
            if (0 != i_32_) {
                model.recolor(i_29_, i_30_, i_31_, i_32_);
            }
        }
    ...
    public void method35() {
        ...
        if (!provider.membersServer && members) {
            ...
            componentActions = provider.defaultComponentActions;
            aBool8328 = false;
            anIntArray8304 = null;
            ...
            if (parameters != null) {
                ...
                for (Node parameter = parameters.first(); parameter != null; parameter = parameters.next()) {
    ...
    void decode(Buffer buffer, int opcode) {
        if (opcode == 1) {
            ...
            componentActions[opcode - 35] = buffer.readString();
        } else if (40 == opcode) {
            ...
            if (157 == opcode) {
                ...
                for (int index = 0; index < count; index++) {
                    ...
                    if (string) {
                        value = new ObjectNode<String>(buffer.readString());
                    } else {
                        value = new IntegerNode(buffer.readInt());
                    }
    ...
    void generate(ItemGenerationType type, ItemDefinition template, ItemDefinition info, TranslatableString drop,
        ...
        if (ItemGenerationType.NOTE == type) {
            ...
            componentActions = new String[5];
            componentActions[0] = TranslatableString.COMBINE.translate(language);
            componentActions[4] = drop.translate(language);
        } else {
            value = 0;
            ...
            if (info.componentActions != null) {
                for (int index = 0; index < 4; index++) {
                    componentActions[index] = info.componentActions[index];
                }
            }
    ...
    int[] getSprite(Toolkit class134, Toolkit class134_74_, int amount, int borderSize, int shadowColour, boolean note,
                    int textType, Font font, PlayerAppearance appearance, PlayerDefaults defaults) {
        BaseModel base = BaseModel.lookup(provider.modelArchive, -246742663 * baseModel, 0);
        if (null == base) {
            return null;
        }
        ...
        Matrix4f class399 = class134.cloneMatrix4f();
        Matrix4f class399_86_ = class134.getMatrix4f();
        ...
        class134.method2477(16777215, 0.95F + (float) (Math.random() / 10.0), 0.95F + (float) (Math.random() / 10.0),
                -50.0F, -10.0F, -50.0F);
        Matrix4x3 class405_87_ = class134.getMatrix4x3();
