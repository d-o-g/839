...
public class Class55 {
    ...
    public static Class480_Sub37 method1184() {
        if (null == Class495.aClass644_6820 || null == Class480_Sub37.iterator) {
            return null;
        }
        Class480_Sub37.iterator.setDeque(Class495.aClass644_6820);
        Class480_Sub37 class480_sub37 = (Class480_Sub37) Class480_Sub37.iterator.front();
    ...
    static float method1182(float f, float f_5_, float f_6_, float f_7_, float f_8_, float f_9_, int i) {
        ...
        for (; f_11_ < 1.1F; f_11_ += 0.1F) {
            ...
            int x = (int) worldX >> 9;
            int z = (int) worldZ >> 9;
            if (x > 0 && z > 0 && x < Client.scene.getMapWidth() && z < Client.scene.getMapLength()) {
                int plane = Client.localPlayer.plane;
                if (plane < 3 && (Client.scene.method7775().flags[1][x][z] & TileFlags.BRIDGE_FLAG) != 0) {
                    plane++;
                }

                int height = sceneGraph.levels[plane].averageHeightAt((int) worldX, (int) worldZ);
                if (height < f_19_) {
                    if (i >= 2) {
    ...
    void save() {
        ...
        try {
            try {
                ...
                encode(buffer);
                preferences.write(buffer.payload, 0, buffer.caret * -165875887);
