...
public abstract class Class302_Sub1 extends Class302 {
    ...
    void method15165(int i, Matrix4x3 class405) {
    ...
    void method15168(Matrix4x3 class405) {
    ...
    void method15185(int i, Matrix4x3 class405) {
    ...
    @Override
    void method5473() {
        method15168(Matrix4x3.primeMatrix);
    }
