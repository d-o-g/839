...
public class VolumePreference extends Preference {
    ...
    static final void method16788(Component class226, Interface class221, ScriptExecutionContext context, int i) {
        ...
        class226.anObjectArray2494 = World.method16248(string, context);
