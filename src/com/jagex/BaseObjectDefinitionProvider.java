...
public abstract class BaseObjectDefinitionProvider {
    ...
    Pair<Model, Shadow> aClass674_7321 = new Pair<Model, Shadow>(null, null);
    int anInt7317;
    String[] defaultActions;
    boolean membersServer;
    ReferenceCache<Pair<Model, Shadow>> tuples = new ReferenceCache<Pair<Model, Shadow>>(30);
    ...
    void reset() {
        ...
        aClass674_7321 = new Pair(null, null);
    }
