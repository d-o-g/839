...
public class NativeSceneGraphLevel extends SceneGraphLevel {
    ...
    NativeSceneGraphLevel(NativeToolkit class134_sub3, int i, int i_38_, int i_39_, int i_40_, int[][] is, int[][] is_41_,
                          int i_42_) {
    ...
    public void finish() {
        if (anInt8708 <= 0) {
            ...
            aClass480Array8742 = new Node[aClass667_8743.size()];
            aClass667_8743.values(aClass480Array8742);
            for (Node element : aClass480Array8742) {
            ...
            aClass480Array8714 = new Node[anInt8737];
    ...
    public void method2216(int i, int i_112_, int i_113_, boolean[][] bools, boolean bool, int i_114_) {
        if (aClass480Array8714 != null) {
            ...
            ByteBuffer bytebuffer = toolkit.aByteBuffer9279;
            bytebuffer.clear();
            for (Node element : aClass480Array8714) {
                                    ...
                                    if (!toolkit.fixedFunction && (anInt8732 & 0x8) != 0
                                        ...
                                        class302_sub1_sub1.aClass399_11010
                                                .method6551(
                                                        ...
                                                        1.0F / (class480_sub34.aFloat10234 * (class480_sub34.aClass150_10245.anInt1848 * -1963415229)),
                                                        1.0F, 1.0F);
                                        class302_sub1_sub1.aVector3f_11024.set(toolkit.aClass399_9323.array[12],
                                                toolkit.aClass399_9323.array[13], toolkit.aClass399_9323.array[14]);
                                        TextureMetrics class141 = toolkit.metricsList.get(class480_sub34.anInt10241);
                                        ...
                                        class302_sub1_sub1.aVector3f_11018.copyFrom(class259.aVector3f_2872);
                                        class302_sub1_sub1.aClass375_11025.method6170(class259.aClass375_2871);
                                        class302_sub1_sub1.aVector3f_11029.copyFrom(class259.aVector3f_2875);
            ...
            if (!aClass644_8729.isEmpty()) {
                ...
                Vector3f vector3f = new Vector3f(class259.aVector3f_2875);
                class259.aVector3f_2875.set(0.0F, 0.0F, 0.0F);
                ...
                class259.aVector3f_2875.copyFrom(vector3f);
            }
    ...
    void method14048() {
        ...
        if ((anInt8732 & 0x7) != 0) {
            if (anIntArrayArrayArray8726 != null) {
                aClass323_8733 = toolkit.method14696(new Class320(Class316.aClass316_3, Class316.aClass316_9,
                ...
                aClass323_8733 = toolkit.method14696(new Class320(
                        Class316.aClass316_3, Class316.aClass316_9, Class316.aClass316_1),
                        new Class320(Class316.aClass316_2));
            }
        } else if (anIntArrayArrayArray8726 != null) {
            aClass323_8733 = toolkit.method14696(new Class320(Class316.aClass316_3, Class316.aClass316_9, Class316.aClass316_12),
                    new Class320(Class316.aClass316_2));
        } else {
            aClass323_8733 = toolkit.method14696(new Class320(Class316.aClass316_3, Class316.aClass316_9),
                    new Class320(Class316.aClass316_2));
    ...
    void method14050(int i, int i_48_, byte[][] is, Class480_Sub34[] class480_sub34s, HashTable class667,
        ...
        if (anIntArrayArrayArray8709[i][i_48_] != null) {
            ...
            int i_72_ = 0;
            while_21_:
            for (int i_73_ = 0; i_73_ < is_54_.length; i_73_++) {
            ...
            for (int i_76_ = 0; i_76_ < is_54_.length; i_76_++) {
                ...
                if (class480 == null) {
                    ...
                    aByteBuffer8744.putFloat(averageHeightAt(i_77_, i_78_) + i_83_);
                    ...
                    class667.put(l, new ShortNode(is_75_[i_76_]));
                } else {
                    is_75_[i_76_] = ((ShortNode) class480).value;
