            ...
            for (int i_2_ = 0; i_2_ < 128; i_2_++) {
                for (int i_3_ = 0; i_3_ < 128; i_3_++) {
                    ...
                    for (int i_6_ = 0; i_6_ < 6; i_6_++) {
                        Vector3f vector3f_7_;
                        if (i_6_ == 0) {
                            vector3f_7_ = new Vector3f(-f_5_, -f, f_4_);
                        } else if (i_6_ == 1) {
                            vector3f_7_ = new Vector3f(f_5_, f, f_4_);
                        } else if (i_6_ == 2) {
                            vector3f_7_ = new Vector3f(-f, f_4_, -f_5_);
                        } else if (i_6_ == 3) {
                            vector3f_7_ = new Vector3f(-f, -f_4_, f_5_);
                        } else if (i_6_ == 4) {
                            vector3f_7_ = new Vector3f(f, f_5_, -f_4_);
                        } else {
                            vector3f_7_ = new Vector3f(f, -f_5_, f_4_);
                        }

                        float f_8_ = vector3f_7_.method6488(vector3f);
