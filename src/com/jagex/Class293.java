...
public class Class293 implements Interface28 {
    static MenuItem aClass480_Sub31_Sub17_3254;
    ...
    static int method5403(int i) {
        IntegerNode linkable = (IntegerNode) Class570.aClass667_7639.get(i);
        if (linkable == null) {
            Class361 class361 = PlayerMapDot.anInterface44_2095.load(i);
            if (class361 == null || 2 != 939371847 * class361.anInt3894) {
                return -1;
            }
            linkable = new IntegerNode(1765478053 * Class570.anInt7642);
