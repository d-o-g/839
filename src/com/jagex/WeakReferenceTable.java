...
public final class WeakReferenceTable {
    ...
    public static Class678_Sub12 itemTableDefinitionLoader;
    static int anInt559;
    ...
    static void method1091(int i, int i_13_, int i_14_, boolean bool, int i_15_, boolean bool_16_) {
        if (i < i_13_) {
            ...
            World class562_sub1 = Class671.worlds[i_18_];
            Class671.worlds[i_18_] = Class671.worlds[i_13_];
            Class671.worlds[i_13_] = class562_sub1;

            for (int i_20_ = i; i_20_ < i_13_; i_20_++) {
                if (SpawnObjectCutsceneAction.method15148(Class671.worlds[i_20_], class562_sub1, i_14_, bool,
                        i_15_, bool_16_, -1994505823) <= 0) {
                    World class562_sub1_21_ = Class671.worlds[i_20_];
                    Class671.worlds[i_20_] = Class671.worlds[i_19_];
                    Class671.worlds[i_19_++] = class562_sub1_21_;
                }
            }

            Class671.worlds[i_13_] = Class671.worlds[i_19_];
            Class671.worlds[i_19_] = class562_sub1;
