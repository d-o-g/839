...
public class ObjectDefinition implements Definition {
    ...
    static void method9290(Toolkit toolkit) {
        if ((84366055 * Class56.menuOptionCount >= 2 || Client.componentSelected) && null == Client.aClass226_10801) {
            String string;
            if (Client.componentSelected && 84366055 * Class56.menuOptionCount < 2) {
                string = new StringBuilder().append(Client.selectedComponentAction)
                        .append(TranslatableString.aClass5_157.translate(Client.currentLanguage))
                        .append(Client.aString10789).append(" ").append(Class60.arrow).toString();
            } else if (Class612.method10339() && 84366055 * Class56.menuOptionCount > 2) {
                string = Class589.method9918(PlayerInterfaceNode.aClass480_Sub31_Sub17_11430);
            } else {
                MenuItem class480_sub31_sub17 = PlayerInterfaceNode.aClass480_Sub31_Sub17_11430;
            ...
            if (84366055 * Class56.menuOptionCount > 2) {
                string = new StringBuilder().append(string).append(Item.getColorTags(16777215)).append(" / ")
            ...
            if (null != Class56.aClass226_636) {
                ...
                class132.method2300(string, 469815189 * Class56.anInt637, 838332027 * Class56.anInt638,
                        ...
                        Class56.aClass226_636.textColor * 923665021, Class56.aClass226_636.shadowColor * -1694773323,
    ...
    static void method9291(Toolkit toolkit) {
        if (-1503545849 * Client.floorLevel != Client.localPlayer.plane && Client.scene.getGraph() != null) {
            TimeUtil.time();
            if (Class56.method1351(toolkit, Client.localPlayer.plane)) {
                Client.floorLevel = Client.localPlayer.plane * -742271049;
            }
        }
    }
    ...
    public final synchronized Model getModel(Toolkit toolkit, int attributes, int type, int orientation,
                                             SceneGraphLevel class120, SceneGraphLevel class120_47_, int i_48_,
                                             int i_49_, int i_50_, Animator animator, Class540 class540, int i_51_) {
        if (ObjectCategory.method5284(type)) {
            type = -1050493863 * ObjectCategory.aClass541_7344.type;
        }

        long key = orientation + (type << 3) + (-894246227 * id2 << 10);
        int mask = attributes;
        ...
        if (animator != null) {
            attributes |= animator.method13457();
        }
        ...
        if (null != animator) {
            ...
            updated = true;
            animator.method13458(model, orientation & 0x3);
        }
    ...
    public final ObjectDefinition transform(VariableLoader loader, VariableProvider provider) {
        int index = -1;
        if (varpBit * 714856961 != -1) {
            VarpBit bits = loader.getVarpBit(varpBit * 714856961);

            if (bits != null) {
                index = provider.getVarpBitValue(bits);
            }
        } else if (179919805 * varp != -1) {
            Varp parameter = loader.getVarp(VarpType.PLAYER, varp * 179919805);

            if (parameter != null) {
                index = provider.getVarpValue(parameter);
            }
        }
    ...
    public final synchronized Pair<Model, Shadow> getModelAndShadow(Toolkit toolkit, int i, int type, int i_82_,
                                                                    SceneGraphLevel class120, SceneGraphLevel class120_83_,
                                                                    int i_84_, int i_85_, int i_86_, boolean bool,
                                                                    Class540 class540) {
        if (ObjectCategory.method5284(type)) {
            type = ObjectCategory.aClass541_7344.type * -1050493863;
        }
        long key = (type << 3) + (id2 * -894246227 << 10) + i_82_;
        key |= toolkit.id * 976039213 << 29;
        if (null != class540) {
            key |= class540.aLong7332 * 189278560431466431L << 32;
        }
        ...
        Pair<Model, Shadow> pair;
        synchronized (provider.tuples) {
            pair = provider.tuples.get(key);
        }

        Model model = pair != null ? pair.left : null;
        Shadow shadow = null;
        ...
        if (model == null || toolkit.method2637(model.functionMask(), mask) != 0) {
            ...
            model.updateFunctionMask(mask);
            pair = new Pair<>(model, shadow);

            synchronized (provider.tuples) {
                provider.tuples.put(key, pair);
            }
        } else {
            shadow = pair.right;
            if (bool && shadow == null && !bool_89_ && !bool_90_) {
                shadow = pair.right = model.method3018(null);
            }
        }
        ...
        provider.aClass674_7321.left = model;
        provider.aClass674_7321.right = shadow;
    ...
    void decode(Buffer buffer, int opcode) {
        if (opcode == 1) {
            ...
            if (19 == opcode) {
                type = buffer.readUByte() * 1123018159;
            } else if (opcode == 21) {
                aByte7428 = (byte) 1;
            } else if (22 == opcode) {
                aBool7392 = true;
                ...
                itemSupport = buffer.readUByte() * -1882964605;
            } else if (77 == opcode || opcode == 92) {
                varpBit = buffer.readUShort() * -486005247;
                if (65535 == varpBit * 714856961) {
                    varpBit = 486005247;
                }
                ...
                if (opcode == 170) {
                    ...
                    if (opcode == 200) {
                        ...
                        for (int index = 0; index < count; index++) {
                            ...
                            Node node;
                            if (string) {
                                node = new ObjectNode(buffer.readString().intern());
                            } else {
    ...
    void method9243() {
        ...
        if (itemSupport * 36878635 == -1) {
            itemSupport = (383562139 * anInt7367 != 0 ? 1 : 0) * -1882964605;
        }
    ...
    Model method9247(Toolkit toolkit, int attributes, int type, int orientation, Class540 class540) {
        ...
        if (0 != aByte7444) {
            result.recolor(aByte7382, aByte7384, aByte7412, aByte7444 & 0xff);
        }
