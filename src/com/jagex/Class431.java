...
public class Class431 {
    ...
    public static int method7147(int i, int i_1_) {
        if (-1 == -587121439 * Client.playerDefaults.profilingModel) {
            return 1;
        }
        ...
        int i_3_;
        try {
            Dimension dimension = Engine.gameCanvas.getSize();
            ...
            BaseModel class144 = BaseModel.lookup(Class436.models, -587121439 * Client.playerDefaults.profilingModel, 0);
            ...
            class399.method6559(dimension.width / 2, dimension.height / 2, 512.0F, 512.0F,
                    Client.scene.method7685(), Client.scene.method7686(), dimension.width,
                    dimension.height);
