...
public class MouseOverEntities {
    ...
    public static Model getMobModel(Toolkit class134, int i, int i_5_, int i_6_, int i_7_, int i_8_, Model class143,
                                    int i_9_, int i_10_, int i_11_, int i_12_, Animator animator) {
        if (null == class143) {
            return null;
        }
        int i_14_ = 2055;
        if (null != animator) {
            i_14_ |= animator.method13457();
            i_14_ &= ~0x200;
        }
        ...
        int i_34_ = class143.maximumX();
        int i_35_ = class143.minimumZ();
        ...
        if (null != animator) {
            ...
            animator.method13460(class143_15_);
        } else {
            class143_15_ = class143_15_.method2890((byte) 3, i_14_, true);
            class143_15_.scale(i_34_ - i_33_ >> 1, 128, i_36_ - i_35_ >> 1);
