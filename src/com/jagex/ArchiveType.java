...
public class ArchiveType {
    ...
    public static final ArchiveType INTERFACES = new ArchiveType(3, false);
    ...
    static ArchiveType[] values() {
        return new ArchiveType[]{VARBITS, SOUND_EFFECTS, ENUMERATIONS, PARTICLES, NATIVES, MAPS, FRAMES, DEFAULTS,
                ...
                MATERIALS, CUTSCENES, IMAGES, OBJECTS, INTERFACES, ARCHIVE_34, TEXTURE_DEFINITIONS, ARCHIVE_42, CONFIG,
                MODELS, HUFFMAN};
    }
