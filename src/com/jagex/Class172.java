...
class Class172 implements Interface52 {
    static Component aClass226_1961;
    Class186 this$0;
    ...
    public void method345(Object object, float[] fs, Object[] objects, int i) {
        ...
        Vector3f vector3f_1_ = Vector3f.difference(vector3f, this$0.method3598());
        float f_2_ = 0.0F;
        float f_3_ = vector3f_1_.distance();
        ...
        if (Client.mapState * 1212513917 == 3) {
            float f_7_ = Client.camera.getYaw();
            if (vector3f_1_.x != 0.0F || 0.0F != vector3f_1_.z) {
                int i_8_ = (int) (-1.0F * f_7_ * 2607.5945876176133)
                        - (int) (Math.atan2(vector3f_1_.x, vector3f_1_.z) * 2607.5945876176133) - 4096 & 0x3fff;
                if (i_8_ > 8192) {
                    i_8_ = 16384 - i_8_;
                }
            ...
            if (vector3f_1_.x != 0.0F || vector3f_1_.z != 0.0F) {
                int i_10_ = -(Class550.cameraYaw * 1686504405)
                        - (int) (Math.atan2(vector3f_1_.x, vector3f_1_.z) * 2607.5945876176133) - 4096 & 0x3fff;
