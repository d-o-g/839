...
public class OverlayDefinition implements Definition, Interface71 {
    ...
    static final void method9929(SceneNode class600_sub1, ScriptExecutionContext class613) {
        boolean bool = false;
        int i_5_ = 0;
        int i_6_ = 0;
        int i_7_ = 0;
        int i_8_ = 0;
        if (null != class600_sub1.class139Array) {
            for (Class139 class139 : class600_sub1.class139Array) {
    ...
    static final void method9931(ScriptExecutionContext class613, byte i) {
        ...
        Component class226 = Component.lookup(i_15_);
        Interface class221 = Class598.loadedInterfaces[i_15_ >>> 16];
        Component class226_16_ = Class339.method5850(class221, class226, 1736880654);
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = null == class226_16_ ? -1
                : class226_16_.uid * 1857819631;
    }
