...
public class Class166_Sub14 extends CutsceneAction {
    ...
    public static void method15118(Mobile mobile, int[] animations, int[] is_0_, int[] is_1_) {
        for (int index = 0; index < animations.length; index++) {
            int animationId = animations[index];
            int i_4_ = is_1_[index];
            int i_5_ = is_0_[index];

            for (int i_6_ = 0; 0 != i_4_ && i_6_ < mobile.aClass650_Sub1_Sub1Array11537.length; i_4_ >>>= 1) {
                if (0 != (i_4_ & 0x1)) {
                    if (animationId == -1) {
                        mobile.aClass650_Sub1_Sub1Array11537[i_6_] = null;
                    } else {
                        Animation animation = Animation.loader.get(animationId);
                        int replayMode = -1719904053 * animation.replayMode;

                        EntityAnimator_Sub1_ class650_sub1_sub1 = mobile.aClass650_Sub1_Sub1Array11537[i_6_];
                        ...
                        if (class650_sub1_sub1 == null || !class650_sub1_sub1.hasAnimation()) {
                            class650_sub1_sub1 = mobile.aClass650_Sub1_Sub1Array11537[i_6_] = new EntityAnimator_Sub1_(mobile);
