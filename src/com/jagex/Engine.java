...
public abstract class Engine implements Interface56, Runnable, FocusListener, WindowListener {
    ...
    public static void method8026(boolean bool) {
        ...
        Class199.preferences.setValue(Class199.preferences.buildArea, SceneGraphSize.DEFAULT.type * 1283574337);
    ...
    synchronized void method7919() {
        ...
        gameCanvas = new DelegatingCanvas(container);
    ...
    void method7920(Container container, int i) {
        ...
        gameCanvas.setSize(1319181337 * screenWidth, screenHeight * -551672947);
        gameCanvas.setVisible(true);
        if (Engine.frame == container) {
            Insets insets = Engine.frame.getInsets();
            gameCanvas.setLocation(insets.left + anInt6498 * 1489471141, insets.top + -1495234169 * anInt6499);
        } else {
            gameCanvas.setLocation(anInt6498 * 1489471141, -1495234169 * anInt6499);
        }
    ...
    void method7924() {
        ...
        engineTicks[Class50.anInt585 * 556932831] = time;
    ...
    void method7925() {
        ...
        if ((anInt6503 += 135351301) * 1418174669 - 1 > 50) {
            ...
            aBool6502 = true;
            gameCanvas.setSize(1319181337 * screenWidth, -551672947 * screenHeight);
            gameCanvas.setVisible(true);

            if (null != Engine.frame && null == Client.fullScreenFrame) {
                Insets insets = Engine.frame.getInsets();
                gameCanvas.setLocation(anInt6498 * 1489471141 + insets.left, insets.top + -1495234169 * anInt6499);
            } else {
                gameCanvas.setLocation(anInt6498 * 1489471141, anInt6499 * -1495234169);
            }
        }
    ...
    void method7926() {
        ...
        while (0L == aLong6492 * 5285465794934834617L || TimeUtil.time() < aLong6492 * 5285465794934834617L) {
            ...
            method7925();
            Class342.method5870(gameCanvas);
        }
    }
    ...
    File method7939(String string, String game, int i) {
        String string_19_ = 0 == i ? "" : new StringBuilder().append(i).toString();
        ...
        if (Class632_Sub19.aFile10502.exists()) {
            try {
                ...
                int i_22_;
                Buffer buffer;
                for (buffer = new Buffer((int) class670.length()); buffer.caret * -165875887 < buffer.payload.length; buffer.caret += 1258142129 * i_22_) {
                    i_22_ = class670.read(buffer.payload, buffer.caret * -165875887, buffer.payload.length
                            - -165875887 * buffer.caret);
                    if (i_22_ == -1) {
                ...
                if (i_22_ < 1 || i_22_ > 3) {
                    throw new IOException(new StringBuilder().append(i_22_).toString());
                }
                int i_23_ = 0;
                if (i_22_ > 1) {
        ...
        if (null == string_20_ && i == 0) {
            while_17_:
            for (int i_24_ = 0; i_24_ < Class281_Sub1_Sub1.aStringArray11041.length; i_24_++) {
    ...
    final void method7989(String gameName, String buildName, int i, int i_33_, int revision, int i_35_)
        ...
        dataFile = new BufferedFile(new DiskFile(Class558.openRwFile("main_file_cache.dat2"), "rw", 3221225472L), 5200,
                0);
        indexFile = new BufferedFile(new DiskFile(Class558.openRwFile("main_file_cache.idx255"), "rw", 1048576L),
                6000, 0);
