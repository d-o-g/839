...
public class FullScreenAdapter {
    ...
    public static void method13393(int plane, int localX, int localZ, int group, int id, int type, int orientation) {
        SceneMod current = null;
        for (SceneMod next = SceneMod.pendingSpawns.head(); null != next; next = SceneMod.pendingSpawns
                .next()) {
        ...
        if (null == current) {
            ...
            SceneMod.pendingSpawns.pushBack(current);
        }
