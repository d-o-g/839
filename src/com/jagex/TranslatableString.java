...
public class TranslatableString {
    ...
    static {
        ...
        LOADING_INTERFACE_SCRIPTS = new TranslatableString("Loading interface com.dogbot.scripts - ", "Lade Interface-Skripte - ",
                "Chargement des interfaces - ", "Carregando com.dogbot.scripts de interface - ",
                "Cargando gui\u00f3n de interfaz - ");
        LOADED_INTERFACE_SCRIPTS = new TranslatableString("Loaded interface com.dogbot.scripts", "Interface-Skripte geladen",
        ...
        aClass5_61 = new TranslatableString(null, "bevor du die Option 'Regelversto\u00df melden' benutzt.", null,
                null, null);
        SYSTEM_UPDATE_IN = new TranslatableString("System store in: ", "System-Update in: ",
    ...
    static final void method559(Mobile mobile, boolean bool) {
        int speed = MovementType.aClass624_8025.id;
        int i_12_ = 0;

        if (-589638007 * mobile.anInt11560 > Client.engineCycle) {
            HashTableIterator.method13669(mobile);
        } else if (-1506188915 * mobile.anInt11522 >= Client.engineCycle) {
            Class188.method3749(mobile);
        } else {
            Class290_Sub1.method15204(mobile, bool);
        ...
        if ((int) vector3f.x < 512 || (int) vector3f.z < 512
                || (int) vector3f.x >= (Client.scene.getMapWidth() - 1) * 512
            ...
            i_12_ = 0;
            mobile.setPosition(mobile.pathX[0] * 512 + mobile.boundSize() * 256, vector3f.y,
                    512 * mobile.pathZ[0] + mobile.boundSize() * 256);
            mobile.method17985();
        }

        if (Client.localPlayer == mobile
                && ((int) vector3f.x < 6144 || (int) vector3f.z < 6144
                || (int) vector3f.x >= (Client.scene.getMapWidth() - 12) * 512 || (int) vector3f.z >= (Client.scene
                .getMapLength() - 12) * 512)) {
            mobile.animator.update(-1);
        ...
        int i_15_ = KeyRecorder.method8899(mobile);
        Class330.method5807(mobile);
        IncomingFrameMeta.method6298(mobile, speed, i_12_, i_15_);
        Class24.method776(mobile, speed);
        Class449.method7388(mobile);
        Quaternion quaternion = Quaternion.cached();
        quaternion.method6413(Class373.method6114(mobile.yaw.value()), Class373.method6114(mobile.pitch.value()),
                Class373.method6114(mobile.roll.value()));
        mobile.method10179(quaternion);
        quaternion.cache();
    }
