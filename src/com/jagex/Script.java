...
public class Script extends Cacheable {
    ...
    static Cache<Script> cache = new Cache<>(128);
    ...
    public Script(Buffer buffer, VariableLoader interface14) {
        ...
        while (buffer.caret * -165875887 < i) {
        ...
        if (null != script) {
            ...
            for (int index = 1; index < arguments.length; index++) {
                if (arguments[index] instanceof Integer) {
                    ...
                    if (value == -2147483645) {
                        value = context.source != null ? context.source.uid * 1857819631 : -1;
                    }
                    if (-2147483644 == value) {
                        value = context.menuIndex * -826301581;
                    }
                    if (value == -2147483643) {
                        value = null != context.source ? -592186295 * context.source.index : -1;
                    }
                    if (value == -2147483642) {
                        value = context.target != null ? context.target.uid * 1857819631 : -1;
                    }
                    if (value == -2147483641) {
                        value = context.target != null ? context.target.index * -592186295 : -1;
                    }
                    if (value == -2147483640) {
    ...
    int method17840(Buffer buffer, int i) {
        buffer.caret = (buffer.payload.length - 2) * 1258142129;
        int i_0_ = buffer.readUShort();
        int i_1_ = buffer.payload.length - 2 - i_0_ - 16;
        buffer.caret = 1258142129 * i_1_;
        ...
        if (i_3_ > 0) {
            ...
            for (int i_4_ = 0; i_4_ < i_3_; i_4_++) {
                ...
                while (i_5_-- > 0) {
                    ...
                    class667.put(i_6_, new IntegerNode(i_7_));
                }
            }
        }
        buffer.caret = 0;
    ...
    void method17841(Buffer buffer, int i, ScriptInstruction class466, int i_8_) {
        ...
        if (ScriptInstruction.aClass466_5276 == class466 || ScriptInstruction.aClass466_5412 == class466) {
            ...
            anObjectArray11388[i] = anInterface14_11400.getVarpBit(i_11_);
            if (anIntArray11391 == null) {
                anIntArray11391 = new int[i_9_];
            }
            anIntArray11391[i] = buffer.readUByte();
