...
public class Class611 {
    ...
    public static void method10321(int i, int i_2_, int i_3_, int i_4_, int i_5_) {
        ...
        for (Class480_Sub18 class480_sub18 = (Class480_Sub18) Class480_Sub18.aClass644_10112.head(); class480_sub18 != null; class480_sub18 = (Class480_Sub18) Class480_Sub18.aClass644_10112
            ...
            if (i_6_ != class480_sub18.anInt10116 * 63208259) {
                ...
                if (npcDefinition.morphisms != null) {
                    npcDefinition = npcDefinition.morph(PlayerFacade.instance,
            ...
            Vector3f vector3f = class480_sub18.npc.getCoordinateSpace().translation;
            class480_sub18.anInt10115 = 238948139 * (int) vector3f.x;
            class480_sub18.anInt10117 = ((int) vector3f.x + (class480_sub18.npc.boundSize() << 8)) * -1142456477;
            class480_sub18.anInt10123 = (int) vector3f.z * 725290353;
            class480_sub18.anInt10118 = ((int) vector3f.z + (class480_sub18.npc.boundSize() << 8)) * 1443554551;
        ...
        for (Class480_Sub18 class480_sub18 = (Class480_Sub18) Class480_Sub18.aClass667_10113.first(); class480_sub18 != null; class480_sub18 = (Class480_Sub18) Class480_Sub18.aClass667_10113
            ...
            if (class480_sub18.anInt10116 * 63208259 != i_9_) {
                int i_11_ = StaticClass1.method545(class480_sub18.player, 1747981955);
            ...
            Vector3f vector3f = class480_sub18.player.getCoordinateSpace().translation;
            class480_sub18.anInt10115 = (int) vector3f.x * 238948139;
            class480_sub18.anInt10117 = ((int) vector3f.x + (class480_sub18.player.boundSize() << 8)) * -1142456477;
            class480_sub18.anInt10123 = 725290353 * (int) vector3f.z;
            class480_sub18.anInt10118 = ((int) vector3f.z + (class480_sub18.player.boundSize() << 8)) * 1443554551;
            class480_sub18.anInt10134 = class480_sub18.player.plane * -1632551033;
            Class480_Sub18.method6905(class480_sub18, i, i_2_, i_3_, i_4_, -1296484740);
        }
    }

    Component method10313() {
        return aClass221_7913.getChild(1857819631 * aClass226_7914.uid);
    }
    ...
    boolean method10315(int i, int i_0_, int i_1_) {
        Component class226 = Class185.method3584(i, i_0_);
        if (null != class226) {
