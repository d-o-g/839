...
public class Class536 implements Identifiable {
    ...
    public static void setConnectionState(int state) {
        if (Client.connectionState * -1501875989 != state) {
            Client.anInt10631 = 0;
            if (16 == -1501875989 * Client.connectionState && 13 != state) {
            ...
            if (0 == state) {
                Client.method9237(Client.connectionState * -1501875989 == 6 || Client.connectionState * -1501875989 == 2
                        || Client.anInt10790 * 1764783361 != 1673114103 * Client.playerDefaults.loginWindowInterfaceIndex);
            }
            if (8 == state) {
                boolean bool;
                if (Client.playerDefaults.lobbyWindowInterfaceIndex * 1803208677 == -1) {
                    bool = 18 == Client.connectionState * -1501875989 || -1501875989 * Client.connectionState == 3;
                } else {
                    bool = 1764783361 * Client.anInt10790 != Client.playerDefaults.lobbyWindowInterfaceIndex * 1803208677;
                }
            ...
            } else if (15 == state || state == 11 && -1501875989 * Client.connectionState != 17) {
            ...
            boolean bool_1_ = Client.connectionState * -1501875989 == 19
                    || AsynchronousStreamRequest.loggedOutState(-1501875989 * Client.connectionState)
                    || Class456.lobbyState(-1501875989 * Client.connectionState);
            if (bool != bool_1_) {
            ...
            Client.connectionState = state * 1176893379;
        }
    }
    ...
    public static void method9176() {
        ...
        Class199.aVarcs_2099.method14041(class670, (byte) 56);
    }
    ...
    static final void method9177(ScriptExecutionContext class613, int i) {
        ...
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = vector4i.z
                * -980788885;
    }
