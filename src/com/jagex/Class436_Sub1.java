...
public class Class436_Sub1 extends Class436 {
    ...
    ObjectDefinitionLoader defLoader;

    public Class436_Sub1(SceneGraph sceneGraph, ObjectDefinitionLoader loader, int i, int i_34_, int i_35_, boolean bool,
                         TileFlags flags, Class575 class575) {
        super(sceneGraph, i, i_34_, i_35_, bool, OverlayDefinition.loader, UnderlayDefinition.loader, flags);
        this.defLoader = loader;
        aClass575_9938 = class575;
    }

    public final void method15408(Toolkit toolkit, Buffer buffer, int i, int i_0_) {
        if (!underwater) {
            buffer.caret += 1475202440;
            boolean bool = false;
            Class569 class569 = null;
            boolean bool_2_ = false;

            while (-165875887 * buffer.caret < buffer.payload.length) {
                ...
                if (0 == i_3_) {
                    ...
                    if (i_4_ > 0) {
                        for (int i_5_ = 0; i_5_ < i_4_; i_5_++) {
                            Class504 class504 = new Class504(toolkit, sceneGraph.tileScale * -1911343043, buffer, 2);
                            ...
                            if (toolkit.method2480() > 0) {
                                ...
                                if (i_8_ >= 0 && i_9_ >= 0 && i_8_ < 1626386547 * width && i_9_ < -1252946243 * length) {
                                    ...
                                    sceneGraph.method8366(class504, 995913351);
                                }
                            }
                        }
                    }
        ...
        for (; ; ) {
            ...
            for (; ; ) {
                ...
                if (i_49_ == i_38_ && i_48_ >= i_39_ && i_48_ < i_39_ + 8 && i_47_ >= i_40_ && i_47_ < i_40_ + 8) {
                    ObjectDefinition definition = defLoader.get(id);
                    int i_53_;
                    int i_54_;
                    ...
                    if (i_55_ < width * 1626386547
                        ...
                        spawnMod(toolkit, i, i, i_55_, i_56_, id, orientation + i_41_ & 0x3, i_51_, -1, 0);
                    }
                }
            }
        }
    ...
    public final void method15416(Toolkit class134, boolean bool, int i) {
        ...
        if (!bool) {
                ...
                for (int i_111_ = 0; i_111_ < 1626386547 * width; i_111_++) {
                    for (int i_112_ = 0; i_112_ < -1252946243 * length; i_112_++) {
                        if ((aClass425_4950.flags[1][i_111_][i_112_] & 0x2) == 2) {
                            sceneGraph.method8317(i_111_, i_112_, (byte) 88);
                        }
                    }
                }
            }
                ...
                for (int i_114_ = 0; i_114_ <= -1252946243 * length; i_114_++) {
                    for (int i_115_ = 0; i_115_ <= width * 1626386547; i_115_++) {
                        if ((aByteArrayArrayArray4922[i_113_][i_115_][i_114_] & 0x4) != 0) {
                            ...
                            while_53_:
                            for (; i_116_ > 0 && i_117_ - i_116_ < 10; i_116_--) {
                            ...
                            while_54_:
                            for (; i_117_ < 1626386547 * width && i_117_ - i_116_ < 10; i_117_++) {
                            ...
                            if ((i_117_ - i_116_ + 1) * (i_119_ - i_118_ + 1) >= 4) {
                                ...
                                sceneGraph.aClass492_6695.method8496(4, i_113_, i_116_ << 9, 512 + (i_117_ << 9),
            ...
            sceneGraph.aClass492_6695.method8494();
        }
    ...
    public final void method15425(Toolkit class134, byte[] is, int i, int i_125_, byte i_126_) {
        ...
        for (; ; ) {
            ...
            for (; ; ) {
                ...
                ObjectDefinition class544 = defLoader.get(i_127_);
                int i_139_;
                int i_140_;
                if (0 == (i_136_ & 0x1)) {
                ...
                if (i_137_ < width * 1626386547
                    ...
                    spawnMod(class134, i_133_, i_133_, i_137_, i_138_, i_127_, i_136_, i_135_, -1, 0);
                }
            }
        }
    }
                ...
                if (0 == i_172_) {
                    ...
                    if (i_173_ > 0) {
                        for (int i_174_ = 0; i_174_ < i_173_; i_174_++) {
                            Class504 class504 = new Class504(class134, sceneGraph.tileScale * -1911343043, buffer,
                                    2);
                            ...
                            if (class134.method2480() > 0) {
                                ...
                                if (class504.anInt6948 * 297507485 == i_164_ && i_175_ >= i_170_ && i_175_ < 8 + i_170_
                                    ...
                                    if (i_175_ >= 0 && i_176_ >= 0 && i_175_ < 1626386547 * width
                                        ...
                                        sceneGraph.method8366(class504, 334858052);
                                    }
                                }
                            }
                        }
    ...
    final void spawnMod(Toolkit toolkit, int collisionPlane, int plane, int localX, int localZ, int id,
                        int orientation, int type, int animation, int i_66_) { // TODO
        if (plane < -1335764017 * anInt9937) {
            anInt9937 = plane * 1290619695;
        }

        ObjectDefinition object = defLoader.get(id);
        if (Class199.preferences.textures.getValue() != 0 || !object.aBool7435) {
            ...
            SceneGraphLevel ground = sceneGraph.levels1[collisionPlane];
            int i_74_;
            ...
            if (!aBool9935
                ...
                if (ObjectCategory.aClass541_7358.type * -1050493863 == type) {
                    if (Class199.preferences.groundDecoration.getValue() != 0 || 0 != -1893691057 * object.type
                            || 1 == 383562139 * object.anInt7367 || object.aBool7420) {
                        TileDecoration class600_sub1_sub4;

                        if (bool_77_) {
                            DynamicTileDecoration class600_sub1_sub4_sub1 = new DynamicTileDecoration(
                                    sceneGraph, toolkit, defLoader, object, plane, collisionPlane, i_75_, i_74_,
                                    i_76_, underwater, orientation, bool);
                            if (class600_sub1_sub4_sub1.shadow()) {
                                class600_sub1_sub4_sub1.renderShadow(toolkit);
                            }
                            class600_sub1_sub4 = class600_sub1_sub4_sub1;
                        } else {
                            class600_sub1_sub4 = new StaticTileDecoration(sceneGraph, toolkit, defLoader, object, plane,
                                    collisionPlane, i_75_, i_74_, i_76_, underwater, orientation, animation, i_66_);
                        }

                        sceneGraph.method8446(plane, localX, localZ, class600_sub1_sub4, -1331064663);
                    }
                } else if (type == -1050493863 * ObjectCategory.aClass541_7338.type
                        || type == -1050493863 * ObjectCategory.aClass541_7357.type) {
                    DynamicGameObject class600_sub1_sub3_sub3 = null;
                    SceneEntity class600_sub1_sub3;
                    int i_78_;
                    if (bool_77_) {
                        DynamicGameObject class600_sub1_sub3_sub3_79_ = new DynamicGameObject(
                                sceneGraph, toolkit, defLoader, object, plane, collisionPlane, i_75_, i_74_, i_76_,
                        ...
                        class600_sub1_sub3 = new StaticGameObject(sceneGraph, toolkit, defLoader, object, plane,
                    ...
                    if (sceneGraph.method8423(class600_sub1_sub3, false)) {
                        if (class600_sub1_sub3_sub3 != null && class600_sub1_sub3_sub3.shadow()) {
                            class600_sub1_sub3_sub3.renderShadow(toolkit);
                        }
                    ...
                    SceneEntity class600_sub1_sub3;
                    if (bool_77_) {
                        DynamicGameObject class600_sub1_sub3_sub3 = new DynamicGameObject(sceneGraph,
                                toolkit, defLoader, object, plane, collisionPlane, i_75_, i_74_, i_76_, underwater,
                                localX, localX + i_68_ - 1, localZ, i_69_ + localZ - 1, type, orientation, bool, true);
                        if (class600_sub1_sub3_sub3.shadow()) {
                            class600_sub1_sub3_sub3.renderShadow(toolkit);
                        }
                    ...
                    sceneGraph.method8423(class600_sub1_sub3, false);
    ...
    void method15412(Toolkit toolkit, int i, int i_82_, int i_83_, int i_84_) {
        ...
        if (interface55 != null) {
            ObjectDefinition class544 = defLoader.get(interface55.getId());
            int i_86_ = interface55.getType();
            int i_87_ = interface55.getOrientation();
            if (class544.method9248()) {
                Class480_Sub18.method15334(i, i_83_, i_84_, class544, -196218542);
            }
            if (interface55.shadow()) {
                interface55.method365(toolkit);
            }
            if (i_82_ == 0) {
                sceneGraph.method8336(i, i_83_, i_84_, -720979437);
                sceneGraph.method8337(i, i_83_, i_84_, -831143864);
                if (777675999 * class544.occludes == 1) {
                    if (i_87_ == 0) {
                        sceneGraph.aClass492_6695.method8513(1, i, i_83_, i_84_);
                    } else if (i_87_ == 1) {
                        sceneGraph.aClass492_6695.method8513(2, i, i_83_, 1 + i_84_);
                    } else if (i_87_ == 2) {
                        sceneGraph.aClass492_6695.method8513(1, i, 1 + i_83_, i_84_);
                    } else if (i_87_ == 3) {
                        sceneGraph.aClass492_6695.method8513(2, i, i_83_, i_84_);
                    }
                }
            } else if (1 == i_82_) {
                sceneGraph.method8463(i, i_83_, i_84_, 944565284);
                sceneGraph.method8339(i, i_83_, i_84_, 34168);
            } else if (i_82_ == 2) {
                sceneGraph.getTopEntity(i, i_83_, i_84_, Client.anSceneEntityPredicate_10904);
                if (i_86_ == ObjectCategory.aClass541_7339.type * -1050493863) {
                    if (0 == (i_87_ & 0x1)) {
                        sceneGraph.aClass492_6695.method8513(8, i, i_83_, i_84_);
                    } else {
                        sceneGraph.aClass492_6695.method8513(16, i, i_83_, i_84_);
                    }
                }
            } else if (3 == i_82_) {
                sceneGraph.method8382(i, i_83_, i_84_, -1509376493);
            }
        }
    }
    ...
    boolean method15413(Toolkit class134, int i, int i_88_, boolean bool, ObjectDefinition class544, int i_89_,
        ...
        if (i == ObjectCategory.aClass541_7344.type * -1050493863) {
            BoundaryDecoration class600_sub1_sub2;
            if (bool) {
                DynamicBoundaryDecoration class600_sub1_sub2_sub2 = new DynamicBoundaryDecoration(sceneGraph, class134,
                        defLoader, class544, i_91_, i_92_, i_93_, i_94_, i_95_, underwater, 0, 0, i, i_88_);
                if (class600_sub1_sub2_sub2.shadow()) {
                    class600_sub1_sub2_sub2.renderShadow(class134);
                }
                class600_sub1_sub2 = class600_sub1_sub2_sub2;
            } else {
                class600_sub1_sub2 = new StaticBoundaryDecoration(sceneGraph, class134, defLoader, class544, i_91_, i_92_,
                        i_93_, i_94_, i_95_, underwater, 0, 0, i, i_88_, i_89_, i_90_);
            }
            sceneGraph.method8353(i_91_, i_96_, i_97_, class600_sub1_sub2, null, -2097097763);
            return true;
        }
        if (i == ObjectCategory.aClass541_7341.type * -1050493863) {
            int i_99_ = 65;
            SceneObject interface55 = (SceneObject) sceneGraph.getBoundary(i_91_, i_96_, i_97_);
            if (interface55 != null) {
                i_99_ = defLoader.get(interface55.getId()).anInt7401 * 1601375007 + 1;
            }
            BoundaryDecoration class600_sub1_sub2;
            if (bool) {
                DynamicBoundaryDecoration class600_sub1_sub2_sub2 = new DynamicBoundaryDecoration(sceneGraph, class134,
                        defLoader, class544, i_91_, i_92_, i_93_, i_94_, i_95_, underwater, anIntArray9933[i_88_] * i_99_,
            ...
            sceneGraph.method8353(i_91_, i_96_, i_97_, class600_sub1_sub2, null, -2110611709);
            return true;
        }
        if (i == ObjectCategory.aClass541_7340.type * -1050493863) {
            ...
            SceneObject interface55 = (SceneObject) sceneGraph.getBoundary(i_91_, i_96_, i_97_);
            if (interface55 != null) {
                i_100_ = defLoader.get(interface55.getId()).anInt7401 * 1601375007 / 2 + 1;
            }
            BoundaryDecoration class600_sub1_sub2;
            if (bool) {
                DynamicBoundaryDecoration class600_sub1_sub2_sub2 = new DynamicBoundaryDecoration(sceneGraph, class134,
                        defLoader, class544, i_91_, i_92_, i_93_, i_94_, i_95_, underwater,
            ...
            sceneGraph.method8353(i_91_, i_96_, i_97_, class600_sub1_sub2, null, -2064412549);
            return true;
        }
        if (i == ObjectCategory.aClass541_7343.type * -1050493863) {
            ...
            if (bool) {
                DynamicBoundaryDecoration class600_sub1_sub2_sub2 = new DynamicBoundaryDecoration(sceneGraph, class134,
                        defLoader, class544, i_91_, i_92_, i_93_, i_94_, i_95_, underwater, 0, 0, i, 4 + i_101_);
                if (class600_sub1_sub2_sub2.shadow()) {
                    class600_sub1_sub2_sub2.renderShadow(class134);
                }
                class600_sub1_sub2 = class600_sub1_sub2_sub2;
            ...
            sceneGraph.method8353(i_91_, i_96_, i_97_, class600_sub1_sub2, null, -2051889004);
            return true;
        }
        if (ObjectCategory.aClass541_7356.type * -1050493863 == i) {
            ...
            SceneObject interface55 = (SceneObject) sceneGraph.getBoundary(i_91_, i_96_, i_97_);
            if (interface55 != null) {
                i_103_ = defLoader.get(interface55.getId()).anInt7401 * 1601375007 / 2 + 1;
            }
            BoundaryDecoration class600_sub1_sub2;
            BoundaryDecoration class600_sub1_sub2_104_;
            if (bool) {
                DynamicBoundaryDecoration class600_sub1_sub2_sub2 = new DynamicBoundaryDecoration(sceneGraph, class134,
                        defLoader, class544, i_91_, i_92_, i_93_, i_94_, i_95_, underwater,
                        i_103_ * anIntArray9929[i_88_], i_103_ * anIntArray9936[i_88_], i, i_88_ + 4);
                DynamicBoundaryDecoration class600_sub1_sub2_sub2_105_ = new DynamicBoundaryDecoration(sceneGraph,
                        class134, defLoader, class544, i_91_, i_92_, i_93_, i_94_, i_95_, underwater, 0, 0, i, 4 + i_102_);
                if (class600_sub1_sub2_sub2.shadow()) {
                    class600_sub1_sub2_sub2.renderShadow(class134);
                }
                if (class600_sub1_sub2_sub2_105_.shadow()) {
                    class600_sub1_sub2_sub2_105_.renderShadow(class134);
                }
                class600_sub1_sub2 = class600_sub1_sub2_sub2;
                class600_sub1_sub2_104_ = class600_sub1_sub2_sub2_105_;
            } else {
                StaticBoundaryDecoration class600_sub1_sub2_sub1 = new StaticBoundaryDecoration(sceneGraph, class134, defLoader, class544,
                        i_91_, i_92_, i_93_, i_94_, i_95_, underwater, i_103_ * anIntArray9929[i_88_],
                        anIntArray9936[i_88_] * i_103_, i, i_88_ + 4, i_89_, i_90_);
                StaticBoundaryDecoration class600_sub1_sub2_sub1_106_ = new StaticBoundaryDecoration(sceneGraph, class134, defLoader,
            ...
            sceneGraph.method8353(i_91_, i_96_, i_97_, class600_sub1_sub2, class600_sub1_sub2_104_, -2126246091);
            return true;
        }
        return false;
    }
    ...
    SceneObject getObject(int plane, int group, int x, int z) {
        ...
        if (group == 0) {
            object = (SceneObject) sceneGraph.getBoundary(plane, x, z);
        }
        if (group == 1) {
            object = (SceneObject) sceneGraph.getBoundaryDecoration(plane, x, z);
        }
        if (group == 2) {
            object = (SceneObject) sceneGraph.getEntity(plane, x, z, Client.anSceneEntityPredicate_10904);
        }
        if (3 == group) {
            object = (SceneObject) sceneGraph.getTileDecoration(plane, x, z);
        }
        return object;
    }

    boolean method15430(Toolkit toolkit, int i, int i_143_, boolean dynamic, ObjectDefinition def, int i_144_,
                        int i_145_, int i_146_, int i_147_, int i_148_, int i_149_, int i_150_, int i_151_, int i_152_,
                        boolean bool_153_, SceneGraphLevel class120, int i_154_, int i_155_, byte dummy) {
        if (-1050493863 * ObjectCategory.aClass541_7335.type == i) {
            int i_157_ = 777675999 * def.occludes;
            if (aBool9928 && -1 == def.occludes * 777675999) {
                i_157_ = 1;
            }
            Boundary boundary;
            if (dynamic) {
                DynamicBoundary dynamicboundary = new DynamicBoundary(sceneGraph, toolkit,
                        defLoader, def, i_146_, i_147_, i_148_, i_149_, i_150_, underwater, i, i_143_, bool_153_);
                if (dynamicboundary.shadow()) {
                    dynamicboundary.renderShadow(toolkit);
                }
                boundary = dynamicboundary;
            } else {
                boundary = new StaticBoundary(sceneGraph, toolkit, defLoader, def, i_146_, i_147_, i_148_,
                        i_149_, i_150_, underwater, i, i_143_, i_144_, i_145_);
            }
            sceneGraph.method8359(i_146_, i_151_, i_152_, boundary, null, 2135603389);
            if (i_143_ == 0) {
                if (aBool4937 && def.castsShadow) {
                    class120.setShadowing(i_151_, i_152_, 50);
                    class120.setShadowing(i_151_, 1 + i_152_, 50);
                }
                if (i_157_ == 1 && !underwater) {
                    sceneGraph.aClass492_6695.method8515(1, i_146_, i_151_, i_152_, 93223085 * def.anInt7394,
                            def.anInt7395 * 683670749);
                }
            } else if (1 == i_143_) {
                if (aBool4937 && def.castsShadow) {
                    class120.setShadowing(i_151_, 1 + i_152_, 50);
                ...
                if (1 == i_157_ && !underwater) {
                    sceneGraph.aClass492_6695.method8515(2, i_146_, i_151_, 1 + i_152_,
                            93223085 * def.anInt7394, -(683670749 * def.anInt7395));
                }
            } else if (i_143_ == 2) {
                if (aBool4937 && def.castsShadow) {
                    class120.setShadowing(i_151_ + 1, i_152_, 50);
                ...
                if (i_157_ == 1 && !underwater) {
                    sceneGraph.aClass492_6695.method8515(1, i_146_, 1 + i_151_, i_152_,
                            93223085 * def.anInt7394, -(683670749 * def.anInt7395));
                }
            } else if (i_143_ == 3) {
                if (aBool4937 && def.castsShadow) {
                ...
                if (i_157_ == 1 && !underwater) {
                    sceneGraph.aClass492_6695.method8515(2, i_146_, i_151_, i_152_, 93223085 * def.anInt7394,
                            def.anInt7395 * 683670749);
                }
            }
            if (64 != def.anInt7401 * 1601375007) {
                sceneGraph.method8334(i_146_, i_151_, i_152_, 1601375007 * def.anInt7401, 964940834);
            }
            return true;
        }
        if (i == -1050493863 * ObjectCategory.aClass541_7336.type) {
            Boundary class600_sub1_sub5;
            if (dynamic) {
                DynamicBoundary class600_sub1_sub5_sub1 = new DynamicBoundary(sceneGraph, toolkit,
                        defLoader, def, i_146_, i_147_, i_148_, i_149_, i_150_, underwater, i, i_143_, bool_153_);
                if (class600_sub1_sub5_sub1.shadow()) {
                    class600_sub1_sub5_sub1.renderShadow(toolkit);
                }
                class600_sub1_sub5 = class600_sub1_sub5_sub1;
            } else {
                class600_sub1_sub5 = new StaticBoundary(sceneGraph, toolkit, defLoader, def, i_146_, i_147_, i_148_,
                        i_149_, i_150_, underwater, i, i_143_, i_144_, i_145_);
            }
            sceneGraph.method8359(i_146_, i_151_, i_152_, class600_sub1_sub5, null, 2125945864);
            if (def.castsShadow && aBool4937) {
                if (i_143_ == 0) {
        ...
        if (i == ObjectCategory.aClass541_7337.type * -1050493863) {
            ...
            Boundary class600_sub1_sub5;
            Boundary class600_sub1_sub5_159_;
            if (dynamic) {
                DynamicBoundary class600_sub1_sub5_sub1 = new DynamicBoundary(sceneGraph, toolkit,
                        defLoader, def, i_146_, i_147_, i_148_, i_149_, i_150_, underwater, i, i_143_ + 4, bool_153_);
                DynamicBoundary class600_sub1_sub5_sub1_160_ = new DynamicBoundary(sceneGraph,
                        toolkit, defLoader, def, i_146_, i_147_, i_148_, i_149_, i_150_, underwater, i, i_158_,
                        bool_153_);
                if (class600_sub1_sub5_sub1.shadow()) {
                    class600_sub1_sub5_sub1.renderShadow(toolkit);
                }
                if (class600_sub1_sub5_sub1_160_.shadow()) {
                    class600_sub1_sub5_sub1_160_.renderShadow(toolkit);
                }
                class600_sub1_sub5 = class600_sub1_sub5_sub1;
                ...
                class600_sub1_sub5_159_ = new StaticBoundary(sceneGraph, toolkit, defLoader, def, i_146_, i_147_, i_148_,
                        i_149_, i_150_, underwater, i, i_158_, i_144_, i_145_);
            }
            sceneGraph.method8359(i_146_, i_151_, i_152_, class600_sub1_sub5, class600_sub1_sub5_159_, 2096584039);
            if ((1 == def.occludes * 777675999 || aBool9928 && 777675999 * def.occludes == -1) && !underwater) {
                if (0 == i_143_) {
                    sceneGraph.aClass492_6695.method8515(1, i_146_, i_151_, i_152_, def.anInt7394 * 93223085,
                            def.anInt7395 * 683670749);
                    sceneGraph.aClass492_6695.method8515(2, i_146_, i_151_, 1 + i_152_,
                            def.anInt7394 * 93223085, def.anInt7395 * 683670749);
                } else if (1 == i_143_) {
                    sceneGraph.aClass492_6695.method8515(1, i_146_, i_151_ + 1, i_152_,
                            93223085 * def.anInt7394, 683670749 * def.anInt7395);
                    sceneGraph.aClass492_6695.method8515(2, i_146_, i_151_, 1 + i_152_,
                            93223085 * def.anInt7394, def.anInt7395 * 683670749);
                } else if (i_143_ == 2) {
                    sceneGraph.aClass492_6695.method8515(1, i_146_, 1 + i_151_, i_152_,
                            def.anInt7394 * 93223085, 683670749 * def.anInt7395);
                    sceneGraph.aClass492_6695.method8515(2, i_146_, i_151_, i_152_, def.anInt7394 * 93223085,
                            683670749 * def.anInt7395);
                } else if (i_143_ == 3) {
                    sceneGraph.aClass492_6695.method8515(1, i_146_, i_151_, i_152_, 93223085 * def.anInt7394,
                            683670749 * def.anInt7395);
                    sceneGraph.aClass492_6695.method8515(2, i_146_, i_151_, i_152_, def.anInt7394 * 93223085,
            ...
            if (64 != def.anInt7401 * 1601375007) {
                sceneGraph.method8334(i_146_, i_151_, i_152_, 1601375007 * def.anInt7401, -1579830867);
            }
            return true;
        }
        if (i == ObjectCategory.aClass541_7355.type * -1050493863) {
            ...
            sceneGraph.method8359(i_146_, i_151_, i_152_, class600_sub1_sub5, null, 2062178199);
            if (def.castsShadow && aBool4937) {
                if (i_143_ == 0) {
                    class120.setShadowing(i_151_, i_152_ + 1, 50);
                } else if (i_143_ == 1) {
        ...
        if (ObjectCategory.aClass541_7339.type * -1050493863 == i) {
            SceneEntity class600_sub1_sub3;
            if (dynamic) {
                DynamicGameObject class600_sub1_sub3_sub3 = new DynamicGameObject(sceneGraph, toolkit,
                        defLoader, def, i_146_, i_147_, i_148_, i_149_, i_150_, underwater, i_151_, i_151_, i_152_,
                ...
                class600_sub1_sub3 = new StaticGameObject(sceneGraph, toolkit, defLoader, def, i_146_, i_147_, i_148_,
                        i_149_, i_150_, underwater, i_151_, i_154_ + i_151_ - 1, i_152_, i_152_ + i_155_ - 1, i,
                        i_143_, i_144_, i_145_, true);
            }
            sceneGraph.method8423(class600_sub1_sub3, false);
            if (1 == def.occludes * 777675999 && !underwater) {
                int i_161_;
                if (0 == (i_143_ & 0x1)) {
                    i_161_ = 8;
                } else {
                ...
                sceneGraph.aClass492_6695.method8515(i_161_, i_146_, i_151_, i_152_, 93223085 * def.anInt7394,
                        0);
            }
            if (64 != 1601375007 * def.anInt7401) {
                sceneGraph.method8334(i_146_, i_151_, i_152_, 1601375007 * def.anInt7401, -355772503);
            }
            return true;
        }
        return false;
