...
public class NativeMouseRecord extends MouseRecord {
    ...
    static void method3315() {
        synchronized (NativeMouseRecord.records) {
            Point location = null;
            if (Engine.gameCanvas.isShowing()) {
                location = Engine.gameCanvas.getLocationOnScreen();
            }
            ...
            for (; ; ) {
                ...
                if (null == location || !Engine.gameCanvas.isShowing() || !HashedVariableCollection.aBool1483) {
                    record.cache();
                } else {
