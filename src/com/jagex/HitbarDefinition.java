...
public class HitbarDefinition implements Definition {
    ...
    public static void method8948(String string, String string_11_, String string_12_, boolean bool, int i) {
        if (string.length() <= 320 && Client.unconnected()) {
            ...
            Class31.accountUsername = string;
            Class31.accountPassword = string_11_;
            Class31.accountAuthenticator = string_12_;
    ...
    public static void method8950() {
        ...
        Client.method8796(907118265 * TextureMetricsList.menuX, MobVariableCollection.menuY * 1889755609,
                -1708755565 * PlayerInterfaceNode.menuWidth, Class593.menuHeight * 502538357);
        PlayerInterfaceNode.aClass480_Sub31_Sub17_11430 = null;
        MenuItem.aClass480_Sub31_Sub17_348 = null;
    }

    public static void method8951() {
        int i_15_ = Client.scene.getMapWidth();
        int i_16_ = Client.scene.getMapLength();
