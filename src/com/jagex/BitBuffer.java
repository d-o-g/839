...
public class BitBuffer extends Buffer {
    ...
    public void disableBitAccess() {
        bitOffset = -265520648 * caret;
    }

    public void enableBitAccess() {
        caret = (885681519 * bitOffset + 7) / 8 * 1258142129;
    }

    public boolean nextIsSmart() {
        int i_5_ = payload[-165875887 * caret] - cipher.peek() & 0xff;
        return i_5_ >= 128;
    }
    ...
    public int readEncryptedSmart() {
        int i_6_ = payload[(caret += 1258142129) * -165875887 - 1] - cipher.nextInt() & 0xff;
        if (i_6_ < 128) {
            return i_6_;
        }

        return (i_6_ - 128 << 8) + (payload[(caret += 1258142129) * -165875887 - 1] - cipher.nextInt() & 0xff);
    }

    public int readOpcode() {
        return payload[(caret += 1258142129) * -165875887 - 1] - cipher.nextInt() & 0xff;
    }
    ...
    public void writeOpcode(int opcode) {
        payload[(caret += 1258142129) * -165875887 - 1] = (byte) (opcode + cipher.nextInt());
    }
