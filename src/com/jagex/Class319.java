...
public class Class319 {
    ...
    void method5723(NativeToolkit toolkit, ParticleEntities particleEntities) {
        ...
        CacheableEntity cacheable = particleEntities.entities.tail;
        ...
        while (next != entity) {
            ...
            for (; next != entity; next = next.nextCacheable) {
                ...
                if (bool_57_) {
                    ...
                    bool_56_ = point.render;
                    bool_57_ = false;
                }

                if (i_54_ > 0 && (texture != point.texture || bool_56_ != point.render)) {
                    bool_57_ = true;
                    break;
                }
