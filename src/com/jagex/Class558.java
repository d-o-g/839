...
public class Class558 {
    ...
    static final void method9423() {
        ...
        for (int i_1_ = 0; i_1_ < Client.anInt10914 * 1947309341; i_1_++) {
            ...
            Npc npc = (Npc) Client.npcTable.get(i_2_).referent;
            buffer.readUShort();
            ...
            if (0 != (i_3_ & 0x400)) {
                ...
                npc.anInt11560 = (buffer.readLEUShort() + Client.engineCycle) * 1321566137;
                npc.anInt11522 = (buffer.readLEUShortA() + Client.engineCycle) * 771082565;
            ...
            if (0 != (i_3_ & 0x80)) {
                npc.target = buffer.readUShort() * -953311613;
                if (-209575893 * npc.target == 65535) {
                    npc.target = 953311613;
                }
            }
            if (0 != (i_3_ & 0x800)) {
            ...
            if (0 != (i_3_ & 0x8000000)) {
                ...
                npc.anInt11528 = (Client.engineCycle + buffer.readUShort()) * -1044838623;
                npc.anInt11529 = (Client.engineCycle + buffer.readLEUShortA()) * 1372621715;
            }
            if (0 != (i_3_ & 0x100000)) {
                npc.anInterface73_11556.clear();
                buffer.caret += -1778683038;
                int i_41_ = buffer.payload[(buffer.caret += 1258142129) * -165875887 - 1] & 0xff;
                for (int i_42_ = 0; i_42_ < i_41_; i_42_++) {
                    ...
                    DefaultMapEntry class383 = Npc.varpLoader.decodeTypedEntry(buffer, class423);
            ...
            if ((i_3_ & 0x40) != 0) {
                ...
                Mobile.method8795(npc, is, i_45_, true);
            }
            if ((i_3_ & 0x20) != 0) {
            ...
            if ((i_3_ & 0x80000) != 0) {
                int i_51_ = buffer.payload[(buffer.caret += 1258142129) * -165875887 - 1] & 0xff;
            ...
            if (0 != (i_3_ & 0x400000)) {
                buffer.caret += -1778683038;
                int i_61_ = buffer.payload[(buffer.caret += 1258142129) * -165875887 - 1] & 0xff;
            ...
            if (0 != (i_3_ & 0x4)) {
                ...
                if (i_64_ > 0) {
                    for (int i_65_ = 0; i_65_ < i_64_; i_65_++) {
                        ...
                        npc.hit(i_69_, i_67_, i_66_, i_68_, Client.engineCycle, i_70_);
                    }
                }
                ...
                if (i_71_ > 0) {
                    for (int i_72_ = 0; i_72_ < i_71_; i_72_++) {
                        ...
                        if (32767 != i_74_) {
                            ...
                            npc.method17952(i_73_, Client.engineCycle, i_74_, i_75_, i_76_, i_77_);
                        } else {
