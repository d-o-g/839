...
public class DirectXToolkit extends NativeToolkit {
    ...
    DirectXToolkit(int i, int i_0_, long l, long l_1_, Direct3DDisplayMode mode, Direct3DPresentParameters parameters,
                   Direct3DCaps d3dcaps, TextureMetricsList metricsList, TextureLoader textureLoader, BillboardLoader billboardLoader,
                   ParticleProducerDefinitionLoader particleLoader, Interface44 interface44, Archive shaders, int i_2_) {
        super(metricsList, textureLoader, billboardLoader, particleLoader, interface44, shaders, i_2_, 0);
        aBool11053 = false;
        aLong11054 = 0L;
        aLong11055 = 0L;
        aLong11056 = 0L;
    ...
    public static Toolkit create(Canvas canvas, TextureMetricsList metricsList, TextureLoader textureLoader,
        ...
        try {
            ...
            return method17418(canvas, metricsList, textureLoader, billboardLoader, particleLoader, interface44, shaders,
                    multisamples);
        } catch (Throwable throwable) {
            throw new RuntimeException("");
        }
    ...
    static Toolkit method17418(Canvas canvas, TextureMetricsList metricsList, TextureLoader textureLoader,
                               BillboardLoader billboardLoader, ParticleProducerDefinitionLoader particleLoader, Interface44 interface44,
        ...
        try {
            ...
            toolkit = new DirectXToolkit(i, i_51_, l, l_53_, mode, parameters, caps, metricsList, textureLoader,
    ...
    @Override
    public NativeAttachment method2401(int i, int i_10_, Class121 class121, Class151 class151, int i_11_) {
        return new Class376(this, class121, class151, i, i_10_, i_11_);
    }

    @Override
    public NativeAttachBuffer method2403(int i, int i_78_, int i_79_) {
    ...
    @Override
    public NativeAttachBuffer method2774(int i, int i_12_) {
    ...
    public boolean method2806() {
        ...
        return aLongArray11062[anInt11060] == 0L;
    }
    ...
    public GraphicsCard getGraphicsCard() {
        ...
        return new GraphicsCard(identifier.vendorID, isFixedFunction() ? "Direct3D FF" : "Direct3D", 9,
    ...
    @Override
    void method14638() {
        for (ObjectNode class480_sub25 = (ObjectNode) aClass644_11077.head(); class480_sub25 != null; class480_sub25 = (ObjectNode) aClass644_11077
                .next()) {
            Interface45 interface45 = (Interface45) class480_sub25.referent;
    ...
    ObjectNode method17404(Interface45 interface45) {
        for (ObjectNode class480_sub25 = (ObjectNode) aClass644_11077.head(); class480_sub25 != null; class480_sub25 = (ObjectNode) aClass644_11077
                .next()) {
            if (class480_sub25.referent == interface45) {
    ...
    void method17405(Interface45 interface45) {
        ObjectNode class480_sub25 = method17404(interface45);
    ...
    void method17412(Interface45 interface45) {
        if (method17404(interface45) == null) {
            aClass644_11077.pushBack(new ObjectNode(interface45));
        }
    }
