...
public class Class570 {
    ...
    static final boolean decodeFrame(BufferedConnectionContext context) throws IOException {
        ...
        BitBuffer buffer = context.buffer;
        if (null == connection) {
            return false;
        }
        ...
        if (context.currentFrame == null) {
            ...
            if (opcode < 0 || opcode >= metas.length) {
                throw new IOException(new StringBuilder().append(opcode).append(" ").append(-165875887 * buffer.caret)
                        .toString());
            }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4364) {
            ...
            if (0 == context.currentFrameSize * -842560185) {
                ItemDefinition.aMappingVarpProvider_8339 = null;
            } else {
                ItemDefinition.aMappingVarpProvider_8339 = new MappingVarpProvider(0L, buffer, true, Client.anBigBoyVarpProvider_10652);
            }
        ...
        if (IncomingFrameMeta.aClass386_4408 == context.currentFrame) {
            Class199.aVarcs_2099.method14034();
            context.currentFrame = null;
            return false;
        }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4379) {
            ObjectNode.aClass126_10169 = new HashedVariableCollection(Class501.aClass77_Sub1_Sub1_6903);
            context.currentFrame = null;
            return true;
        }
        if (context.currentFrame == IncomingFrameMeta.aClass386_4331) {
            ...
            Class166_Sub6.method15081();
            InterfaceNode.method4800(i_17_, new InterfaceNode(i_18_, i_20_),
        ...
        if (context.currentFrame == IncomingFrameMeta.SET_COMPONENT_COLOR) {
            int component = buffer.readInt();
            int color = buffer.readLEUShortA();
            Class166_Sub6.method15081();
            PulseEvent.setComponentColor(component, color);
            context.currentFrame = null;
            return true;
        }
        ...
        if (context.currentFrame == IncomingFrameMeta.PLAY_CUTSCENE) {
            ...
            Client.cutsceneStatus = 902614604;
            ...
            HashedVariableCollection.aClass480_Sub17_1484.writeBytes(buffer.payload, buffer.caret * -165875887, size);
            buffer.caret += size * 1258142129;
            context.currentFrame = null;
            return false;
        }
        ...
        if (IncomingFrameMeta.aClass386_4439 == context.currentFrame) {
            ...
            PlayerFacade.instance.skills[i_37_].method9532(i_36_);
            PlayerFacade.instance.skills[i_37_].method9529(i_35_);
        ...
        if (IncomingFrameMeta.aClass386_4387 == context.currentFrame) {
            ...
            Class166_Sub6.method15081();
            ZoneProt.method6032(i_38_, i_39_);
            context.currentFrame = null;
            return true;
        }
        if (context.currentFrame == IncomingFrameMeta.aClass386_4377) {
            BitBuffer copy = new BitBuffer(context.currentFrameSize * -842560185);
            System.arraycopy(context.buffer.payload, context.buffer.caret * -165875887, copy.payload, 0,
                    context.currentFrameSize * -842560185);
            Class255.method4748();

            if (Class199.preferences.aClass632_Sub33_10293.getValue() == 1) {
                ChatContainer.aClass461_2622.method7825(new Class452(SceneFormat.aSceneFormat_5154, copy));
            } else {
                Client.scene.method7706(new Class452(SceneFormat.aSceneFormat_5154, copy));
            }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4313) {
            int npcIndex = buffer.readUShort();
            int i_42_ = buffer.readIMEInt();
            int i_43_ = buffer.readInt();
            int i_44_ = buffer.readInt();
            int interfaceId = buffer.readLEUShortA();
            int i_46_ = buffer.readInt();
            int i_47_ = buffer.readIMEInt();
            int interfaceState = buffer.readUByteS();

            Class166_Sub6.method15081();
            InterfaceNode.method4800(i_42_, new NpcInterfaceNode(interfaceId, interfaceState, npcIndex), new int[]{i_46_, i_47_,
                    i_43_, i_44_}, false);
            context.currentFrame = null;
            return true;
        }
        ...
        if (IncomingFrameMeta.aClass386_4334 == context.currentFrame) {
            ...
            Class166_Sub6.method15081();
            ZoneProt.method6032(i_56_, i_55_);
            context.currentFrame = null;
            return true;
        }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4327) {
            ...
            ChatMessageIcon chatMessageIcon = CompressionType.findIdentifiable(ChatMessageIcon.values(), buffer.readUByte());
            boolean bool = buffer.readUByte() == 1;
            ...
            while_43_:
            do {
                if (null == ItemDefinition.aMappingVarpProvider_8339) {
                    bool_60_ = true;
                } else {
                    ...
                    if (chatMessageIcon.aBool3707 && IgnoredPlayer.isIgnored(name)) {
                        bool_60_ = true;
                    }
                }
            } while (false);
            ...
            if (!bool_60_) {
                ...
                if (chatMessageIcon.crown * 1921955303 != -1) {
                    JavaThreadResource.addChatMessage(i_63_, 0,
                            Class290_Sub1.crown(chatMessageIcon.crown * 1921955303) + name,
                            Class290_Sub1.crown(chatMessageIcon.crown * 1921955303) + name, name, string_62_,
                            ItemDefinition.aMappingVarpProvider_8339.method3811(), i_58_, chatMessageIcon);
                } else {
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4401) {
            ...
            int i_65_ = -165875887 * buffer.caret;
            int i_66_ = buffer.readUShort();
            boolean bool = buffer.readUByte() == 1;
            SkillVarpProvider skillVarpProvider = ItemDefinition.aMappingVarpProvider_8339.method3806(i_66_);
            DefaultHashMap class666 = skillVarpProvider.method3893();

            if (null == class666 || bool) {
                skillVarpProvider.method3892(Client.anBigBoyVarpProvider_10652);
                class666 = skillVarpProvider.method3893();
            }

            while (context.currentFrameSize * -842560185 - (buffer.caret * -165875887 - i_65_) > 0) {
                DefaultMapEntry class383 = Varp.varpLoader.decode(buffer);
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4291) {
            ...
            if (bool) {
                Class417.aClass480_Sub33_4650 = new ClanChannel(buffer);
            } else {
                Class486.aClass480_Sub33_6643 = new ClanChannel(buffer);
            }
        ...
        if (IncomingFrameMeta.aClass386_4337 == context.currentFrame) {
            ...
            for (int i_75_ = 0; i_75_ < i_74_; i_75_++) {
                ...
                ItemTable.add(i_72_, i_75_, i_76_ - 1, i_77_, bool);
            }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4381) {
            ...
            if (null != Class598.loadedInterfaces[i_78_]) {
                for (int i_81_ = i_79_; i_81_ < i_80_; i_81_++) {
                    ...
                    if (i_81_ < Class598.loadedInterfaces[i_78_].components.length
                            && Class598.loadedInterfaces[i_78_].components[i_81_] != null) {
                        Class598.loadedInterfaces[i_78_].components[i_81_].anInt2375 = i_82_ * 741620033;
                    }
                }
            }
            context.currentFrame = null;
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4375) {
            if (Client.anInt10790 * 1764783361 != -1) {
                Component.method15440(1764783361 * Client.anInt10790, 0);
            }
            context.currentFrame = null;
            return true;
        }
        ...
        if (IncomingFrameMeta.aClass386_4461 == context.currentFrame) {
            ...
            PlayerFacade.instance.collection.update(Varp.varpLoader.get(id), value);
            context.currentFrame = null;
            return true;
        }
        ...
        if (IncomingFrameMeta.aClass386_4453 == context.currentFrame) {
            ...
            do {
                if (null == class480_sub33) {
                    ...
                    if (chatMessageIcon.aBool3707 && IgnoredPlayer.isIgnored(string)) {
                        bool_97_ = true;
                    }
                }
            } while (false);
            if (!bool_97_) {
                ...
                if (1921955303 * chatMessageIcon.crown != -1) {
                    JavaThreadResource.addChatMessage(i_100_, 0,
                            new StringBuilder().append(Class290_Sub1.crown(1921955303 * chatMessageIcon.crown)).append(string)
                                    .toString(),
                            new StringBuilder().append(Class290_Sub1.crown(1921955303 * chatMessageIcon.crown)).append(string)
                                    .toString(), string, string_99_, class480_sub33.aString10231, i_95_, chatMessageIcon);
                } else {
                    JavaThreadResource.addChatMessage(i_100_, 0, string, string, string, string_99_,
                            class480_sub33.aString10231, i_95_, chatMessageIcon);
                }
            }
            context.currentFrame = null;
            return true;
        ...
        if (IncomingFrameMeta.aClass386_4362 == context.currentFrame) {
            ...
            Client.scene.method7690().method9696(Client.scene, bool ? class591 : null,
                    class591.method9953());
            context.currentFrame = null;
            return true;
        }
        if (context.currentFrame == IncomingFrameMeta.aClass386_4465) {
            ...
            if (linkable != null) {
                Mobile.method8795(linkable.referent, animations, i_102_, true);
            }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4294) {
            Client.camera.method15142(buffer, context.currentFrameSize * -842560185);
                ...
                if (null == class480_sub16) {
                    if (i_112_ == -1) {
                        class480_sub16_113_ = new Class480_Sub16(setting,
                                Component.lookup(target).settings.anInt10101 * 1945403175);
                    } else {
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4441) {
            ...
            PlayerFacade.instance.collection.updateVarpBit(VarpBit.loader.get(id), i_115_);
            context.currentFrame = null;
            return true;
        }
        if (IncomingFrameMeta.aClass386_4292 == context.currentFrame) {
            ...
            if (null != Client.aClass473Array10624[i_116_]) {
                Client.aClass473Array10624[i_116_].method8061(Client.scene.getGraph());
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4330) {
            ...
            Class166_Sub6.method15081();
            InterfaceNode lw = Client.openInterfaces.get(i_118_);
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4328) {
            ...
            Class195 class195 = new Class195(buffer, Client.anBigBoyVarpProvider_10652);
            class195.method3852(ItemDefinition.aMappingVarpProvider_8339);
            context.currentFrame = null;
            return true;
        }
        ...
        if (IncomingFrameMeta.aClass386_4404 == context.currentFrame) {
            ...
            CoordGrid class553 = new CoordGrid(buffer.readInt());
            ...
            InterfaceNode.method4800(i_133_, new Class480_Sub41_Sub2(i_125_, i_134_, new Class628(class553, i_127_,
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4296) {
            ...
            while (-165875887 * buffer.caret < context.currentFrameSize * -842560185) {
                ...
                ItemTable.add(i_136_, i_138_, i_139_ - 1, i_140_, bool);
            }
        ...
        if (context.currentFrame == IncomingFrameMeta.SEND_QUICKCHAT_MESSAGE) {
            ...
            do {
                ...
                if (chatMessageIcon.aBool3707 && IgnoredPlayer.isIgnored(username)) {
                    invalid = true;
                }
            } while (false);
            ...
            if (!invalid) {
                ...
                if (chatMessageIcon.crown * 1921955303 != -1) {
                    JavaThreadResource.addChatMessage(20, 0, Class290_Sub1.crown(1921955303 * chatMessageIcon.crown) + string,
                            Class290_Sub1.crown(chatMessageIcon.crown * 1921955303) + username, string, message, string_144_,
                            i_146_, chatMessageIcon);
                } else {
        ...
        if (context.currentFrame == IncomingFrameMeta.SET_COMPONENT_ANIMATION) {
            int animation = buffer.readMEInt();
            int component = buffer.readMEInt();
            Class166_Sub6.method15081();
            PulseEvent.setComponentAnimation(component, animation);
            context.currentFrame = null;
            return true;
        }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4459) {
            ...
            if (i_171_ >= 0 && i_172_ >= 0 && i_171_ < Client.scene.getMapWidth() * 2
                    && i_172_ < Client.scene.getMapWidth() * 2 && i_162_ >= 0 && i_157_ >= 0
                    && i_162_ < Client.scene.getMapLength() * 2
                    && i_157_ < Client.scene.getMapLength() * 2 && i_168_ != 65535) {
                i_171_ *= 256;
                i_172_ *= 256;
                i_162_ = 256 * i_162_;
                i_157_ *= 256;
        ...
        if (IncomingFrameMeta.aClass386_4416 == context.currentFrame) {
            SceneGraphTile.aClass655_6685 = Class655.valueOf(buffer.readUByte());
            context.currentFrame = null;
            return true;
        }
        ...
        if (context.currentFrame == IncomingFrameMeta.ITEM_ON_COMPONENT) {
            int component = buffer.readLEInt();
            ...
            Class166_Sub6.method15081();
            PulseEvent.setComponentItem(component, id, amount);
            ItemDefinition definition = ItemDefinition.loader.get(id);
            PulseEvent.method1713(component, 1763387363 * definition.modelPitch, definition.modelRoll * -706143343,
                    777862773 * definition.modelScale);
            PulseEvent.method15089(component, 805773215 * definition.modelTranslateX, -1113093815
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4311) {
            ObjectNode.aClass126_10169 = null;
            context.currentFrame = null;
            return true;
        }
                    ...
                    if (!bool) {
                        if (name.equals(friend.name)) {
                            if (world != -1900962431 * friend.world) {
                                ...
                                for (FriendLoginUpdate update = Client.friendLogins.head(); null != update; update = Client.friendLogins
                                        .next()) {
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4345) {
            ...
            Class166_Sub6.method15081();
            InterfaceNode lw = Client.openInterfaces.get(i_208_);
            InterfaceNode lw0 = Client.openInterfaces.get(i_209_);

            if (null != lw0) {
                InterfaceNode.method9830(lw0, lw == null || 1021060255 * lw.id != 1021060255 * lw0.id, false);
            }

            if (lw != null) {
                lw.unlink();
                Client.openInterfaces.put(i_209_, lw);
            }

            Component class226 = Component.lookup(i_208_);
            if (null != class226) {
                Component.redraw(class226);
            }

            class226 = Component.lookup(i_209_);
            if (class226 != null) {
                Component.redraw(class226);
                Class548.method9327(Class598.loadedInterfaces[class226.uid * 1857819631 >>> 16], class226, true);
            }

            if (Client.anInt10790 * 1764783361 != -1) {
                Component.method15440(1764783361 * Client.anInt10790, 1);
            }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4323) {
            ...
            for (int i_220_ = i_218_; i_220_ <= i_219_; i_220_++) {
                ...
                if (class480_sub16 == null) {
                    if (-1 == i_220_) {
                        class480_sub16_221_ = new Class480_Sub16(Component.lookup(i_216_).settings.anInt10100
                                * -528482985, i_217_);
                    } else {
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4317) {
            if (ObjectNode.aClass126_10169 == null) {
                ObjectNode.aClass126_10169 = new HashedVariableCollection(Class501.aClass77_Sub1_Sub1_6903);
            }

            DefaultMapEntry class383 = Class501.aClass77_Sub1_Sub1_6903.decode(buffer);
            ObjectNode.aClass126_10169.map.put(class383.key * 1960527763, class383.value);
        ...
        if (IncomingFrameMeta.aClass386_4382 == context.currentFrame) {
            ...
            Class606.setWorld(i_222_, host);
            Class536.setConnectionState(14);
            context.currentFrame = null;
            return false;
        }
        ...
        if (context.currentFrame == IncomingFrameMeta.SET_PLAYER_MESSAGE) {
            ...
            if (player.accountName != null && player.appearance != null) {
                ...
                if (!bool_227_) {
                    ...
                    int i_229_;
                    if (chatMessageIcon.aBool3706) {
                        i_229_ = bool ? 17 : 1;
                    } else {
                        i_229_ = bool ? 17 : 2;
                    }

                    if (-1 != 1921955303 * chatMessageIcon.crown) {
                        JavaThreadResource.addChatMessage(i_229_, 0, Class290_Sub1.crown(chatMessageIcon.crown * 1921955303)
                                        + player.formattedName(true),
                                Class290_Sub1.crown(1921955303 * chatMessageIcon.crown) + player.getName(false),
                                player.displayName, text, null, i_228_, chatMessageIcon);
                    } else {
        ...
        if (IncomingFrameMeta.aClass386_4415 == context.currentFrame) {
            ...
            InterfaceNode.method4800(component, new PlayerInterfaceNode(i_232_, i_233_, i_236_), new int[]{i_237_,
            ...
            if (0 != position >> 30) {
                ...
                if (x >= 0 && z >= 0 && x < Client.scene.getMapWidth()
                    ...
                    if (-1 == graphicId) {
                        ...
                        if (collisionPlane < 3 && Client.scene.method7775().isBridge(x, z)) {
                            collisionPlane++;
                        }
                    ...
                    if (-1 != graphicId && currentGraphic != -1) {
                        if (graphicId == currentGraphic) {
                            ...
                            if (2053507375 * replacement.animation != -1 && 2053507375 * current.animation != -1) {
                                ...
                                Animation currentAnimation = Animation.loader
        ...
        if (IncomingFrameMeta.ADD_FRIENDS_CHATTER == context.currentFrame) {
            ...
            for (int index = 0; index < Client.friendChatSize * 46303181; index++) {
                ...
                if (players[index].accountName.equals(Client.localPlayer.accountName)) {
                    VarcType.localFcRank = players[index].rank;
                }
            }
        ...
        if (context.currentFrame == IncomingFrameMeta.SET_COMPONENT_HIDDEN) {
            int hidden = buffer.readUByte();
            int component = buffer.readLEInt();
            Class166_Sub6.method15081();
            PulseEvent.setComponentHidden(component, hidden);
            context.currentFrame = null;
            return true;
        }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4351) {
            if (Class456.lobbyState(Client.connectionState * -1501875989)) {
        ...
        if (context.currentFrame == IncomingFrameMeta.SET_UID) {
            buffer.caret += 868241244;
            if (buffer.matchingCrcs()) {
                Class378.saveUid(buffer, buffer.caret * -165875887 - 28);
            }
            context.currentFrame = null;
            return true;
        }
        ...
        if (IncomingFrameMeta.SET_COMPONENT_TEXT == context.currentFrame) {
            String text = buffer.readString();
            int component = buffer.readLEInt();
            Class166_Sub6.method15081();
            PulseEvent.setComponentText(component, text);
            context.currentFrame = null;
            return true;
        }
        if (context.currentFrame == IncomingFrameMeta.aClass386_4424) {
            ParticleTriangle.walkHere = -842560185 * context.currentFrameSize > 2 ? buffer.readString()
        ...
        if (context.currentFrame == IncomingFrameMeta.CONSTRUCTED_MAP_AREA) {
            BitBuffer copy = new BitBuffer(context.currentFrameSize * -842560185);
            System.arraycopy(context.buffer.payload, -165875887 * context.buffer.caret, copy.payload, 0,
                    context.currentFrameSize * -842560185);
            Class255.method4748();
            if (Class199.preferences.aClass632_Sub33_10293.getValue() == 1) {
                ChatContainer.aClass461_2622.method7825(new Class452(SceneFormat.CONSTRUCTED, copy));
            } else {
                Client.scene.method7706(new Class452(SceneFormat.CONSTRUCTED, copy));
            }
            context.currentFrame = null;
            return false;
        }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4307) {
            ...
            Client.scene.getGraph().method8461(i_310_, i_308_, i_309_, (byte) 52);
            context.currentFrame = null;
            return true;
        }
        ...
        if (IncomingFrameMeta.aClass386_4431 == context.currentFrame) {
            ...
            for (SceneMod sceneMod = SceneMod.pendingSpawns.head(); sceneMod != null; sceneMod = SceneMod.pendingSpawns
                    .next()) {
                if (1155137153 * sceneMod.localX >= Class185.localRegionX * 1507881063
            ...
            for (SceneMod sceneMod = SceneMod.pendingRotations.head(); sceneMod != null; sceneMod = SceneMod.pendingRotations
                    .next()) {
                if (1155137153 * sceneMod.localX >= 1507881063 * Class185.localRegionX
                ...
                if (chatMessageIcon.crown * 1921955303 != -1) {
                    JavaThreadResource.addChatMessage(i_324_, 0,
                            new StringBuilder().append(Class290_Sub1.crown(1921955303 * chatMessageIcon.crown)).append(string)
                                    .toString(),
                            new StringBuilder().append(Class290_Sub1.crown(1921955303 * chatMessageIcon.crown)).append(string)
                                    .toString(), string, string_323_, ItemDefinition.aMappingVarpProvider_8339.method3811(), -1,
                            chatMessageIcon);
                } else {
                    JavaThreadResource.addChatMessage(i_324_, 0, string, string, string, string_323_,
                            ItemDefinition.aMappingVarpProvider_8339.method3811(), -1, chatMessageIcon);
                }
            }
            context.currentFrame = null;
            return true;
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4433) {
            ...
            if (buffer.readUByte() == 0) {
                Client.grandExchangeOffers[i_325_] = new GrandExchangeOffer();
            } else {
                buffer.caret -= 1258142129;
                Client.grandExchangeOffers[i_325_] = new GrandExchangeOffer(buffer, null);
            }
            ...
            if (!bool_333_) {
                ...
                if (1921955303 * chatMessageIcon.crown != -1) {
                    JavaThreadResource.addChatMessage(i_336_, 0,
                            new StringBuilder().append(Class290_Sub1.crown(chatMessageIcon.crown * 1921955303)).append(string)
                                    .toString(),
                            new StringBuilder().append(Class290_Sub1.crown(1921955303 * chatMessageIcon.crown)).append(string)
                                    .toString(), string, string_335_, class480_sub33.aString10231, -1, chatMessageIcon);
                } else {
                    JavaThreadResource.addChatMessage(i_336_, 0, string, string, string, string_335_,
                            class480_sub33.aString10231, -1, chatMessageIcon);
                }
            }
            context.currentFrame = null;
            return true;
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4303) {
            ...
            component.anInt2396 = i_342_ * 1115802887;
            context.currentFrame = null;
            return true;
        }
        ...
        if (IncomingFrameMeta.SET_SCROLL_POSITION == context.currentFrame) {
            int component = buffer.readIMEInt();
            int position = buffer.readLEUShort();
            Class166_Sub6.method15081();
            PulseEvent.setComponentScrollPosition(component, position);
            context.currentFrame = null;
            return true;
        }
        ...
        if (IncomingFrameMeta.aClass386_4349 == context.currentFrame) {
            ...
            PlayerFacade.instance.collection.update(Varp.varpLoader.get(i_356_), i_357_);
            context.currentFrame = null;
            return true;
        }
            ...
            if (!bool_363_) {
                ...
                if (1921955303 * chatMessageIcon.crown != -1) {
                    JavaThreadResource.addChatMessage(
                            ...
                            new StringBuilder().append(Class290_Sub1.crown(chatMessageIcon.crown * 1921955303)).append(string)
                                    .toString(),
                            new StringBuilder().append(Class290_Sub1.crown(chatMessageIcon.crown * 1921955303))
                                    .append(string_359_).toString(), string, string_365_, string_360_, -1, chatMessageIcon);
                } else {
        ...
        if (context.currentFrame == IncomingFrameMeta.RESET_MOB_ANIMATIONS) {
            for (int i_366_ = 0; i_366_ < Client.players.length; i_366_++) {
                if (Client.players[i_366_] != null) {
                    ...
                    Client.players[i_366_].animator.update(-1);
                }
            }
            for (int i_367_ = 0; i_367_ < -999337347 * Client.anInt10862; i_367_++) {
                Client.npcs[i_367_].referent.anIntArray11538 = null;
                Client.npcs[i_367_].referent.animator.update(-1);
            }
            context.currentFrame = null;
            return true;
        }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4344) {
            CoordGrid class553 = new CoordGrid(buffer.readIMEInt());
            ...
            Class166_Sub6.method15081();
            InterfaceNode.method4800(i_369_, new Class480_Sub41_Sub1(i_372_, i_374_, new Class606(class553, i_371_)),
        ...
        if (context.currentFrame == IncomingFrameMeta.SET_COMPONENT_POSITION) {
            int x = buffer.readShortA();
            int component = buffer.readIMEInt();
            int y = buffer.readLEShort();
            Class166_Sub6.method15081();
            PulseEvent.setComponentPosition(component, x, y);
            context.currentFrame = null;
            return true;
        }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4361) {
            ...
            if (bool_399_) {
                ...
                if (index < Client.friendChatSize * 46303181) {
                    while (index < Client.friendChatSize * 46303181 - 1) {
        ...
        if (IncomingFrameMeta.aClass386_4299 == context.currentFrame) {
            ...
            if (!bool_409_) {
                ...
                int i_412_ = chatMessageIcon.aBool3706 ? 7 : 3;
                if (1921955303 * chatMessageIcon.crown != -1) {
                    JavaThreadResource.addChatMessage(
                            i_412_,
                            0,
                            new StringBuilder().append(Class290_Sub1.crown(1921955303 * chatMessageIcon.crown)).append(string)
                                    .toString(),
                            new StringBuilder().append(Class290_Sub1.crown(1921955303 * chatMessageIcon.crown))
                                    .append(string_406_).toString(), string, string_411_, null, -1, chatMessageIcon);
                } else {
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4458) {
            ...
            Component.method5082(1764783361 * Client.anInt10790, is);
            for (int i_418_ = 0; i_418_ < 104; i_418_++) {
                Client.validComponents[i_418_] = true;
            }
            context.currentFrame = null;
            return true;
        }
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4393) {
            ...
            do {
                ...
                if (chatMessageIcon.aBool3707 && IgnoredPlayer.isIgnored(string_419_)) {
                    bool_423_ = true;
                }
            } while (false);
            if (!bool_423_) {
                ...
                if (1921955303 * chatMessageIcon.crown != -1) {
                    JavaThreadResource.addChatMessage(
                            ...
                            new StringBuilder().append(Class290_Sub1.crown(1921955303 * chatMessageIcon.crown)).append(string)
                                    .toString(),
                            new StringBuilder().append(Class290_Sub1.crown(chatMessageIcon.crown * 1921955303))
                                    .append(string_419_).toString(), string, string_425_, null, i_421_, chatMessageIcon);
                } else {
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4421) {
            ...
            int i_427_ = buffer.readShortA(-869978518);
            int index = buffer.readUShort();
        ...
        if (context.currentFrame == IncomingFrameMeta.aClass386_4358) {
            ...
            PlayerFacade.instance.collection.updateVarpBit(VarpBit.loader.get(varbit), i_430_);
            context.currentFrame = null;
            return true;
        }
