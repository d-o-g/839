...
public class Class475 {
    ...
    boolean method8108(Toolkit toolkit, Class475 class475_18_) {
        if (sprite == null) {
            if (anInt6556 == 0) {
                if (PlayerFacade.anTextureLoader_1027.loaded(TextureType.TEXTURE_AND_MATERIAL, anInt654)) {
                    int[] data = PlayerFacade.anTextureLoader_1027.loadOpaque(TextureType.TEXTURE_AND_MATERIAL,
                            anInt654, 0.7F);
    ...
    void method8109(Toolkit toolki, Class475 class475_19_) {
        ...
        if (base != null) {
            ...
            int i_30_ = model.maximumX() - model.minimumX();
            int i_31_ = model.maximumY() - model.minimumY();
            int i_32_ = i_30_ > i_31_ ? i_30_ : i_31_;
            int i_33_ = 1024 * size / i_32_;
            Matrix4f clone = toolki.cloneMatrix4f();
            Matrix4f matrix = toolki.getMatrix4f();
            matrix.method6560(size / 2, size / 2, i_33_, i_33_, 50.0F, 50000.0F, toolki.method2628().getWidth(),
                    toolki.method2628().getHeight(), 1024.0F);
            toolki.method2540(matrix);
            Matrix4x3 class405 = new Matrix4x3();
            toolki.method2471(class405);
            Matrix4x3 class405_35_ = toolki.getMatrix4x3();
            class405_35_.method6742(0.0F, 0.0F, 50 - model.minimumZ());
            model.method2917(class405_35_, null, 1);
            sprite = toolki.method2630(0, 0, size, size, true);
            sprite.method2114(0, 0, 3);
            toolki.method2540(clone);
    ...
    void method8111(Toolkit toolkit, Class475 class475_36_) {
        ...
        int i_45_ = 1024 * size / (model.maximumX() - model.minimumX());

        if (anInt6552 != 0) {
            i_45_ = i_45_ * 13 / 16;
        }

        Matrix4f class399 = toolkit.cloneMatrix4f();
        Matrix4f class399_46_ = toolkit.getMatrix4f();
        ...
        toolkit.method2471(new Matrix4x3());
        Matrix4x3 class405 = new Matrix4x3();
        class405.method6742(0.0F, 0.0F, 50 - model.minimumZ());
