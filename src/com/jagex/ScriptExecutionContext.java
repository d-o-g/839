...
public class ScriptExecutionContext {
    ...
    Script script;
    ClanChannel aClass480_Sub33_7935;
    ItemPile aClass600_Sub1_Sub1_Sub1_7938;
    Mobile targetMobile;
                ...
                if (class480_sub11.method15592(i, i_0_, (byte) 75)) {
                    if (null != class224.aStringArray2312) {
                        if (null != class224.aStringArray2312[4]) {
                            MenuItem.add(class224.aStringArray2312[4], class224.aString2313, -1, 1012, -1,
                        ...
                        if (class224.aStringArray2312[3] != null) {
                            MenuItem.add(class224.aStringArray2312[3], class224.aString2313, -1, 1011, -1,
                                    818539827 * class480_sub11.aClass480_Sub37_10053.id,
                        ...
                        if (class224.aStringArray2312[2] != null) {
                            MenuItem.add(class224.aStringArray2312[2], class224.aString2313, -1, 1010, -1,
                                    818539827 * class480_sub11.aClass480_Sub37_10053.id,
                                    class224.anInt2303 * 1606761481, 0, true, false,
                                    818539827 * class480_sub11.aClass480_Sub37_10053.id, false);
                        }
                        if (class224.aStringArray2312[1] != null) {
                            MenuItem.add(class224.aStringArray2312[1], class224.aString2313, -1, 1009, -1,
                                    818539827 * class480_sub11.aClass480_Sub37_10053.id,
                                    1606761481 * class224.anInt2303, 0, true, false,
                                    class480_sub11.aClass480_Sub37_10053.id * 818539827, false);
                        }
                        if (null != class224.aStringArray2312[0]) {
                            MenuItem.add(class224.aStringArray2312[0], class224.aString2313, -1, 1008, -1,
                                    818539827 * class480_sub11.aClass480_Sub37_10053.id,
                                    class224.anInt2303 * 1606761481, 0, true, false,
                                    818539827 * class480_sub11.aClass480_Sub37_10053.id, false);
                        }
    ...
    static final void method6012(ScriptExecutionContext context, int i) {
        Varp class131 = (Varp) context.script.anObjectArray11388[1523704279 * context.counter];
        ...
        if (class423 == ValueType.INTEGER) {
            if (class131.type == VarpType.CLIENT) {
                SceneFormat.method7546(class131, 1182137911);
            }
    ...
    static final void method7875(ScriptExecutionContext class613, int i) {
        MenuItem class480_sub31_sub17 = Class63.method1482();
        ...
        class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = MenuItem.getAction(
    ...
    static void execute(Script script, int maximumOperations, ScriptExecutionContext context) {
        ...
        context.aMap7939.put(VarpType.PLAYER, PlayerFacade.instance.collection);
        context.aMap7939.put(VarpType.CLIENT, Class199.aVarcs_2099);
        context.aMap7939.put(VarpType.CLAN, ObjectNode.aClass126_10169);
        ...
        if (context.targetMobile instanceof Npc) {
            context.aMap7939.put(VarpType.NPC, context.targetMobile.anInterface13_11517);
        }

        if (context.targetMobile instanceof Player) {
            context.aMap7940.put(VarpType.PLAYER, context.targetMobile.anInterface13_11517);
        }

        if (ItemDefinition.aMappingVarpProvider_8339 != null) {
            context.aMap7939.put(VarpType.aClass441_5047, ItemDefinition.aMappingVarpProvider_8339.method3836());
        }
    ...
    static final void method15098(ScriptExecutionContext class613) {
        ...
        InterfaceNode class480_sub41 = Client.openInterfaces.get(i_0_);
        if (class480_sub41 != null && i_1_ == 1021060255 * class480_sub41.id) {
    ...
    static final void method15099(Component class226, Interface class221, ScriptExecutionContext class613) {
        ...
        class226.anObjectArray2493 = World.method16248(string, class613);
    ...
    static final void method3328(Component class226, ScriptExecutionContext class613) {
        class613.anInt7924 -= -2049596966;
    ...
    static final void method3327(Component class226, Interface class221, ScriptExecutionContext class613) {
    ...
    static final void method15133(ScriptExecutionContext class613, int i) {
        ...
        Component class226 = Component.lookup(i_1_);
    ...
    static final void method15137(ScriptExecutionContext class613, int i) {
        ...
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = ItemTable
                .getTotalItemQuantity(i_1_, i_2_, false);
    }
    ...
    static final void method9383(ScriptExecutionContext class613) {
        int i_5_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Npc class600_sub1_sub3_sub1_sub2 = (Npc) class613.targetMobile;
    ...
    static final void method3190(ScriptExecutionContext class613, int i) {
        ...
        if (Class495_Sub1.aClass667_10338 != null) {
            Node class480 = Class495_Sub1.aClass667_10338.get(i_6_);
    ...
    static final void method1102(Component class226, Interface class221, ScriptExecutionContext class613) {
    ...
    static final void method6084(ScriptExecutionContext class613) {
        ...
        if (Class495_Sub1.aClass667_10338 != null) {
            Node class480 = Class495_Sub1.aClass667_10338.get(i_1_);
    ...
    static final void method6085(ScriptExecutionContext class613, byte i) {
        int i_2_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        int i_3_ = Client.grandExchangeOffers[i_2_].method7375();
    ...
    static void method1605(ScriptExecutionContext context, ScriptInstruction instruction, Exception exception,
        ...
        for (int index = -748745979 * context.anInt7927 - 1; index >= 0; index--) {
            builder.append(context.aClass604Array7919[index].scripts.linkedKey * -4821875126325281949L)
                    .append(" ");
        }

        builder.append(Integer.valueOf(instruction.opcode * 1521341811));
    ...
    static final void method3747(ScriptExecutionContext class613, byte i) {
        ...
        class613.anInt7924 -= -2049596966;
        SceneFormat.method7544((String) class613.anObjectArray7918[211787933 * class613.anInt7929],
    ...
    static final void method3750(ScriptExecutionContext class613) {
        int i_8_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Component class226 = Component.lookup(i_8_);
    ...
    static final void method3539(Component class226, Interface class221, ScriptExecutionContext class613, byte i) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2513 = World.method16248(string, class613);
        class226.aBool2483 = true;
    }
    ...
    static final void method3542(ScriptExecutionContext class613, int i) throws ScriptException {
        ...
        Vector3f vector3f = Vector3f.create(i_7_, i_8_, i_9_);
        if (-1.0F == vector3f.x) {
            vector3f.x = Float.POSITIVE_INFINITY;
        }
        if (vector3f.y == -1.0F) {
            vector3f.y = Float.POSITIVE_INFINITY;
        }
        if (-1.0F == vector3f.z) {
            vector3f.z = Float.POSITIVE_INFINITY;
        }
        Client.camera.method4814(vector3f);
        Client.camera.method4823(i_10_ / 1000.0F, (byte) 0);
        vector3f.cache();
    }
    ...
    static final void method3533(ScriptExecutionContext class613, int i) {
        ...
        Component class226 = Component.lookup(i_17_);
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = class226.fontId * 1668905963;
    }
    ...
    static final void method3491(Component class226, Interface class221, ScriptExecutionContext class613) {
        class226.method4234();
    }
    ...
    static final void method7409(Component class226, ScriptExecutionContext class613, int i) {
    ...
    static final void method3569(ScriptExecutionContext class613, int i) {
        ...
        Component class226 = class611.aClass226_7914;
        Interface class221 = class611.aClass221_7913;
        SceneGraph.method8470(class226, class221, class613, 1553858567);
    }
    ...
    static final void method4411(ScriptExecutionContext class613, int i) {
        ...
        Component class226 = class611.aClass226_7914;
        Interface class221 = class611.aClass221_7913;
        Component.method7527(class226, class221, true, 0, class613);
    }
    ...
    static final void method8799(ScriptExecutionContext class613, int i) {
        int i_0_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = Client.grandExchangeOffers[i_0_]
    ...
    static final void method8801(ScriptExecutionContext class613, byte i) {
        ...
        Vector4i vector4i = (Vector4i) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (Client.camera.method4836() != Class257.aClass257_2850) {
            throw new RuntimeException();
        }
        ((Class642_Sub1) Client.camera.method4834()).method16692(vector4i.toVector3f(),
                class613.anIntArray7942[class613.anInt7924 * 1841827045],
    ...
    static final void method5099(ScriptExecutionContext class613) {
        ...
        if (Client.method17050(class226).method15631((short) -19297) && Client.aClass226_10793 == null) {
            Class276.method5162(1857819631 * class226.uid, class226.index * -592186295, (short) 29410);
            Client.aClass226_10793 = Class185.method3584(1857819631 * class226.uid, class226.index * -592186295);
    ...
    static final void method14015(ScriptExecutionContext class613) {
        ...
        Component.redraw(class226);
        Interface.method8775(class221, class226);
    ...
    static void method7343(ScriptExecutionContext class613) {
        ...
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = class234.skillRequirements == null ? 0
                : class234.skillRequirements.length;
    }

    static final void method7345(ScriptExecutionContext class613, byte i) {
        int i_2_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Component class226 = Component.lookup(i_2_);
    ...
    static final void method7386(ScriptExecutionContext class613) {
        ...
        InterfaceNode class480_sub41 = Client.openInterfaces.first();
        while (i_13_-- > 0) {
            class480_sub41 = Client.openInterfaces.next();
        }
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = 1021060255 * class480_sub41.id;
    }

    static final void method1683(Component class226, Interface class221, ScriptExecutionContext class613) {
        class613.anInt7924 -= 195773364;
    ...
    static final void method1685(ScriptExecutionContext class613, int i) {
        ...
        Component class226 = Component.lookup(i_1_);
        Interface class221 = Class598.loadedInterfaces[i_1_ >> 16];
        Component.method7527(class226, class221, true, 2, class613);
    }
    ...
    static final void method9316(ScriptExecutionContext class613) {
        ...
        SkillVarpProvider skillVarpProvider = ItemDefinition.aMappingVarpProvider_8339.method3806(i_8_);
        if (skillVarpProvider.method3893() == null) {
            skillVarpProvider.method3892(Client.anBigBoyVarpProvider_10652);
        }
        if (bool) {
            PlayerVariable class131_sub2 = Varp.varpLoader
                    .get(i_9_);
            switch (-1355589053 * class131_sub2.keyType.valueType.anInt4854) {
                case 4:
                    class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = skillVarpProvider
                            .method3893().getOrDefaultInt(class131_sub2.index * 169834903);
                    break;
                case 0:
                    class613.aLongArray7934[(class613.anInt7928 += 423292651) * -47101501 - 1] = skillVarpProvider.method3893()
                            .getOrDefaultLong(class131_sub2.index * 169834903);
                    break;
                default:
                    class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = skillVarpProvider
                            .method3893().getOrDefaultObject(169834903 * class131_sub2.index);
            }
        } else {
            VarpBit class301 = VarpBit.loader.get(i_9_);
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = class301.getValue(skillVarpProvider
                    .method3893().getOrDefaultInt(169834903 * class301.varp.index));
        }
    }
    ...
    static final void method9318(ScriptExecutionContext class613, int i) {
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = Class31.loginResponse2 * 1004082977;
    }
    ...
    static final void method9320(ScriptExecutionContext class613, int i) {
        ...
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = ChatMessage
                .method3149(i_10_);
    }
    ...
    static final void method9321(ScriptExecutionContext class613, int i) {
        ...
        class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = Client.camera
    ...
    static final void method6978(Component class226, Interface class221, ScriptExecutionContext class613, int i) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        int[] is = method9239(string, class613);
        if (null != is) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2500 = World.method16248(string, class613);
    ...
    static final void method6983(ScriptExecutionContext class613, int i) {
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = (int) ((TimeUtil.time()
                - ItemDefinition.aMappingVarpProvider_8339.method3770() - -4467880663037169619L
    ...
    static final void method6998(ScriptExecutionContext class613) {
        ...
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = ExpandableMenuItem.count * 1469668737;
    }

    static final void method7000(Component class226, ScriptExecutionContext class613) {
        int i_3_ = 10;
    ...
    static final void method5371(ScriptExecutionContext class613) {
        ...
        Component class226 = Component.lookup(i_49_);
        class226.actions = null;
    }

    static final void method5372(ScriptExecutionContext class613) {
        class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = ((Player) class613.targetMobile)
                .formattedName(true);
    }
    ...
    static void executeOnMobile(Class520 class520, int i, int i_1_, ScriptExecutionContext context) {
        ...
        if (null == script) {
            ...
            if (script.aClass520_11394 == Class520.aClass520_7176 || script.aClass520_11394 == Class520.aClass520_7178
                ...
                context.intVariables[0] = -414689037 * context.targetMobileIndex;
            }
    ...
    static final void method17571(ScriptExecutionContext class613) {
        int i_0_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = Client.grandExchangeOffers[i_0_].quantity * 848726687;
    }

    static final void method1632(Component class226, Interface class221, ScriptExecutionContext class613) {
        class226.modelType = -512645613;
    ...
    static final void method1635(ScriptExecutionContext class613) {
        int i_1_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        int i_2_ = Client.grandExchangeOffers[i_1_].method7375();
    ...
    static final void method5857(ScriptExecutionContext class613) {
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = BaseAnimationDefinitionProvider
                .method3320(-1501875989 * Client.connectionState) ? 1 : 0;
    }
    ...
    static final void method5855(ScriptExecutionContext class613) {
        Component class226 = Component.lookup(class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045]);
        class226.components2 = null;
        class226.subComponents = null;
        Component.redraw(class226);
    }

    static final void method5906(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        World.method16248(string, class613);
    }
    ...
    static final void method5961(ScriptExecutionContext class613, short i) {
        int i_1_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = class613.aClass480_Sub33_7935.aClass283Array10233[i_1_].name;
    }
    ...
    static final void method6046(ScriptExecutionContext class613, int i) {
        ...
        int i_5_ = class613.anIntArray7942[1841827045 * class613.anInt7924 + 1];
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = ItemTable.getParameterSum(i_4_, i_5_,
                true, false);
    }
    ...
    static final void method5975(ScriptExecutionContext class613, int i) {
        ...
        Component class226 = Component.lookup(i_1_);
        Interface class221 = Class598.loadedInterfaces[i_1_ >> 16];
        ChatMessage.method17837(class226, class221, class613);
    }

    static final void method5976(ScriptExecutionContext class613) {
        int i_2_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = Client.grandExchangeOffers[i_2_].id * 1146866127;
    }
    ...
    static final void method6018(ScriptExecutionContext class613, int i) {
        ...
        if (2 != class226.modelType * 286135323) {
            throw new RuntimeException("");
        }
        NpcDefinition definition = NpcDefinition.loader.get(class226.modelId * -643054127);
    ...
    static final void method6019(ScriptExecutionContext class613) {
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = 3 == 1212513917 * Client.mapState ? 1
                : 0;
    }
    ...
    static final void method13723(ScriptExecutionContext class613, byte i) {
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = class613.targetMobile
                .method16307();
    }

    static final void method13724(Component class226, Interface class221, ScriptExecutionContext class613, int i) {
        class226.spriteScale = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045] * 1495301125;
        Component.redraw(class226);
        if (-1 == class226.index * -592186295 && !class221.closed) {
            PulseEvent.method4741(1857819631 * class226.uid);
        }
    }
    ...
    static final void method1544(ScriptExecutionContext class613, int i) {
        ...
        Component class226 = Component.lookup(i_0_);
        Interface class221 = Class598.loadedInterfaces[i_0_ >> 16];
        DynamicTileDecoration.method18062(class226, class221, class613, 1758700346);
    }
    ...
    static final void method729(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2519 = World.method16248(string, class613);
        class226.aBool2483 = true;
    }

    static final void method731(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        int[] is = method9239(string, class613);
        if (null != is) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2498 = World.method16248(string, class613);
    ...
    static final void method17487(ScriptExecutionContext class613) {
        int i_8_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Component class226 = Component.lookup(i_8_);
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = 1920469085 * class226.parentUid;
    }
    ...
    static final void method912(ScriptExecutionContext class613, int i) {
        ...
        LoginEnum1.method4708(string, string_2_);
    }

    static final void method913(ScriptExecutionContext class613, int i) {
        boolean bool = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045] == 1;
        PlayerMapDot.method3873(bool);
    }

    static final void method914(ScriptExecutionContext class613, int i) {
        int i_3_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = PlayerFacade.instance
                .method1546(i_3_);
    }

    static final void method911(Component class226, Interface class221, ScriptExecutionContext class613) {
        class613.anInt7924 -= -2049596966;
        int i_0_ = class613.anIntArray7942[1841827045 * class613.anInt7924];
        int i_1_ = class613.anIntArray7942[class613.anInt7924 * 1841827045 + 1];
        if (-1 == i_0_ && i_1_ == -1) {
            class226.parent = null;
        } else {
            class226.parent = Class185.method3584(i_0_, i_1_);
        }
    }
    ...
    static final void method7005(Component class226, Interface class221, ScriptExecutionContext class613) {
        int i_2_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
    ...
    static final void method7007(ScriptExecutionContext class613, int i) {
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = Client.camera
    ...
    static final void method7011(Component class226, Interface class221, ScriptExecutionContext class613) {
        class226.textColor = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045] * -742586667;
        Component.redraw(class226);
        if (-1 == -592186295 * class226.index && !class221.closed) {
            PulseEvent.resetComponentColor(1857819631 * class226.uid);
        }
    }
    ...
    static final void method4798(Component class226, Interface class221, ScriptExecutionContext class613) {
        class226.aBool2423 = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045] == 1;
        Component.redraw(class226);
    }

    static final void method10237(Component class226, Interface class221, ScriptExecutionContext class613, int i) {
    ...
    static final void method9350(ScriptExecutionContext class613) throws ScriptException {
        class613.anInt7924 -= -2049596966;
        int i_5_ = class613.anIntArray7942[1841827045 * class613.anInt7924];
        Vector3f vector3f = Vector3f.create(i_5_, i_5_, i_5_);
        Client.camera.method4802(vector3f);
        vector3f.cache();
    }
    ...
    static final void method16136(Component class226, Interface class221, ScriptExecutionContext class613, int i) {
    ...
    static final void method3287(ScriptExecutionContext class613) throws ScriptException {
        ...
        Client.camera.method4915(Vector3f.create(f, f_66_, f_67_), f_68_);
    }
    ...
    static final void method3291(ScriptExecutionContext class613, int i) {
        ...
        Component class226 = Component.lookup(i_72_);
        Interface class221 = Class598.loadedInterfaces[i_72_ >> 16];
        Component.method7527(class226, class221, false, 2, class613);
    }
    ...
    static final void method3292(ScriptExecutionContext class613, byte i) {
        ...
        Component class226 = Component.lookup(i_73_);
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = class226.hidden ? 1 : 0;
    }
    ...
    static final void method9587(ScriptExecutionContext class613, byte i) {
        ...
        int i_0_ = class613.anIntArray7942[1841827045 * class613.anInt7924];
        int i_1_ = class613.anIntArray7942[1 + 1841827045 * class613.anInt7924];
        Mobile.method18041(i_0_, i_1_ >> 14 & 0x3fff, i_1_ & 0x3fff, true);
    }
    ...
    static final void method17755(ScriptExecutionContext class613) {
        ...
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = ItemTable.getItemIdAt(i_0_,
                i_1_, false);
    }
    ...
    static final void method15581(ScriptExecutionContext class613) {
        int i_8_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Component class226 = Component.lookup(i_8_);
        class226.name = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
    }
    ...
    static final void method7392(ScriptExecutionContext class613) throws ScriptException {
        int i_4_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Client.camera.method4889(Class157.method3301(i_4_), true);
    ...
    static final void method7372(ScriptExecutionContext class613, int i) {
        ...
        if (class33.isString()) {
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = Animation.loader
                    .get(i_3_).getParameter(i_4_, class33.defaultString);
        } else {
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = Animation.loader
    ...
    public static void method6308(Class520 class520, int i, int i_0_, SceneObject interface55, int i_1_) {
        ...
        executeOnMobile(class520, i, i_0_, class613);
    ...
    static final void method6312(ScriptExecutionContext class613, byte i) {
        int i_3_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Component class226 = Component.lookup(i_3_);
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = -370763243 * class226.textureId;
    }

    static final void method6319(Component class226, Interface class221, ScriptExecutionContext class613, int i) {
        boolean bool = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045] == 1;
        ...
        if (-592186295 * class226.index == -1 && !class221.closed) {
            PulseEvent.method9353(1857819631 * class226.uid);
        }
    }
    ...
    static final void method8778(ScriptExecutionContext class613) {
        ...
        Component class226 = Component.lookup(i_14_);
        Interface class221 = Class598.loadedInterfaces[i_14_ >> 16];
        CutsceneMobile.method3384(class226, class221, class613, 65535);
    }

    static final void method8777(ScriptExecutionContext class613, byte i) {
        int i_13_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Component class226 = Component.lookup(i_13_);
        Interface class221 = Class598.loadedInterfaces[i_13_ >> 16];
        SceneGraph.method8470(class226, class221, class613, 1240505385);
    }
    ...
    static final void method1032(ScriptExecutionContext class613) {
        Class611 class611 = class613.aBool7932 ? class613.aClass611_7945 : class613.aClass611_7931;
        Component class226 = class611.aClass226_7914;
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = class226.itemId * 1391525437;
    }

    static final void method7272(ScriptExecutionContext class613, byte i) {
        int i_0_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = ((Class182) ItemDefinition.aMappingVarpProvider_8339
    ...
    static final void method1092(ScriptExecutionContext class613, byte i) {
        ...
        if (-1 == -592186295 * class226.index && !class221.closed) {
            Class380.method6235(1857819631 * class226.uid);
        }
    }
    ...
    static final void method9293(Component class226, ScriptExecutionContext class613) {
        int i_94_ = 10;
        ...
        PlayerDefaults.method9579(class226, i_94_, i_95_, i_96_, class613);
    }
    ...
    static final void method9292(ScriptExecutionContext class613, int i) {
        ...
        Component class226 = Component.lookup(i_93_);
    ...
    public static void method3463(Class520 class520, int i, int i_0_, Class606 class606,
                                  ItemPile class600_sub1_sub1_sub1, int i_1_) {
        ScriptExecutionContext class613 = method9584();
    ...
    static final void method5847(Component class226, Interface class221, ScriptExecutionContext class613, int i) {
        int id = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        ParameterDefinition definition = ParameterDefinition.loader.get(id);
        if (!definition.defaultString.equals(string)) {
            class226.putString(id, string);
        } else {
    ...
    static final void method5851(ScriptExecutionContext class613, byte i) {
        ...
        if (i_9_ < 0) {
            ...
            i_9_ = Client.scene.getMapLength();
        }
    ...
    static final void method3368(ScriptExecutionContext class613) throws ScriptException {
        ...
        Client.camera.method4820(Vector3f.create(f, f_1_, f_2_), f_3_);
    }
    ...
    static final void method3458(ScriptExecutionContext class613) throws ScriptException {
        ...
        Vector3f vector3f = Vector3f.create(i_7_, i_7_, i_7_);
        Client.camera.method4818(vector3f);
        vector3f.cache();
    }
    ...
    static final void method3461(ScriptExecutionContext class613) {
        ...
        Component class226 = class611.aClass226_7914;
        Interface class221 = class611.aClass221_7913;
        Component.method7527(class226, class221, false, 1, class613);
    }
    ...
    static final void method3460(ScriptExecutionContext class613) {
        ...
        Component.lookup(i_8_);
        Component.method14089(Class598.loadedInterfaces[i_8_ >>> 16], i_8_ & 0xffff, i_9_, i_10_,
    ...
    static final void method3528(ScriptExecutionContext class613) {
        int i_18_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Component class226 = Component.lookup(i_18_);
    ...
    static final void method5133(ScriptExecutionContext class613) {
        ...
        Component class226 = Component.lookup(i_97_);
    ...
    static final void method5134(ScriptExecutionContext class613, int i) {
        ...
        if (class226.components2 == null) {
            ...
            int i_98_ = class226.components2.length;
            for (int i_99_ = 0; i_99_ < class226.components2.length; i_99_++) {
                if (null == class226.components2[i_99_]) {
                    i_98_ = i_99_;
                    break;
                }
            }
    ...
    static final void method5137(Component class226, Interface class221, ScriptExecutionContext class613, int i) {
        class226.aBool2461 = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045] == 1;
        Component.redraw(class226);
        if (-1 == class226.index * -592186295 && !class221.closed) {
            CursorDefinitionLoader.method16798(class226.uid * 1857819631, (byte) 1);
        }
    }

    static final void method6280(ScriptExecutionContext class613, Mobile mobile) {
        class613.anInt7924 -= -731138437;
        int i_0_ = class613.anIntArray7942[class613.anInt7924 * 1841827045];
        int i_1_ = class613.anIntArray7942[class613.anInt7924 * 1841827045 + 1];
        int i_2_ = class613.anIntArray7942[2 + 1841827045 * class613.anInt7924];
        ...
        Quaternion quaternion_6_ = new Quaternion();
        quaternion.setByAngle(0.0F, 1.0F, 0.0F, (float) (2.0 * (Math.PI * i_4_) / 16384.0));
        Vector3f vector3f = new Vector3f(1.0F, 0.0F, 0.0F);
        vector3f.invertAndMultiply(quaternion);
        vector3f.invert();
        quaternion_6_.setByAngle(vector3f, (float) (i_3_ * Math.PI * 2.0 / 16384.0));
    ...
    static final void method6284(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2516 = World.method16248(string, class613);
        class226.aBool2483 = true;
    }
    ...
    static final void method6712(ScriptExecutionContext class613) {
        ...
        CameraEvent cameraEvent = Client.camera.method4828(i_0_);
        if (null == cameraEvent) {
            throw new RuntimeException("");
        } else if (!(cameraEvent instanceof Class480_Sub31_Sub19_Sub1)) {
            throw new RuntimeException("");
        }

        ((Class480_Sub31_Sub19_Sub1) cameraEvent).method18161(f);
    }
    ...
    static final void method6992(ScriptExecutionContext class613) {
        int i_4_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = Client.grandExchangeOffers[i_4_].transferred
                * -333623323;
    }
    ...
    static final void method6994(ScriptExecutionContext class613, int i) {
        ...
        EntityAnimator.method16709(class226, i_1_, is, is_5_, class613, 39585591);
    }

    public static void method6991(Class520 class520, int i, int i_2_) {
        ScriptExecutionContext context = method9584();
        executeOnMobile(class520, i, i_2_, context);
    }
    ...
    static final void method8238(ScriptExecutionContext class613) {
        ...
        ChatMessage chatMessage = ChatMessage.method3150(i_1_);
        if (chatMessage != null) {
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = -1129723623
                    * chatMessage.type;
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = chatMessage.cycle * 1645966401;
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = chatMessage.anInt11376
                    * -1639949421;
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = chatMessage.source != null ? chatMessage.source
                    : "";
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = chatMessage.aString11378 != null ? chatMessage.aString11378
                    : "";
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = null != chatMessage.aString11379 ? chatMessage.aString11379
                    : "";
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = null != chatMessage.content ? chatMessage.content
                    : "";
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = chatMessage.anInt11381 * 78704391;
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = null != chatMessage.aString11383 ? chatMessage.aString11383
                    : "";
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = chatMessage.icon != null ? chatMessage.icon
                    .getId() : -1;
        } else {
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = -1;
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = 0;
    ...
    static final void method7190(ScriptExecutionContext class613) {
        int i_0_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Component class226 = Component.lookup(i_0_);
        class226.toolTip = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
    }
    ...
    static final void method9169(ScriptExecutionContext context) {
        ...
        PlayerDefaults.method9579(component, i_9_, i_10_, i_11_, context);
    }

    static void method8819(ScriptExecutionContext class613) {
        class613.anIntArray7942[class613.anInt7924 * 1841827045 - 1] = QuestDefinition.loader
                .get(class613.anIntArray7942[class613.anInt7924 * 1841827045 - 1]).type * -2088404763;
    }
    ...
    static final void method4764(ScriptExecutionContext class613, int i) {
        ...
        Vector3f vector3f = ((Class281_Sub2) Client.camera.method4876()).method15243((byte) -60);
        Vector3f vector3f_3_ = ((Class642_Sub3) Client.camera.method4834()).method16720(1778457837);
        Vector3f vector3f_4_ = Vector3f.copyOf(vector3f);
        vector3f_4_.subtract(vector3f_3_);
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = (int) vector3f_4_.distance();
    }
    ...
    static final void method5282(ScriptExecutionContext class613, byte i) {
        ...
        boolean bool = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045] == 1;
        Client.login(string, string_5_, string_6_, bool, 961581289);
    }
    ...
    static final void method5283(ScriptExecutionContext class613) {
        ...
        int i_8_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        i_8_--;
        if (null == class226.actions || i_8_ >= class226.actions.length
                || class226.actions[i_8_] == null) {
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = "";
        } else {
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = class226.actions[i_8_];
        }
    }

    static final void method5286(ScriptExecutionContext class613) {
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = Client.camera
                .method4836() == null ? -1 : Client.camera.method4836().anInt2854 * -2084034471;
    }

    static final void method16020(ScriptExecutionContext class613) {
        if (!Client.camera.method4836().method4757()) {
            throw new RuntimeException();
        }
        Class642_Sub5 class642_sub5 = (Class642_Sub5) Client.camera.method4834();
    ...
    static final void method13518(ScriptExecutionContext class613, int i) throws ScriptException {
        ...
        Client.camera.method4825(i_26_, f, (byte) 114);
    }
    ...
    static final void method15080(ScriptExecutionContext class613) {
        ...
        Component class226 = Component.lookup(i_35_);
    ...
    static final void method3552(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        int[] is = method9239(string, class613);
        if (null != is) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2504 = World.method16248(string, class613);
    ...
    static final void method5834(ScriptExecutionContext class613) {
        int i_3_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = 4094849 * Client.grandExchangeOffers[i_3_].price;
    }

    static final void method5833(ScriptExecutionContext class613) {
        Class611 class611 = class613.aBool7932 ? class613.aClass611_7945 : class613.aClass611_7931;
        Component component = class611.aClass226_7914;
        int id = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        ParameterDefinition parameter = ParameterDefinition.loader.get(id);

        if (parameter.isString()) {
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = component.getStringOrDefault(id,
                    parameter.defaultString);
        } else {
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = component.getIntOrDefault(id,
                    -125275839 * parameter.defaultInt);
        }
    }
    ...
    static final void method546(ScriptExecutionContext class613) {
        ...
        Vector3f vector3f = ((Class281_Sub2) Client.camera.method4876()).method15243((byte) 3);
        Vector3f vector3f_2_ = ((Class642_Sub3) Client.camera.method4834()).method16720(2057132453);
        Vector3f vector3f_3_ = Vector3f.copyOf(vector3f);
        vector3f_3_.subtract(vector3f_2_);
        float f = Class465.method7879(vector3f_3_.x, vector3f_3_.z, 1914134880);
    ...
    static void method547(ScriptExecutionContext class613) {
        class613.anIntArray7942[1841827045 * class613.anInt7924 - 2] = QuestDefinition.loader
                .get(class613.anIntArray7942[1841827045 * class613.anInt7924 - 2]).skillRequirements[class613.anIntArray7942[class613.anInt7924 * 1841827045 - 1]][1];
        class613.anInt7924 -= 1122685165;
    }
    ...
    static final void method5439(ScriptExecutionContext class613, byte i) {
        int i_4_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Component class226 = Component.lookup(i_4_);
        Interface class221 = Class598.loadedInterfaces[i_4_ >> 16];
        Component.method7527(class226, class221, false, 0, class613);
    }
    ...
    static void method5396(ScriptExecutionContext class613) {
        class613.anIntArray7942[1841827045 * class613.anInt7924 - 2] = QuestDefinition.loader.get(
                ...
                PlayerFacade.instance, class613.anIntArray7942[class613.anInt7924 * 1841827045 - 1]) ? 1 : 0;
        class613.anInt7924 -= 1122685165;
    }

    static final void method5394(Component class226, ScriptExecutionContext class613) {
    ...
    static final void method5221(ScriptExecutionContext class613, byte i) {
        ...
        Component class226 = class611.aClass226_7914;
        Interface class221 = class611.aClass221_7913;
        Component class226_1_ = Class339.method5850(class221, class226, 1060483645);
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = null == class226_1_ ? -1
                : class226_1_.uid * 1857819631;
    }
    ...
    static final void method5222(ScriptExecutionContext class613, int i) {
        ...
        ((Class642_Sub1) Client.camera.method4834()).method16687(
    ...
    static final void method5155(ScriptExecutionContext class613, int i) {
        ...
        if (Class495_Sub1.aClass667_10318 != null) {
            Node class480 = Class495_Sub1.aClass667_10318.get(i_2_);
    ...
    static final void method5149(ScriptExecutionContext class613) {
        ...
        Component class226 = Component.lookup(i_10_);
    ...
    static final void method5150(ScriptExecutionContext class613) {
        Class611 class611 = class613.aBool7932 ? class613.aClass611_7945 : class613.aClass611_7931;
        Component class226 = class611.aClass226_7914;
        if (1391525437 * class226.itemId != -1) {
    ...
    static final void method5045(Component class226, ScriptExecutionContext class613, int i) {
        int i_5_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        int i_6_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045] - 1;
        int i_7_ = i_6_;
        if (class226.modelType * 286135323 != 6 && 2 != 286135323 * class226.modelType) {
            throw new RuntimeException("");
        }
        NpcDefinition npcDefinition = NpcDefinition.loader.get(class226.modelId * -643054127);
        if (null == class226.aClass267_2361) {
            class226.aClass267_2361 = new Class267(npcDefinition, 6 == class226.modelType * 286135323);
        }
        class226.aClass267_2361.aLong2977 = Class36.method992() * 359135170314717883L;
    ...
    static final void method5041(ScriptExecutionContext class613, byte i) {
        ...
        ((Class642_Sub1) Client.camera.method4834()).method16688(
    ...
    static final void method5003(ScriptExecutionContext class613, short i) {
        ...
        int i_3_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        i_3_--;
        if (class226.actions == null || i_3_ >= class226.actions.length
                || class226.actions[i_3_] == null) {
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = "";
        } else {
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = class226.actions[i_3_];
        }
    }
    ...
    static final void method4993(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2553 = World.method16248(string, class613);
        class226.aBool2483 = true;
    }
    ...
    static final void method4995(ScriptExecutionContext class613) {
        ...
        Component class226 = class611.aClass226_7914;
        Interface class221 = class611.aClass221_7913;
        PlayerMapDot.method3872(class226, class221, class613);
    }

    static final void method4996(ScriptExecutionContext class613) {
        Npc npc = (Npc) class613.targetMobile;
        boolean bool = false;
    ...
    static final void method4770(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2526 = World.method16248(string, class613);
        class226.aBool2483 = true;
    }

    static final void method4745(ScriptExecutionContext class613) {
        World class562_sub1 = Class287.method5302();
        if (null != class562_sub1) {
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = class562_sub1.anInt10370
                    * -1741841871;
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = class562_sub1.mask
                    * -1833179177;
            ...
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = class562_sub1
                    .method16236();
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = class562_sub1.population
                    * -1320445881;
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = 1668853513 * class562_sub1.index;
    ...
    static final void method14027(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.mouseEnterListeners = World.method16248(string, class613);
        class226.aBool2483 = true;
    }
    ...
    static final void method3183(ScriptExecutionContext class613) {
        ...
        Component class226 = class611.aClass226_7914;
        Interface class221 = class611.aClass221_7913;
        SceneGraph.method8471(class226, class221, class613, -2124781903);
    }
    ...
    static final void method687(ScriptExecutionContext class613) {
        if (SceneGraphTile.aClass655_6685 == null) {
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = -1;
        } else {
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = SceneGraphTile.aClass655_6685.anInt8247
                    * -1219686185;
        }
    }
    ...
    static final void method3838(Component class226, Interface class221, ScriptExecutionContext class613,
                                 Class227 class227) {
        int i_24_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        switch (class227.anInt2565 * 687529979) {
            case 0:
                class226.aString2530 = ItemDefinition.aMappingVarpProvider_8339.method3806(i_24_).method3930();
                break;
            case 1:
            ...
            case 2:
            case 4:
                class226.aString2530 = class613.aClass480_Sub33_7935.aClass283Array10233[i_24_].name;
                break;
            case 5:
            ...
            case 3:
                class226.aString2530 = ((Class182) ItemDefinition.aMappingVarpProvider_8339.method3765().get(i_24_)).method3562();
        }
    ...
    static final void method522(ScriptExecutionContext class613) {
        ...
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = ItemTable
                .getTotalItemQuantity(i_3_, i_4_, true);
    }
    ...
    static final void method3969(ScriptExecutionContext class613) {
        ...
        if (class675.valueType.getId() != KeyType.S_LOWER.getId()) {
            throw new RuntimeException();
        }
    ...
    static final void method4008(ScriptExecutionContext class613) throws ScriptException {
        class613.anInt7924 -= -926911801;
        Client.camera.method4815(class613.anIntArray7942[1841827045 * class613.anInt7924],
    ...
    static final void method4038(ScriptExecutionContext class613) {
        ...
        int i_0_ = class613.anIntArray7942[1841827045 * class613.anInt7924];
        int i_1_ = class613.anIntArray7942[1841827045 * class613.anInt7924 + 1];
        InterfaceNode.method4800(i_0_, new InterfaceNode(i_1_, 3), null, true);
    }
    ...
    static final void method4222(ScriptExecutionContext class613) {
        ...
        Component class226 = Component.lookup(i_27_);
    ...
    static final void method4327(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        int[] is = method9239(string, class613);
        if (is != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2496 = World.method16248(string, class613);
        class226.configListeners = is;
        class226.aBool2483 = true;
    }
    ...
    static final void method753(Component class226, Interface class221, ScriptExecutionContext class613) {
    ...
    static final void method4358(ScriptExecutionContext class613) {
        String string = "";
        if (null != PlayerMapDot.aClipboard2096) {
            Transferable transferable = PlayerMapDot.aClipboard2096.getContents(null);
    ...
    static final void method4359(Component class226, Interface class221, ScriptExecutionContext class613) {
        class226.modelType = 1731739231;
        class226.modelId = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045] * 1265546033;
        if (-592186295 * class226.index == -1 && !class221.closed) {
            PulseEvent.method7175(1857819631 * class226.uid);
        }
    ...
    static final void method4642(ScriptExecutionContext class613) {
        ...
        if (null != class480_sub31_sub18) {
            ...
            if (bool) {
                Animator.method13519(Class626.anIntArray8037[1], Class626.anIntArray8037[2]);
            }
        }
    }
    ...
    static final void method15273(ScriptExecutionContext class613) {
        ...
        Component class226 = class611.aClass226_7914;
        Interface class221 = class611.aClass221_7913;
        PlayerDefaults.method9578(class226, class221, class613);
    }
    ...
    static final void method5265(ScriptExecutionContext class613) throws ScriptException {
        ...
        int i_0_ = class613.anIntArray7942[1841827045 * class613.anInt7924];
        int i_1_ = class613.anIntArray7942[1 + class613.anInt7924 * 1841827045];
        Vector3f vector3f = Vector3f.create(i_0_, i_0_, i_0_);
        if (vector3f.x == -1.0F) {
            vector3f.x = Float.POSITIVE_INFINITY;
        }
        if (vector3f.y == -1.0F) {
        ...
        Client.camera.method4871(vector3f);
        Client.camera.method4833(i_1_ / 1000.0F);
        vector3f.cache();
    }
    ...
    static final void method7087(ScriptExecutionContext class613) {
        ...
        Component class226 = Component.lookup(i_2_);
        Interface class221 = Class598.loadedInterfaces[i_2_ >> 16];
        SceneFormat.method7542(class226, class221, class613);
    }

    static final void method7276(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.mouseLeaveListeners = World.method16248(string, class613);
        class226.aBool2483 = true;
    }
    ...
    static void method7353(ScriptExecutionContext class613) {
        class613.anIntArray7942[1841827045 * class613.anInt7924 - 2] = QuestDefinition.loader.get(
                ...
                PlayerFacade.instance, class613.anIntArray7942[1841827045 * class613.anInt7924 - 1]) ? 1 : 0;
        class613.anInt7924 -= 1122685165;
    }
    ...
    static final void method7352(ScriptExecutionContext class613) {
        ...
        Component component = Component.lookup(id);
        Class62.method1384(component, i_0_, i_1_);
    }
    ...
    static final void method1069(Component class226, Interface class221, ScriptExecutionContext class613) {
        class226.shadowColor = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045] * 1380050589;
        Component.redraw(class226);
    }
    ...
    static final void method3983(Component class226, Interface class221, ScriptExecutionContext class613) {
        class613.anInt7924 -= -926911801;
        int i_2_ = class613.anIntArray7942[1841827045 * class613.anInt7924];
        ...
        if (i_2_ >= 0 && i_2_ < 5) {
            ...
            Component.redraw(class226);
            if (-1 == -592186295 * class226.index && !class221.closed) {
                PulseEvent.method15134(1857819631 * class226.uid, i_2_);
            }
        }
    }
    ...
    static final void method2333(ScriptExecutionContext class613) {
        ...
        Component class226 = Component.lookup(i_131_);
    ...
    static final void method2335(ScriptExecutionContext class613) {
        ...
        Animator.method13519(i_133_ >> 14 & 0x3fff, i_133_ & 0x3fff);
    }
    ...
    static final void method14253(ScriptExecutionContext class613) {
        ...
        if (LoadingRequirementType.method594(class480_sub31_sub17, -30585040) == 4) {
            ObjectNode class480_sub25 = Client.npcTable.get(class480_sub31_sub17.getPrimary());
            if (class480_sub25 != null) {
                class613.targetMobile = (Mobile) class480_sub25.referent;
                class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = 1;
                return;
            }
        }
    ...
    static final void method1573(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2518 = World.method16248(string, class613);
        class226.aBool2483 = true;
    }
    ...
    static final void method1146(Component class226, Interface class221, ScriptExecutionContext class613) {
        int i_0_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        class226.itemId = 702084843;
        if (-370763243 * class226.textureId != i_0_) {
            class226.textureId = i_0_ * -470325955;
            Component.redraw(class226);
        }

        if (-592186295 * class226.index == -1 && !class221.closed) {
            PulseEvent.method2856(1857819631 * class226.uid);
        }
    }
    ...
    static final void method16382(ScriptExecutionContext script) {
        ...
        if (KeyType.S_LOWER != definition.valueType) {
            throw new RuntimeException();
        }
    ...
    static final void method2233(Component class226, ScriptExecutionContext class613) {
        ...
        int i_77_ = i_76_;
        if (286135323 * class226.modelType != 6 && 2 != class226.modelType * 286135323) {
            throw new RuntimeException("");
        }
        NpcDefinition npcDefinition = NpcDefinition.loader.get(-643054127 * class226.modelId);
        if (class226.aClass267_2361 == null) {
            class226.aClass267_2361 = new Class267(npcDefinition, 286135323 * class226.modelType == 6);
        }
        class226.aClass267_2361.aLong2977 = Class36.method992() * 359135170314717883L;
    ...
    static final void method10042(ScriptExecutionContext class613) {
        int i_0_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Component class226 = Component.lookup(i_0_);
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = 923665021 * class226.textColor;
    }

    static final void method10046(ScriptExecutionContext class613) {
        int i_3_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (8 != Client.connectionState * -1501875989 || Class628.method13100()) {
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = 0;
        } else {
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = Class606.setWorld(i_3_,
                    string) ? 1 : 0;
        }
    }
    ...
    static final void method15313(ScriptExecutionContext class613) {
        ...
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = ItemTable.getItemIdAt(i_21_,
                i_22_, true);
    }

    static final void method15352(Component class226, Interface class221, ScriptExecutionContext class613) {
        class613.anInt7924 -= -926911801;
    ...
    static final void method15351(ScriptExecutionContext class613) {
        int i_9_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Component class226 = Component.lookup(i_9_);
    ...
    static final void method5300(ScriptExecutionContext class613) throws ScriptException {
        int i_5_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
        Client.camera.method4903(Class626.method13054(i_5_), true);
        Client.aBool10611 = true;
    }
    ...
    static final void method8739(ScriptExecutionContext class613) {
        ...
        Component class226 = Component.lookup(i_9_);
        Interface class221 = Class598.loadedInterfaces[i_9_ >> 16];
        Component.method7527(class226, class221, true, 1, class613);
    }

    static final void method1138(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2515 = World.method16248(string, class613);
        class226.aBool2483 = true;
    }
    ...
    static final void method1159(Component class226, Interface class221, ScriptExecutionContext class613) {
        class613.anInt7924 -= 195773364;
    ...
    static final void method9024(ScriptExecutionContext class613) {
        Class368.method6102(class613.targetMobile,
    ...
    static final void method1537(Component class226, ScriptExecutionContext class613) {
        int i_1_ = 10;
        int i_2_ = class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045];
    ...
    static final void method13220(Component class226, Interface class221, ScriptExecutionContext class613) {
        class226.modelType = -1537936839;
        class226.modelId = -1872598017 * Client.localPlayerIndex;
        class226.anInt2420 = 0;
        if (class226.index * -592186295 == -1 && !class221.closed) {
            PulseEvent.method7175(1857819631 * class226.uid);
        }
    }
    ...
    static final void method9925(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.anObjectArray2366 = World.method16248(string, class613);
        class226.aBool2483 = true;
    }
    ...
    static final void method10249(ScriptExecutionContext class613) {
        ...
        ((Class642_Sub1) Client.camera.method4834()).method16703(
                class613.anIntArray7942[(class613.anInt7924 -= 1122685165) * 1841827045]);
    }
    ...
    static final void method9890(ScriptExecutionContext class613) throws ScriptException {
        ...
        Vector3f vector3f = Vector3f.create(i_2_, i_3_, i_4_);
        Client.camera.method4802(vector3f);
        vector3f.cache();
    }

    static final void method9887(ScriptExecutionContext class613) {
        if (18 == Client.connectionState * -1501875989) {
    ...
    static final void method16371(ScriptExecutionContext class613, int i) {
        ...
        int i_3_ = class613.anIntArray7942[class613.anInt7924 * 1841827045];
        int i_4_ = class613.anIntArray7942[class613.anInt7924 * 1841827045 + 1];
        ChatMessage chatMessage = BefriendedPlayer.method1101(i_3_, i_4_);
        if (chatMessage != null) {
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = chatMessage.anInt11382
                    * -482365547;
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = chatMessage.cycle * 1645966401;
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = chatMessage.anInt11376
                    * -1639949421;
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = null != chatMessage.source ? chatMessage.source
                    : "";
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = chatMessage.aString11378 != null ? chatMessage.aString11378
                    : "";
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = chatMessage.aString11379 != null ? chatMessage.aString11379
                    : "";
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = chatMessage.content != null ? chatMessage.content
                    : "";
            class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = chatMessage.anInt11381 * 78704391;
            class613.anObjectArray7918[(class613.anInt7929 += -1356601931) * 211787933 - 1] = null != chatMessage.aString11383 ? chatMessage.aString11383
                    : "";
    ...
    static final void method4600(Component class226, Interface class221, ScriptExecutionContext class613) {
        String string = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
        if (method9239(string, class613) != null) {
            string = string.substring(0, string.length() - 1);
        }
        class226.hoverListeners = World.method16248(string, class613);
        class226.aBool2483 = true;
    }
    ...
    static final void method9166(ScriptExecutionContext class613, byte i) {
        ...
        int i_6_ = class613.anIntArray7942[1841827045 * class613.anInt7924];
        int i_7_ = class613.anIntArray7942[class613.anInt7924 * 1841827045 + 1];
        class613.anIntArray7942[(class613.anInt7924 += 1122685165) * 1841827045 - 1] = ItemTable.getTotalItemQuantity(i_6_, i_7_,
                false, -1497011580);
    }
