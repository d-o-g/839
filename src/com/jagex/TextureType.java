...
public class TextureType {
    ...
    public static TextureType TEXTURE = new TextureType(0);
    public static TextureType TEXTURE_AND_MATERIAL = new TextureType(1);
    public static TextureType MATERIAL = new TextureType(4);
