...
public class Class180 implements VarpInstrution {
    ...
    public void execute(MappingVarpProvider mappingVarpProvider) {
        mappingVarpProvider.method3783(anInt1998 * -809848097, aBool1999, -561914517);
        mappingVarpProvider.method3806(-809848097 * anInt1998).method3888();
    }
