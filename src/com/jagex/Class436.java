...
public class Class436 {
    ...
    int[] anIntArray5006;
    int[] anIntArray5007;
    Class436(SceneGraph sceneGraph, int i, int width, int length, boolean bool, OverlayDefinitionLoader overlayLoader,
    ...
    static boolean method7269() {
        if (null == Class56.topMenuItem) {
            return false;
        }
        if (Class56.topMenuItem.opcode * -20536735 >= 2000) {
            Class56.topMenuItem.opcode -= -1044071984;
        }
        return 1007 == Class56.topMenuItem.opcode * -20536735;
    }
    ...
    public final void method7201(Toolkit class134, SceneGraphLevel class120, SceneGraphLevel class120_50_, int i) {
        ...
        for (int i_51_ = 0; i_51_ < -710177039 * anInt4969; i_51_++) {
                ...
                if (i_53_ >= 0) {
                    ...
                    for (int i_64_ = -5; i_64_ < length * -1252946243; i_64_++) {
                        ...
                        if (i_64_ >= 0 && i_62_ > 0 && i_63_ > 0) {
                            is[i_53_][i_64_] = SceneGraphLevel.method6964(256 * i_59_ / i_62_, i_60_ / i_63_, i_61_
                                    / i_63_);
                        }
                    }
                }
            ...
            if (blending) {
                method7203(class134, sceneGraph.levels1[i_51_], i_51_, is, i_51_ == 0 ? class120 : null,
                        0 == i_51_ ? class120_50_ : null, 1177021808);
            } else {
                method7238(class134, sceneGraph.levels1[i_51_], i_51_, is, i_51_ == 0 ? class120 : null,
        ...
        if (!underwater) {
            if (0 != 2146140159 * sceneryShadows) {
                sceneGraph.method8406(1143175765);
            }
            if (lighting) {
                sceneGraph.method8367(-1547714459);
            }
        }
        for (int i_67_ = 0; i_67_ < -710177039 * anInt4969; i_67_++) {
            sceneGraph.levels1[i_67_].finish();
        }
    }
    ...
    public void method7260(Toolkit toolkit, int[][][] is) {
        for (int plane = 0; plane < anInt4969 * -710177039; plane++) {
            ...
            sceneGraph.method8320(plane, toolkit.createGround(1626386547 * width, length * -1252946243,
                    tileHeights[plane], is_328_, 512, flag1, flag2));
        }
    }
    ...
    final void method7198(Buffer buffer, int plane, int i_38_, int i_39_, int i_40_, int i_41_, int i_42_, int i_43_,
        ...
        if (i_38_ >= 0 && i_38_ < width * 1626386547 && i_39_ >= 0 && i_39_ < -1252946243 * length) {
            ...
            if (0 != (i_46_ & 0x8)) {
                ...
                tileHeights[0][i_38_ + i_40_][i_39_ + i_41_] = -SceneGraphLevel.calculateTileHeight(932731 + i_42_,
                        556238 + i_43_) * 8 << 2;
            } else {
    ...
    void method7203(Toolkit class134, SceneGraphLevel class120, int i, int[][] is, SceneGraphLevel class120_68_, SceneGraphLevel class120_69_,
                    int i_70_) {
        ...
        for (int i_75_ = 0; i_75_ < width * 1626386547; i_75_++) {
            ...
            for (int i_77_ = 0; i_77_ < length * -1252946243; i_77_++) {
                ...
                if (0 != i_79_ || i_80_ != 0) {
                    ...
                    if (i_86_ <= 0) {
                        sceneGraph.method8340(i, i_75_, i_77_);
                    } else {
                        if (bools[0]) {
                            i_86_++;
                        }
                        ...
                        if (underwater) {
                            class150.colour = sceneGraph.getColor(i_75_, i_77_) * 791213269;
                            class150.scale = sceneGraph.getScale(i_75_, i_77_) * 1591951847;
                            class150.intensity = sceneGraph.getIntensity(i_75_, i_77_) * 1370254837;
                            class150.anInt1848 = sceneGraph.getConfig4(i_75_, i_77_) * 471935851;
                            class150.anInt1847 = sceneGraph.getConfig2(i_75_, i_77_) * -2072444281;
                            class150.anInt1846 = sceneGraph.getConfig3(i_75_, i_77_) * -1720335367;
                        }
    ...
    void method7207(Toolkit class134, int i, int i_118_, int i_119_, OverlayDefinition class590, boolean[] bools,
                    ...
                    int[] is_126_, SceneGraphLevel class120, SceneGraphLevel class120_127_, SceneGraphLevel class120_128_, byte i_129_) {
        anInt4998 = -815072249;
        ...
        if (null != class590) {
            ...
            for (int i_131_ = 0; i_131_ < 1887065007 * overlayFaces; i_131_++) {
                ...
                for (int i_133_ = 0; i_133_ < i_132_; i_133_++) {
                    ...
                    if (null != is_125_ && aBoolArrayArray4970[-1139259047 * anInt4992][i_134_]) {
                        ...
                        is_125_[anInt4995 * 1110560025] = class120_127_.averageHeightAt(i_140_, i_141_)
                                - class120.averageHeightAt(i_140_, i_141_);
                    }
                    if (is_126_ != null) {
                        if (null != class120_127_ && !aBoolArrayArray4970[-1139259047 * anInt4992][i_134_]) {
                            ...
                            is_126_[anInt4995 * 1110560025] = class120.averageHeightAt(i_142_, i_143_)
                                    - class120_127_.averageHeightAt(i_142_, i_143_);
                            ...
                            is_126_[anInt4995 * 1110560025] = class120_128_.averageHeightAt(i_144_, i_145_)
                                    - class120.averageHeightAt(i_144_, i_145_);
                        }
                    }
            ...
            if (!underwater && 0 == i) {
                sceneGraph.method8333(i_118_, i_119_, class590.waterColour * -2077371167,
    ...
    void method7208(Toolkit class134, int i, int i_146_, int i_147_, int i_148_, int i_149_,
                    ...
                    int[][] is_161_, SceneGraphLevel class120, SceneGraphLevel class120_162_, SceneGraphLevel class120_163_, byte i_164_) {
        if (class646 != null) {
            if (0 == i_151_) {
                i_151_ = i_150_;
            }
            ...
            for (int i_169_ = 0; i_169_ < underlayFaces * -1398807289; i_169_++) {
                ...
                for (int i_171_ = 0; i_171_ < i_170_; i_171_++) {
                    ...
                    if (is_159_ != null && aBoolArrayArray4970[-1139259047 * anInt4992][i_172_]) {
                        ...
                        is_159_[1110560025 * anInt4995] = class120_162_.averageHeightAt(i_178_, i_179_)
                                - class120.averageHeightAt(i_178_, i_179_);
                    }
                    if (is_160_ != null) {
                        if (class120_162_ != null && !aBoolArrayArray4970[anInt4992 * -1139259047][i_172_]) {
                            ...
                            is_160_[anInt4995 * 1110560025] = class120.averageHeightAt(i_180_, i_181_)
                                    - class120_162_.averageHeightAt(i_180_, i_181_);
                            ...
                            is_160_[1110560025 * anInt4995] = class120_163_.averageHeightAt(i_182_, i_183_)
                                    - class120.averageHeightAt(i_182_, i_183_);
                        }
                    }
                    if (i_172_ < 8 && anIntArray4990[i_173_] >= 0) {
                        ...
                        if (aBool4981 && aBoolArrayArray4970[anInt4992 * -1139259047][i_172_]) {
                            ...
                            int i_184_ = CombatGauge.method15582(is_161_[i_146_][i_147_], is_161_[i_148_][i_147_],
                                    i_176_ << 7 >> 9, (byte) 80);
                            int i_185_ = CombatGauge.method15582(is_161_[i_146_][i_149_], is_161_[i_148_][i_149_],
                                    i_176_ << 7 >> 9, (byte) 22);
                            is_156_[anInt4995 * 1110560025] = CombatGauge.method15582(i_184_, i_185_,
                                    i_177_ << 7 >> 9, (byte) 95);
                        }
                        if (null != is) {
    ...
    void method7209(SceneGraphLevel ground, UnderlayDefinition underlay, OverlayDefinition overlay, int plane, int i_186_,
    ...
    int method7222(int i, int i_260_, int i_261_, int i_262_, int i_263_, SceneGraphLevel class120, short[][] is, byte i_264_) {
    ...
    void method7238(Toolkit toolkit, SceneGraphLevel class120, int plane, int[][] defaultColours, SceneGraphLevel class120_273_,
                    SceneGraphLevel class120_274_) {
                ...
                if (null != overlay || underlay != null) {
                    ...
                    if (null != overlay) {
                        ...
                        if (!underwater && plane == 0) {
                            sceneGraph.method8333(x, z, -2077371167 * overlay.waterColour,
                    ...
                    for (int i_300_ = 0; i_300_ < i_295_; i_300_++) {
                        ...
                        if (is_298_ != null && aBoolArrayArray4970[type][i_300_]) {
                            ...
                            is_298_[i_300_] = class120_274_.averageHeightAt(i_305_, i_306_)
                                    - class120.averageHeightAt(i_305_, i_306_);
                        }
                        if (is_299_ != null) {
                            if (class120_274_ != null && !aBoolArrayArray4970[type][i_300_]) {
                                int i_307_ = (x << 9) + is_296_[i_300_];
                                int i_308_ = (z << 9) + is_297_[i_300_];
                                is_299_[i_300_] = class120.averageHeightAt(i_307_, i_308_)
                                        - class120_274_.averageHeightAt(i_307_, i_308_);
                            } else if (class120_273_ != null && !aBoolArrayArray4926[type][i_300_]) {
                                int i_309_ = is_296_[i_300_] + (x << 9);
                                int i_310_ = is_297_[i_300_] + (z << 9);
                                is_299_[i_300_] = class120_273_.averageHeightAt(i_309_, i_310_)
                                        - class120.averageHeightAt(i_309_, i_310_);
                            }
                        }
                    }
                    ...
                    Class150 class150 = new Class150();
                    if (underwater) {
                        class150.colour = sceneGraph.getColor(x, z) * 791213269;
                        class150.scale = sceneGraph.getScale(x, z) * 1591951847;
                        class150.intensity = sceneGraph.getIntensity(x, z) * 1370254837;
                        class150.anInt1848 = sceneGraph.getConfig4(x, z) * 471935851;
                        class150.anInt1847 = sceneGraph.getConfig2(x, z) * -2072444281;
                        class150.anInt1846 = sceneGraph.getConfig3(x, z) * -1720335367;
                    }
                    ...
                    sceneGraph.method8340(plane, x, z);
                }
            }
        }
    }
