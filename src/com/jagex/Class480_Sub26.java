...
public class Class480_Sub26 extends Node {
    NativeSceneGraphLevel aClass120_Sub2_10170;
    ...
    Class480_Sub26(NativeToolkit class134_sub3, NativeSceneGraphLevel class120_sub2, PointLight class480_sub23, int[] is) {
    ...
    void method16022(Class259 class259, NativeElementArrayBuffer interface36, int i) {
        ...
        class259.aVector3f_2870.set(f, f, f);
    ...
    void method16023(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
        ...
        if (l != -1L) {
            aClass667_10185.put(l, new ShortNode(i_8_));
        }
        float f;
        float f_9_;
        float f_10_;
