...
public class NativeSprite extends Sprite {
    ...
    int anInt8700;
    NativeAttachment anNativeAttachment_8701;
    int anInt8702;
    int anInt8703;
    boolean aBool8704;
    boolean aBool8705;
    ...
    NativeSprite(NativeToolkit toolkit, int width, int height, boolean transparent, boolean bool_135_) {
        ...
        if (bool_135_) {
            ...
            anNativeAttachment_8701 = interface40.method305(0);
    ...
    @Override
    public NativeAttachment method2075() {
        return anNativeAttachment_8701;
    }
