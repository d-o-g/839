...
public class Class591 {
    ...
    public static final void method9995() {
        ...
        if (i_5_ == 0) {
            Client.scene.method7770(null);
            Client.method13392(0);
        } else if (i_5_ == 1 || 3 == i_5_) {
            Skill.method9560((byte) 0);
    ...
    static final void method9996(Component class226, Interface class221, ScriptExecutionContext class613, int i) {
    ...
    public Vector3f method9945() {
        return aVector3f_7825;
    }
    ...
    public boolean method9959(Buffer buffer) {
        ...
        if (0 != (i_3_ & -126543503 * Class589.aClass589_7784.anInt7795)) {
            aVector3f_7825 = Vector3f.from(buffer);
        }
