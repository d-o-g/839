...
public class Class315 {
    ...
    NativeAttachment anNativeAttachment_3342;
    NativeAttachment anNativeAttachment_3343;
    NativeAttachment anNativeAttachment_3344;
    NativeAttachment anNativeAttachment_3345;
    int anInt3346;
    NativeAttachBuffer anNativeAttachBuffer_3347;
    int anInt3348;
    ...
    boolean aBool3353;
    NativeAttachBuffer anNativeAttachBuffer_3354;
    ...
    void method5666() {
        ...
        if (anNativeAttachment_3345 != null) {
            anNativeAttachment_3345.deleteImmediately();
            anNativeAttachment_3345 = null;
        }
        if (anNativeAttachBuffer_3347 != null) {
            anNativeAttachBuffer_3347.deleteImmediately();
            anNativeAttachBuffer_3347 = null;
        }
        if (aClass146_Sub2_3337 != null) {
            aClass146_Sub2_3337.delete();
        }
        if (anNativeAttachment_3342 != null) {
            anNativeAttachment_3342.deleteImmediately();
        }
        if (anNativeAttachment_3343 != null) {
            anNativeAttachment_3343.deleteImmediately();
        }
        if (anNativeAttachment_3344 != null) {
            anNativeAttachment_3344.deleteImmediately();
        }
        ...
        if (anNativeAttachBuffer_3354 != null) {
            anNativeAttachBuffer_3354.deleteImmediately();
        }
    ...
    void method5668() {
        ...
        if (toolkit.anInt9400 > 1 && toolkit.aBool9409 && toolkit.aBool9271) {
            ...
            anNativeAttachment_3345 = toolkit.method2401(anInt3348, anInt3336, Class121.aClass121_1465, aClass151_3352,
                    toolkit.anInt9400);
            anNativeAttachBuffer_3347 = toolkit.method2403(anInt3348, anInt3336, toolkit.anInt9400);
        }
        anInterface40_3358 = toolkit.create2DTexture(Class121.aClass121_1465, aClass151_3352, anInt3348, anInt3336);
        anNativeAttachment_3342 = anInterface40_3358.method305(0);
        anInterface40_3338 = toolkit.create2DTexture(Class121.aClass121_1465, aClass151_3352, anInt3348, anInt3336);
        anNativeAttachment_3343 = anInterface40_3338.method305(0);
        anInterface40_3341 = toolkit.create2DTexture(Class121.aClass121_1465, aClass151_3352, anInt3348, anInt3336);
        anNativeAttachment_3344 = anInterface40_3341.method305(0);
        anNativeAttachBuffer_3354 = toolkit.method2774(anInterface40_3341.getWidth(), anInterface40_3341.getHeight());
        int i = aVector3349.size();
    ...
    void method5675(int i, int i_4_) {
        if (aBool3353) {
            if (display != null) {
                ...
                display.method14263(0, 0, anInt3348, anInt3336, 0, 0, true, anNativeAttachBuffer_3354 != null);
            }
            method5684(i, i_4_);
            aBool3353 = false;
        }
            ...
            for (int i_13_ = 0; i_13_ < i_11_; i_13_++) {
                if (i_13_ == i_11_ - 1) {
                    if (bool) {
                        ...
                        bool_12_ = true;
                        aClass146_Sub2_3337.method14256(0, anNativeAttachment_3344);
                    }
                } else {
                    aClass146_Sub2_3337.method14256(0, anNativeAttachment_3343);
                }
                Interface40 interface40 = anInterface40_3358;
                if (i_13_ == 0) {
                    interface40 = anInterface40_3341;
                }
                class309.method5509(i_13_, aClass146_Sub2_3337, interface40, anNativeAttachBuffer_3354, anInterface40_3341,
                        bool && i_13_ == i_11_ - 1);
                method5667();
                ...
                NativeAttachment nativeAttachment = anNativeAttachment_3342;
                anNativeAttachment_3342 = anNativeAttachment_3343;
                anNativeAttachment_3343 = nativeAttachment;
            }
        }
    ...
    boolean method5690(int i, int i_15_, int i_16_, int i_17_) {
        ...
        aClass146_Sub2_3337.method14256(0, anNativeAttachment_3344);
        if (anNativeAttachBuffer_3354 != null) {
            aClass146_Sub2_3337.method14255(anNativeAttachBuffer_3354);
        }
        if (display != null) {
            display.method14256(0, anNativeAttachment_3345);
            display.method14255(anNativeAttachBuffer_3347);
    ...
    void method5696() {
        if (anInterface32_3355 == null) {
            ...
            aClass323_3339 = toolkit.method14696(new Class320(Class316.aClass316_12));
        }
    }
}
