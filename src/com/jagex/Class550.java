...
public class Class550 implements Identifiable {
    ...
    static final void method9333(Component class226, Interface class221, ScriptExecutionContext class613, int i) {
        class226.selectedAction = (String) class613.anObjectArray7918[(class613.anInt7929 -= -1356601931) * 211787933];
    }
