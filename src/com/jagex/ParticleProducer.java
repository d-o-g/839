...
public class ParticleProducer {
    static Component aClass226_7678;
    ParticleSystem parent;
    ParticleTriangle current;
    Class145 particleMovement;
    int anInt7662;
    ...
    ParticleProducer(Toolkit toolkit, Class145 class145, ParticleSystem system, long time) {
        ...
        next = new ParticleTriangle();
        unmoved = false;
        aBool7677 = false;
        particleMovement = class145;
        parent = system;
        startTime = time * -7590219732314579427L;
        definition = particleMovement.getProducer(toolkit.particleLoader);
        ...
        updatePosition();
        next.anInt7750 = current.anInt7750 * 1;
        next.anInt7742 = 1 * current.anInt7742;
        next.anInt7743 = current.anInt7743 * 1;
        next.anInt7744 = current.anInt7744 * 1;
        next.anInt7746 = current.anInt7746 * 1;
        next.anInt7751 = 1 * current.anInt7751;
        next.anInt7745 = 1 * current.anInt7745;
        next.anInt7748 = current.anInt7748 * 1;
        next.anInt7749 = current.anInt7749 * 1;
    }

    static final void method9684(int i, int[] is) {
        if (Component.loadInterface(i, is)) {
            Component[] components = Class598.loadedInterfaces[i].components;
            for (Component component : components) {
                if (component != null && component.aAnimator_2541 != null) {
    ...
    void updatePosition() {
        current.anInt7750 = 1065904471 * particleMovement.anInt1809;
        current.anInt7742 = -530820371 * particleMovement.anInt1816;
        current.anInt7743 = -1563545285 * particleMovement.anInt1811;
        current.anInt7744 = 1166708931 * particleMovement.anInt1810;
        current.anInt7746 = particleMovement.anInt1813 * -1213788101;
        current.anInt7751 = 1166829601 * particleMovement.anInt1814;
        current.anInt7745 = particleMovement.anInt1815 * 723244479;
        current.anInt7748 = particleMovement.anInt1808 * -2075851931;
        current.anInt7749 = 280437761 * particleMovement.anInt1817;
        if (-1196990579 * current.anInt7744 == 1352340659 * current.anInt7750
            ...
            unmoved = false;
            next.anInt7750 = current.anInt7750;
            next.anInt7742 = current.anInt7742;
            next.anInt7743 = current.anInt7743;
            next.anInt7744 = current.anInt7744;
            next.anInt7746 = current.anInt7746;
            next.anInt7751 = current.anInt7751;
            next.anInt7745 = current.anInt7745;
            next.anInt7748 = current.anInt7748;
            next.anInt7749 = current.anInt7749;
        }
    }

    void method9675(SceneGraph sceneGraph, Toolkit toolkit, long l) {
        for (Particle class477_sub4_sub1_sub1 = (Particle) particles.head(); class477_sub4_sub1_sub1 != null; class477_sub4_sub1_sub1 = (Particle) particles
                .next()) {
            class477_sub4_sub1_sub1.method18122(sceneGraph, toolkit, l);
        }
    }
    ...
    void method9676(Toolkit toolkit, long l, int i, boolean bool) {
        if (aBool7666) {
            bool = false;
        } else if (ParticleSystem.particleSetting * -897945427 < definition.minimumSetting * 904647545) {
            bool = false;
        } else if (Class570.anInt7640 * -238678919 > Class149.anIntArray1832[-897945427 * ParticleSystem.particleSetting]) {
            bool = false;
        } else if (unmoved) {
            bool = false;
        ...
        if (!current.equals(next)) {
            ParticleTriangle triangle = next;
            next = current;
            current = triangle;
            current.anInt7750 = particleMovement.anInt1809 * 1065904471;
            current.anInt7742 = -530820371 * particleMovement.anInt1816;
            current.anInt7743 = particleMovement.anInt1811 * -1563545285;
            current.anInt7744 = 1166708931 * particleMovement.anInt1810;
            current.anInt7746 = -1213788101 * particleMovement.anInt1813;
            current.anInt7751 = 1166829601 * particleMovement.anInt1814;
            current.anInt7745 = 723244479 * particleMovement.anInt1815;
            current.anInt7748 = -2075851931 * particleMovement.anInt1808;
            current.anInt7749 = particleMovement.anInt1817 * 280437761;
            current.centerX = next.centerX * 1;
            current.centerZ = next.centerZ * 1;
            current.centerY = 1 * next.centerY;
        }
