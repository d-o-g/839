...
public class VarDefinitionLoader extends DefaultProvidingVarpLoader {
    static short aShort10931;
    Archive archive;
    ReferenceCache<VarpDefinition> cache = new ReferenceCache<VarpDefinition>(64);
    public VarDefinitionLoader(GameContext context, VarpType type, Language language, Archive archive) {
    ...
    public Iterator iterator() {
        return new VarpDefinitionIterator(this);
    }
