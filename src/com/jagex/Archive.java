...
public final class Archive {
    ...
    static void addTableChecksums(BitBuffer buffer) {
        ...
        buffer.writeInt(Class671.interfaces.getTableChecksum());
        ...
        buffer.writeInt(SceneGraphLevel.graphics.getTableChecksum());
        buffer.writeInt(Class501.varpbits.getTableChecksum());
        ...
        try {
            ...
            throw ContainerDecodingException.wrap(
                    ...
                    new StringBuilder().append(null != key).append(" ").append(entry).append(" ")
                            .append(unpacked.length).append(" ").append(ReferenceTable.crc32(unpacked, unpacked.length))
                            .append(" ").append(ReferenceTable.crc32(unpacked, unpacked.length - 2)).append(" ")
