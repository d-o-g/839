...
public class Class62 {
    ...
    public static void method1382(String pleaseWAit, boolean bool, Toolkit class134, Font class132, FontSpecification class9) {
        ...
        if (bool_1_) {
            if (Class82.aBool1187 && bool_1_) {
                ...
                int i_2_ = class9.textWidth(pleaseWAit, 250, null);
                int i_3_ = class9.textHeight(pleaseWAit, 250, 108311343 * class9.verticalSpacing, null);
                ...
                ItemDeque.aClass152_9984.rotateClockwise();
                class132.method2294(pleaseWAit, i_5_ + i_6_, i_7_ + i_5_, i_2_ - i_5_ * 2, i_3_ - 2 * i_5_,
                        CachedDefinitionLoader.anInt8502 * -883824013 | ~0xffffff, -1, 1, 1, 0, null, null, null, 0, 0);
                Client.method8796(i_6_, i_7_, i_2_, i_3_);
            } else {
                int i_8_ = class9.textWidth(pleaseWAit, 250, null);
                int i_9_ = class9.getLineCount(pleaseWAit, 250, null) * 13;
                int i_10_ = 4;
                int i_11_ = i_10_ + 6;
                int i_12_ = i_10_ + 6;
                ...
                class132.method2294(pleaseWAit, i_11_, i_12_, i_8_, i_9_, -1, -1, 1, 1, 0, null, null, null, 0, 0);
    ...
    public static final void method1384(Component class226, int i, int i_21_) {
        if (Client.aClass226_10801 == null && !Class56.menuOpen && class226 != null
                && Server.method9477(class226, 1431528156)) {
            Client.aClass226_10801 = class226;
            Client.aClass226_10802 = MobWalkCutsceneAction.method15116(class226);
            Client.mouseX = i * 2080472875;
            Client.mouseY = i_21_ * -931482949;
            Display.anInt1818 = 0;
    ...
    static final void method1383(boolean bool) {
        ...
        while (buffer.remainingBits(-842560185 * Client.gameConnection.currentFrameSize) >= 15) {
            ...
            if (null == linkable) {
                Npc npc = new Npc(Client.scene.getGraph());
                npc.index = 1228997701 * index;
                linkable = new ObjectNode(npc);
                Client.npcTable.put(index, linkable);
                Client.npcs[(Client.anInt10862 += 1526871765) * -999337347 - 1] = linkable;
                newNpc = true;
            }
