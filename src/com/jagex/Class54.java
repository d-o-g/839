...
public class Class54 {
    ...
    static final void method1165() {
        Component.redraw(Client.aClass226_10801);
        ...
        if (!Client.aBool10811 || !Client.aBool10806) {
            ...
            i_0_ -= 1600472963 * Client.mouseX;
            i_1_ -= 558940787 * Client.mouseY;
            ...
            if (!Client.recorder.buttonDown()) {
                if (Client.aBool10814) {
                    ...
                    if (Client.aClass226_10801.anObjectArray2493 != null) {
                        ...
                        Component class226 = Client.method17024(Client.aClass226_10801);
                        Component class226_4_ = Client.aClass226_10805;
                        boolean bool = false;
                        for (; class226_4_ != null && 1920469085 * class226_4_.parentUid != -1 && class226 != null; class226_4_ = Class598.loadedInterfaces[1857819631 * class226_4_.uid >> 16].components[1920469085 * class226_4_.parentUid & 0xffff]) {
                            if (class226.uid * 1857819631 == class226_4_.uid * 1857819631) {
                                bool = true;
                                break;
                            }
                        }
                    ...
                    Class122.method2241(Client.anInt10628 * 445820795 + Client.mouseX * 1600472963, 558940787
                            * Client.mouseY + 1448151993 * Client.anInt10857);
                } else if (GlobalPlayer.method1099()) {
                    Class122.method2241(445820795 * Client.anInt10628 + 1600472963 * Client.mouseX, 558940787
                            * Client.mouseY + Client.anInt10857 * 1448151993);
                }
                Client.aClass226_10801 = null;
                Client.aClass226_10802 = null;
            } else {
