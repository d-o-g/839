...
public abstract class Toolkit {
    ...
    public TextureLoader anTextureLoader_1546;
    ...
    Toolkit(TextureMetricsList metrics, TextureLoader textureLoader, BillboardLoader billboardLoader,
        ...
        aFloat1550 = 0.0F;
        metricsList = metrics;
        anTextureLoader_1546 = textureLoader;
    ...
    public static Toolkit create(int type, Canvas canvas, TextureMetricsList metrics, TextureLoader textureLoader,
        ...
        return create(type, canvas, metrics, textureLoader, billboardLoader, particleLoader, interface44, shaders,
                multisamples, width, height);
    }

    static synchronized Toolkit create(int type, Canvas canvas, TextureMetricsList metrics, TextureLoader textureLoader,
                                       BillboardLoader billboardLoader, ParticleProducerDefinitionLoader particleLoader, Interface44 interface44,
                                       Archive shaders, int multisamples, int width, int height) {
        if (0 == type) {
            return JavaToolkit.create(canvas, metrics, textureLoader, billboardLoader, particleLoader, interface44,
                    width, height);
        } else if (type == 1) {
            return OpenGlToolkit.create(canvas, metrics, textureLoader, billboardLoader, particleLoader, interface44,
                    multisamples);
        } else if (type == 5) {
            return OpenGlXToolkit.create(canvas, metrics, textureLoader, billboardLoader, particleLoader, interface44,
                    shaders, multisamples);
        } else if (type == 3) {
            return DirectXToolkit.create(canvas, metrics, textureLoader, billboardLoader, particleLoader, interface44,
                    shaders, multisamples);
        }
    ...
    static void method5369(Toolkit toolkit) {
        if (!Class56.aBool642) {
            SceneGraphLevel.method2227(toolkit);
        } else {
    ...
    public abstract NativeAttachment method2401(int i, int i_15_, Class121 class121, Class151 class151, int i_16_);

    public abstract NativeAttachBuffer method2403(int i, int i_17_, int i_18_);
    ...
    public boolean method2445(int i, int i_77_, Matrix4x3 class405, Class379 class379) {
    ...
    public abstract void method2447(Matrix4x3 class405, Class139 class139, Class379 class379);
    ...
    public abstract Matrix4x3 getMatrix4x3();
    ...
    public abstract SceneGraphLevel createGround(int width, int length, int[][] heights, int[][] lighting, int units,
    ...
    public abstract void method2470(ParticleEntities particleEntities);

    public abstract void method2471(Matrix4x3 class405);
    ...
    public abstract Matrix4f cloneMatrix4f();

    public abstract int update(int i, int i_161_, int i_162_, int i_163_, int i_164_, int i_165_);
    ...
    public abstract Matrix4x3 method2754();

    public abstract void method2760(int i, int i_232_, int i_233_, int i_234_);

    public abstract NativeAttachBuffer method2774(int i, int i_235_);
    ...
    public abstract GraphicsCard getGraphicsCard();
    ...
    abstract boolean method2377(int i, int i_1_, int i_2_, int i_3_, Matrix4x3 class405, Class379 class379);
