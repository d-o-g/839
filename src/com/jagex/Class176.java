...
public class Class176 implements Definition, Interface71 {
    ...
    public static void addChatMessage(int type, int i_7_, String name, String string_8_, String string_9_,
                                      String message, ChatMessageIcon chatMessageIcon) {
        JavaThreadResource.addChatMessage(type, i_7_, name, string_8_, string_9_, message, null, -1, chatMessageIcon);
    }
    ...
    static String method3527(long l, int i, boolean bool) {
        ...
        return new StringBuilder().append(i_13_ / 10).append(i_13_ % 10).append("/")
