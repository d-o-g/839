...
public abstract class Model {
    ...
    public abstract void method2901(int i, int i_74_, SceneGraphLevel class120, SceneGraphLevel class120_75_, int i_76_, int i_77_,
                                    int i_78_);
    ...
    public abstract void transform(Matrix4x3 class405, int i, boolean bool);

    public abstract void method2917(Matrix4x3 class405, Class139 class139, int i);

    public abstract boolean method2918(int i, int i_181_, Matrix4x3 class405, boolean bool, int i_182_);
    ...
    public abstract void recolor(int i, int i_184_, int i_185_, int i_186_);

    public abstract boolean method2938();

    public abstract boolean method2939();

    public abstract boolean isTextured();
    ...
    public abstract void method3063(Matrix4x3 class405);
    ...
    void method2902(SceneGraphLevel class120, int i, int i_79_, int i_80_, int i_81_, int i_82_, int i_83_, int i_84_) {
        int i_87_ = -i_81_ / 2;
        int i_88_ = -i_82_ / 2;
