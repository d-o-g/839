...
public class Class38 {
    ...
    static final void method1021(int i, int i_8_) {
        int i_9_ = Client.engineCycle - 665362717 * Client.anInt10639;
        if (i_9_ >= 100) {
            Client.mapState = FloatRaster.method1728() * 442919637;
            ...
            if (FloatRaster.method1728() == 3) {
                Vector4i vector4i = Client.camera.method4876().method5238((short) 15810);
                CoordGrid class553 = Client.scene.getBase();
                Class155.cameraPitch = ((int) (Client.camera.getPitch((byte) 1) * 2607.5945876176133) & 0x3fff)
                        * -1300105055;
                Class550.cameraYaw = ((int) (Client.camera.getYaw() * -2607.5945876176133) & 0x3fff)
                        * -1726145155;
                ...
                Client.anInt10906 = (int) (DrawableText.anInt9830 * 422651069 + ((int) (101040205 * Client.anInt10888 / (4.0 * Math
                        .tan(Client.camera.method4853((short) -397) / 2.0F))) - 422651069 * DrawableText.anInt9830)
                        * f)
                        * -1137455197;
                Client.cameraX = (int) ((-61099889 * vector4i.x - -1992939008 * class553.x - ValueType.anInt4856 * 718417889)
                        * f + ValueType.anInt4856 * 718417889)
                        * -224503671;
                Class268.cameraY = (int) (f
                        * (-(vector4i.y * 1227419133) - HashedVariableCollection.anInt1485 * -419341025) + HashedVariableCollection.anInt1485
                        * -419341025)
                        * -1128143643;
                ...
                Client.cameraZ = -187933039
                        * (int) (Class512.anInt7004 * -2126389539 + f
                        * (Client.cameraZ * 1829446257 - Class512.anInt7004 * -2126389539));
                Class155.cameraPitch = (int) (1597295205 * Class206.anInt2160 + f
                        * (Class155.cameraPitch * 912649057 - Class206.anInt2160 * 1597295205))
                        * -1300105055;
                i_10_ = 1686504405 * Class550.cameraYaw - AsynchronousHttpRequestCreator.anInt4613 * 2012215581;
                if (i_10_ > 8192) {
                    i_10_ -= 16384;
                } else if (i_10_ < -8192) {
                    i_10_ += 16384;
