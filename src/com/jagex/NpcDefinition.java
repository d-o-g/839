...
public class NpcDefinition implements Definition {
    ...
    public final Model method5103(Toolkit toolkit, int i, Class678_Sub6 class678_sub6, VariableLoader interface14,
                                  VariableProvider interface12, Animator animator, Animator animator_1_, Animator[] animators, int[] is,
                                  int i_2_, Class267 class267) {
        return method5104(toolkit, i, class678_sub6, interface14, interface12, animator, animator_1_, animators, is,
    ...
    public final Model method5104(Toolkit toolkit, int i, Class678_Sub6 class678_sub6, VariableLoader interface14,
                                  VariableProvider interface12, Animator animator, Animator animator_4_, Animator[] animators, int[] is,
        ...
        if (morphisms != null) {
            ...
            return definition.method5104(toolkit, i, class678_sub6, interface14, interface12, animator, animator_4_,
                    animators, is, i_5_, class267, i_6_, bool);
        }
        ...
        int i_11_ = null != animators ? animators.length : 0;
        for (int i_12_ = 0; i_12_ < i_11_; i_12_++) {
            if (animators[i_12_] != null) {
                i_9_ |= animators[i_12_].method13457();
                bool_10_ = true;
            }
        }

        if (null != animator) {
            i_9_ |= animator.method13457();
            bool_10_ = true;
        }

        if (animator_4_ != null) {
            i_9_ |= animator_4_.method13457();
            bool_10_ = true;
        }
        ...
        if (class143 == null || (class143.functionMask() & i_9_) != i_9_) {
            ...
            if (aByte3032 != 0) {
                class143.recolor(aByte3014, aByte3030, aByte3056, aByte3032 & 0xff);
            }
        ...
        while (i_34_ < i_11_) {
            if (null != animators[i_34_]) {
                animators[i_34_].method13459(class143_30_, 0, i_35_, 1691643289);
            }
            i_34_++;
            i_35_ <<= 1;
        }
        ...
        if (null != animator && animator_4_ != null) {
            QuestDefinitionProvider.method4610(class143_30_, animator, animator_4_);
        } else if (animator != null) {
            animator.method13458(class143_30_, 0);
        } else if (animator_4_ != null) {
            animator_4_.method13458(class143_30_, 0);
        }
    ...
    public final Model method5105(Toolkit toolkit, int i, VariableLoader loader, VariableProvider interface12,
                                  Animator animator, Class267 class267) {
        if (morphisms != null) {
            ...
            return definition.method5105(toolkit, i, loader, interface12, animator, class267);
        }
        ...
        Model class143;
        synchronized (provider.modelCache) {
            class143 = provider.modelCache.get(id);
        }
        ...
        if (null == class143 || (class143.functionMask() & i_38_) != i_38_) {
            ...
            synchronized (provider.modelCache) {
                provider.modelCache.put(l, class143);
            }
        }

        if (animator != null) {
            class143 = class143.method2890((byte) 1, i_38_, true);
            animator.method13458(class143, 0);
        }
    ...
    public final NpcDefinition morph(VariableLoader loader, VariableProvider provider) {
        int index = -1;
        if (varpBit * 1698432671 != -1) {
            VarpBit variable = loader.getVarpBit(varpBit * 1698432671);
            if (variable != null) {
                index = provider.getVarpBitValue(variable);
            }
        } else if (-1 != varp * 1866781615) {
            Varp variable = loader.getVarp(VarpType.PLAYER, 1866781615 * varp);
            if (variable != null) {
                index = provider.getVarpValue(variable);
            }
        }
    ...
    public boolean method5128(VariableLoader interface14, VariableProvider interface12, int i) {
        ...
        int i_57_ = -1;
        if (-1 != varpBit * 1698432671) {
            VarpBit class301 = interface14.getVarpBit(varpBit * 1698432671);
            if (class301 != null) {
                i_57_ = interface12.getVarpBitValue(class301);
            }
        } else if (varp * 1866781615 != -1) {
            Varp class131 = interface14.getVarp(VarpType.PLAYER, varp * 1866781615);
            if (null != class131) {
                i_57_ = interface12.getVarpValue(class131);
            }
        }
    ...
    void decode(Buffer buffer, int opcode) {
        if (opcode == 1) {
            ...
            int read = buffer.readUByte();
            int count = 0;
            for (int i = read; i != 0; i >>= 1) {
                count++;
            }
            anIntArray3011 = new int[count];
            aShortArray3046 = new short[count];
            for (int i = 0; i < count; i++) {
                if ((read & 0x1 << i) == 0) {
                    anIntArray3011[i] = -1;
                    aShortArray3046[i] = (short) -1;
                } else {
                    anIntArray3011[i] = buffer.readSmart32();
                    aShortArray3046[i] = (short) buffer.readDecrSmart();
                }
            }
        } else if (103 == opcode) {
            contrast = buffer.readUShort() * -544390137;
        } else if (opcode == 106 || opcode == 118) {
            varpBit = buffer.readUShort() * -540961441;
            if (varpBit * 1698432671 == 65535) {
                varpBit = 540961441;
            }
            ...
            direction = CompressionType.findIdentifiable(NpcDirection.values(), buffer.readByte());
        } else if (127 == opcode) {
            ...
            if (163 == opcode) {
                ...
                if (179 == opcode) {
                    ...
                    for (int i_95_ = 0; i_95_ < i_93_; i_95_++) {
                        ...
                        Node class480;
                        if (bool) {
                            class480 = new ObjectNode(buffer.readString());
                        } else {
                            class480 = new IntegerNode(buffer.readInt());
                        }
