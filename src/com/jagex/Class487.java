...
public class Class487 {
    ...
    public static Class487 createSkybox(int skyboxId, int i_0_, int i_1_, int i_2_,
        ...
        if (aClass143_6660 == null) {
            ...
            if (-1 != anInt6645 * 781728403 && 0 != -1738305869 * anInt6646) {
                ...
                if (aClass116_6655 == null
                        && PlayerFacade.anTextureLoader_1027.loaded(TextureType.TEXTURE_AND_MATERIAL, metrics.id
                        * -464558709)) {
                    int[] data = metrics.aClass554_1727 == Class554.aClass554_7500 ? PlayerFacade.anTextureLoader_1027
                            .loadOpaque(TextureType.TEXTURE_AND_MATERIAL, metrics.id * -464558709, 0.7F)
                            : PlayerFacade.anTextureLoader_1027.loadTranslucent(TextureType.TEXTURE_AND_MATERIAL,
            ...
            Matrix4f class399_48_ = toolkit.cloneMatrix4f();
    ...
    void method8284(Toolkit toolkit, int i, int i_57_, int i_58_, int i_59_) {
        Matrix4x3 class405 = toolkit.method2754();
        Matrix4x3 class405_61_ = new Matrix4x3();
        ...
        Matrix4x3 class405_62_ = new Matrix4x3();
