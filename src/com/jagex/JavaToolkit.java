...
public class JavaToolkit extends Toolkit {
    ...
    JavaToolkit(Canvas canvas, TextureMetricsList class147, TextureLoader textureLoader, BillboardLoader interface41,
                ParticleProducerDefinitionLoader particleLoader, Interface44 interface44, int i, int i_439_) {
        this(class147, textureLoader, interface41, particleLoader, interface44);
        try {
    ...
    JavaToolkit(TextureMetricsList class147, TextureLoader textureLoader, BillboardLoader billboardLoader,
                ParticleProducerDefinitionLoader particleLoader, Interface44 interface44) {
        super(class147, textureLoader, billboardLoader, particleLoader, interface44);
        aBool8796 = false;
        leftClip = 0;
        rightClip = 0;
        bottomClip = 0;
    ...
    public static Toolkit create(Canvas canvas, TextureMetricsList class147, TextureLoader textureLoader,
                                 BillboardLoader interface41, ParticleProducerDefinitionLoader interface42, Interface44 interface44,
                                 int width, int height) {
        return new JavaToolkit(canvas, class147, textureLoader, interface41, interface42, interface44, width, height);
    }

    static void method14153(int i, int i_597_, int i_598_, int i_599_, int i_600_, int i_601_, int i_602_,
                            MenuItem class480_sub31_sub17, Font class132, FontSpecification class9, int i_603_, int i_604_, int i_605_) {
    ...
    @Override
    public NativeAttachment method2401(int i, int i_36_, Class121 class121, Class151 class151, int i_37_) {
        return method14110(i, i_36_);
    }

    @Override
    public NativeAttachBuffer method2403(int i, int i_174_, int i_175_) {
    ...
    @Override
    public void method2424(float fineX, float fineY, float height, float[] dest) {
        float f_329_ = height * matrix.array[7] + (fineX * matrix.array[3] + matrix.array[15])
                + fineY * matrix.array[11];
        float f_330_ = matrix.array[0] * fineX + matrix.array[12] + height * matrix.array[4]
                + matrix.array[8] * fineY;
        float f_331_ = fineY * matrix.array[9]
                + (matrix.array[13] + matrix.array[1] * fineX + matrix.array[5] * height);
        float f_332_ = height * aClass399_8812.array[6] + (aClass399_8812.array[14] + aClass399_8812.array[2] * fineX)
                + fineY * aClass399_8812.array[10];
        dest[0] = aFloat8794 + f_330_ * aFloat8820 / f_329_;
        dest[1] = aFloat8800 + f_331_ * aFloat8808 / f_329_;
        dest[2] = f_332_;
    }
    ...
    @Override
    public void method2447(Matrix4x3 class405, Class139 class139, Class379 class379) {
        Matrix4f class399 = getMatrix4f();
        class399.method6548(class405);
        class399.method6547(matrix);
    ...
    @Override
    public SceneGraphLevel createGround(int width, int length, int[][] heights, int[][] lighting, int units, int i_8_, int i_9_) {
        return new JavaSceneGraphLevel(this, i_9_, width, length, heights, lighting, units);
    }

    @Override
    public void method2470(ParticleEntities particleEntities) {
        method14134(anIntArray8797 != null, null != aFloatArray8801, false, particleEntities);
    }

    @Override
    public void method2471(Matrix4x3 class405) {
    ...
    public void method2502(float f, float f_422_, float f_421_, float[] fs) {
        float f_423_ = f_421_ * matrix.array[6] + (matrix.array[14] + matrix.array[2] * f)
                + f_422_ * matrix.array[10];
        float f_424_ = f_421_ * matrix.array[7] + (matrix.array[15] + f * matrix.array[3])
                + matrix.array[11] * f_422_;
        if (f_423_ < -f_424_ || f_423_ > f_424_) {
            ...
            float f_427_ = matrix.array[8] * f_422_
                    + (f * matrix.array[0] + matrix.array[12] + matrix.array[4] * f_421_);
            if (f_427_ < -f_424_ || f_427_ > f_424_) {
                ...
                float f_430_ = f_421_ * matrix.array[5]
                        + (matrix.array[13] + matrix.array[1] * f) + f_422_ * matrix.array[9];
    ...
    @Override
    public Matrix4f cloneMatrix4f() {
        return new Matrix4f(aClass399_8819);
    }

    @Override
    public int update(int i, int i_496_, int i_497_, int i_498_, int i_499_, int i_500_) {
        int i_501_ = 0;
        float f = matrix.array[2] * i + matrix.array[14] + i_496_ * matrix.array[6]
                + matrix.array[10] * i_497_;
        float f_502_ = matrix.array[10] * i_500_
                + (i_499_ * matrix.array[6] + (matrix.array[2] * i_498_ + matrix.array[14]));
        float f_503_ = i_497_ * matrix.array[11]
                + (matrix.array[7] * i_496_ + (matrix.array[15] + i * matrix.array[3]));
        float f_504_ = i_499_ * matrix.array[7] + (i_498_ * matrix.array[3] + matrix.array[15])
                + matrix.array[11] * i_500_;
        if (f < -f_503_ && f_502_ < -f_504_) {
            i_501_ |= 0x10;
        } else if (f > f_503_ && f_502_ > f_504_) {
            i_501_ |= 0x20;
        }
        float f_505_ = matrix.array[4] * i_496_ + (matrix.array[12] + i * matrix.array[0])
                + i_497_ * matrix.array[8];
        float f_506_ = i_500_ * matrix.array[8]
                + (matrix.array[4] * i_499_ + (matrix.array[12] + i_498_ * matrix.array[0]));
        ...
        float f_507_ = matrix.array[9] * i_497_
                + (i_496_ * matrix.array[5] + (matrix.array[13] + i * matrix.array[1]));
        float f_508_ = matrix.array[13] + matrix.array[1] * i_498_ + i_499_ * matrix.array[5]
                + matrix.array[9] * i_500_;
    ...
    @Override
    public Matrix4x3 method2754() {
        return new Matrix4x3(aClass405_8811);
    }
    ...
    @Override
    public NativeAttachBuffer method2774(int i, int i_288_) {
    ...
    int[] method14092(int i) {
        ...
        synchronized (aClass168_8828) {
            ...
            if (null == class480_sub7) {
                ...
                if (!anTextureLoader_1546.loaded(TextureType.TEXTURE_AND_MATERIAL, i)) {
                    int[] is = null;
                    return is;
                }
                int[] is;
                if (Class554.aClass554_7499 != class141.aClass554_1727) {
                    is = anTextureLoader_1546.loadOpaque(TextureType.TEXTURE_AND_MATERIAL, i, 0.7F);
                } else {
                    is = anTextureLoader_1546.loadTranslucent(TextureType.TEXTURE_AND_MATERIAL, i, 0.7F);
                }
    ...
    boolean method14093(int id) {
        return anTextureLoader_1546.loaded(TextureType.TEXTURE_AND_MATERIAL, id);
    }
    ...
    void method14109() {
        ...
        matrix.copyFrom(aClass399_8812);
        matrix.method6547(aClass399_8819);
        matrix.method6567(aFloatArrayArray8815[0]);
        matrix.method6568(aFloatArrayArray8815[1]);
        matrix.method6563(aFloatArrayArray8815[2]);
        matrix.method6564(aFloatArrayArray8815[3]);
        matrix.method6632(aFloatArrayArray8815[4]);
        matrix.method6566(aFloatArrayArray8815[5]);
    ...
    NativeAttachment method14110(int i, int i_333_) {
    ...
    void method14134(boolean bool, boolean bool_482_, boolean bool_483_, ParticleEntities particleEntities) {
        JavaThreadResource class64 = getThreadResource(Thread.currentThread());
        for (PointEntity class477_sub4_sub1 = (PointEntity) particleEntities.entities.getFront(); class477_sub4_sub1 != null; class477_sub4_sub1 = (PointEntity) particleEntities.entities
                .next()) {
            int i = class477_sub4_sub1.x >> 12;
            int i_484_ = class477_sub4_sub1.z >> 12;
            int i_485_ = class477_sub4_sub1.y >> 12;
            float f = matrix.array[14]
                    + (i * matrix.array[2] + matrix.array[6] * i_484_ + i_485_
                    * matrix.array[10]);
            float f_486_ = matrix.array[15]
                    + (matrix.array[7] * i_484_ + i * matrix.array[3] + i_485_
                    * matrix.array[11]);
            if (!(f < -f_486_)) {
                float f_487_ = aFloat8824 * f / f_486_ + aFloat8825;
                if (!(f > class64.aFloat960)) {
                    float f_488_ = matrix.array[4] * i_484_ + matrix.array[0] * i + i_485_
                            * matrix.array[8] + matrix.array[12];
                    float f_489_ = i_485_ * matrix.array[9]
                            + (i * matrix.array[1] + matrix.array[5] * i_484_)
                            + matrix.array[13];
    ...
    @Override
    boolean method2377(int i, int i_177_, int i_178_, int i_179_, Matrix4x3 class405, Class379 class379) {
        Matrix4f class399 = getMatrix4f();
        class399.method6548(class405);
        class399.method6547(matrix);
    ...
    void method2647(int x, int y) {
        ...
        if (anTextureLoader_1546 != null) {
            anTextureLoader_1546.method106();
        }
    }
